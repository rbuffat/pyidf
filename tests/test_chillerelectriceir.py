...
class TestChillerElectricEir(unittest.TestCase):
    ...
    def test_create_chillerelectriceir(self):
        ...
        self.assertAlmostEqual(idf2.chillerelectriceirs[0].reference_capacity, var_reference_capacity)
        self.assertAlmostEqual(idf2.chillerelectriceirs[0].reference_cop, var_reference_cop)
        self.assertAlmostEqual(idf2.chillerelectriceirs[0].reference_leaving_chilled_water_temperature, var_reference_leaving_chilled_water_temperature)
        self.assertAlmostEqual(idf2.chillerelectriceirs[0].reference_entering_condenser_fluid_temperature, var_reference_entering_condenser_fluid_temperature)
        self.assertAlmostEqual(idf2.chillerelectriceirs[0].reference_chilled_water_flow_rate, var_reference_chilled_water_flow_rate)
        self.assertAlmostEqual(idf2.chillerelectriceirs[0].reference_condenser_fluid_flow_rate, var_reference_condenser_fluid_flow_rate)
        self.assertEqual(idf2.chillerelectriceirs[0].cooling_capacity_function_of_temperature_curve_name, var_cooling_capacity_function_of_temperature_curve_name)
        self.assertEqual(idf2.chillerelectriceirs[0].electric_input_to_cooling_output_ratio_function_of_temperature_curve_name, var_electric_input_to_cooling_output_ratio_function_of_temperature_curve_name)
        self.assertEqual(idf2.chillerelectriceirs[0].electric_input_to_cooling_output_ratio_function_of_part_load_ratio_curve_name, var_electric_input_to_cooling_output_ratio_function_of_part_load_ratio_curve_name)
        self.assertAlmostEqual(idf2.chillerelectriceirs[0].minimum_part_load_ratio, var_minimum_part_load_ratio)
        self.assertAlmostEqual(idf2.chillerelectriceirs[0].maximum_part_load_ratio, var_maximum_part_load_ratio)
        self.assertAlmostEqual(idf2.chillerelectriceirs[0].optimum_part_load_ratio, var_optimum_part_load_ratio)
        self.assertAlmostEqual(idf2.chillerelectriceirs[0].minimum_unloading_ratio, var_minimum_unloading_ratio)
        self.assertEqual(idf2.chillerelectriceirs[0].chilled_water_inlet_node_name, var_chilled_water_inlet_node_name)
        self.assertEqual(idf2.chillerelectriceirs[0].chilled_water_outlet_node_name, var_chilled_water_outlet_node_name)
        self.assertEqual(idf2.chillerelectriceirs[0].condenser_inlet_node_name, var_condenser_inlet_node_name)
        self.assertEqual(idf2.chillerelectriceirs[0].condenser_outlet_node_name, var_condenser_outlet_node_name)
        self.assertEqual(idf2.chillerelectriceirs[0].condenser_type, var_condenser_type)
        self.assertAlmostEqual(idf2.chillerelectriceirs[0].condenser_fan_power_ratio, var_condenser_fan_power_ratio)
        self.assertAlmostEqual(idf2.chillerelectriceirs[0].fraction_of_compressor_electric_consumption_rejected_by_condenser, var_fraction_of_compressor_electric_consumption_rejected_by_condenser)
        self.assertAlmostEqual(idf2.chillerelectriceirs[0].leaving_chilled_water_lower_temperature_limit, var_leaving_chilled_water_lower_temperature_limit)
        self.assertEqual(idf2.chillerelectriceirs[0].chiller_flow_mode, var_chiller_flow_mode)
        self.assertAlmostEqual(idf2.chillerelectriceirs[0].design_heat_recovery_water_flow_rate, var_design_heat_recovery_water_flow_rate)
        self.assertEqual(idf2.chillerelectriceirs[0].heat_recovery_inlet_node_name, var_heat_recovery_inlet_node_name)
        self.assertEqual(idf2.chillerelectriceirs[0].heat_recovery_outlet_node_name, var_heat_recovery_outlet_node_name)
        self.assertAlmostEqual(idf2.chillerelectriceirs[0].sizing_factor, var_sizing_factor)
        self.assertAlmostEqual(idf2.chillerelectriceirs[0].basin_heater_capacity, var_basin_heater_capacity)
        self.assertAlmostEqual(idf2.chillerelectriceirs[0].basin_heater_setpoint_temperature, var_basin_heater_setpoint_temperature)
        self.assertEqual(idf2.chillerelectriceirs[0].basin_heater_operating_schedule_name, var_basin_heater_operating_schedule_name)
        self.assertAlmostEqual(idf2.chillerelectriceirs[0].condenser_heat_recovery_relative_capacity_fraction, var_condenser_heat_recovery_relative_capacity_fraction)
        self.assertEqual(idf2.chillerelectriceirs[0].heat_recovery_inlet_high_temperature_limit_schedule_name, var_heat_recovery_inlet_high_temperature_limit_schedule_name)
        self.assertEqual(idf2.chillerelectriceirs[0].heat_recovery_leaving_temperature_setpoint_node_name, var_heat_recovery_leaving_temperature_setpoint_node_name)