...
class TestAirTerminalSingleDuctUserDefined(unittest.TestCase):
    ...
    def test_create_airterminalsingleductuserdefined(self):

        pyidf.validation_level = ValidationLevel.error

        obj = AirTerminalSingleDuctUserDefined()
        # alpha
        var_name = "Name"
        obj.name = var_name
        # object-list
        ...
        idf2 = IDF(self.path)
        self.assertEqual(idf2.airterminalsingleductuserdefineds[0].name, var_name)
        self.assertEqual(idf2.airterminalsingleductuserdefineds[0].overall_model_simulation_program_calling_manager_name, var_overall_model_simulation_program_calling_manager_name)
        self.assertEqual(idf2.airterminalsingleductuserdefineds[0].model_setup_and_sizing_program_calling_manager_name, var_model_setup_and_sizing_program_calling_manager_name)
        self.assertEqual(idf2.airterminalsingleductuserdefineds[0].primary_air_inlet_node_name, var_primary_air_inlet_node_name)
        self.assertEqual(idf2.airterminalsingleductuserdefineds[0].primary_air_outlet_node_name, var_primary_air_outlet_node_name)
        self.assertEqual(idf2.airterminalsingleductuserdefineds[0].secondary_air_inlet_node_name, var_secondary_air_inlet_node_name)
        self.assertEqual(idf2.airterminalsingleductuserdefineds[0].secondary_air_outlet_node_name, var_secondary_air_outlet_node_name)
        self.assertEqual(idf2.airterminalsingleductuserdefineds[0].number_of_plant_loop_connections, var_number_of_plant_loop_connections)
        self.assertEqual(idf2.airterminalsingleductuserdefineds[0].plant_connection_1_inlet_node_name, var_plant_connection_1_inlet_node_name)
        self.assertEqual(idf2.airterminalsingleductuserdefineds[0].plant_connection_1_outlet_node_name, var_plant_connection_1_outlet_node_name)
        self.assertEqual(idf2.airterminalsingleductuserdefineds[0].plant_connection_2_inlet_node_name, var_plant_connection_2_inlet_node_name)
        self.assertEqual(idf2.airterminalsingleductuserdefineds[0].plant_connection_2_outlet_node_name, var_plant_connection_2_outlet_node_name)
        self.assertEqual(idf2.airterminalsingleductuserdefineds[0].supply_inlet_water_storage_tank_name, var_supply_inlet_water_storage_tank_name)
        self.assertEqual(idf2.airterminalsingleductuserdefineds[0].collection_outlet_water_storage_tank_name, var_collection_outlet_water_storage_tank_name)
        self.assertEqual(idf2.airterminalsingleductuserdefineds[0].ambient_zone_name, var_ambient_zone_name)