...
class TestAirLoopHvacUnitaryFurnaceHeatCool(unittest.TestCase):
    ...
    def test_create_airloophvacunitaryfurnaceheatcool(self):
        ...
        self.assertAlmostEqual(idf2.airloophvacunitaryfurnaceheatcools[0].cooling_supply_air_flow_rate, var_cooling_supply_air_flow_rate)
        self.assertAlmostEqual(idf2.airloophvacunitaryfurnaceheatcools[0].heating_supply_air_flow_rate, var_heating_supply_air_flow_rate)
        self.assertAlmostEqual(idf2.airloophvacunitaryfurnaceheatcools[0].no_load_supply_air_flow_rate, var_no_load_supply_air_flow_rate)
