...
class TestCurveDoubleExponentialDecay(unittest.TestCase):
    ...
    def test_create_curvedoubleexponentialdecay(self):
        ...
        self.assertAlmostEqual(idf2.curvedoubleexponentialdecays[0].maximum_value_of_x, var_maximum_value_of_x)
        ...
        self.assertEqual(idf2.curvedoubleexponentialdecays[0].input_unit_type_for_x, var_input_unit_type_for_x)
