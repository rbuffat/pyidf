...
class TestCoilCoolingDxSingleSpeedThermalStorage(unittest.TestCase):
    ...
    def test_create_coilcoolingdxsinglespeedthermalstorage(self):
        ...
        # object-list
        var_cooling_and_discharge_mode_storage_disharge_capacity_function_of_temperature_curve_name = "object-list|Cooling And Discharge Mode Storage Disharge Capacity Function of Temperature Curve Name"
        obj.cooling_and_discharge_mode_storage_disharge_capacity_function_of_temperature_curve_name = var_cooling_and_discharge_mode_storage_disharge_capacity_function_of_temperature_curve_name
        # object-list
        var_cooling_and_discharge_mode_storage_disharge_capacity_function_of_flow_fraction_curve_name = "object-list|Cooling And Discharge Mode Storage Disharge Capacity Function of Flow Fraction Curve Name"
        obj.cooling_and_discharge_mode_storage_disharge_capacity_function_of_flow_fraction_curve_name = var_cooling_and_discharge_mode_storage_disharge_capacity_function_of_flow_fraction_curve_name
        # object-list
        ...
        self.assertEqual(idf2.coilcoolingdxsinglespeedthermalstorages[0].cooling_and_discharge_mode_storage_disharge_capacity_function_of_temperature_curve_name, var_cooling_and_discharge_mode_storage_disharge_capacity_function_of_temperature_curve_name)
        self.assertEqual(idf2.coilcoolingdxsinglespeedthermalstorages[0].cooling_and_discharge_mode_storage_disharge_capacity_function_of_flow_fraction_curve_name, var_cooling_and_discharge_mode_storage_disharge_capacity_function_of_flow_fraction_curve_name)
