...
class TestZoneHvacWaterToAirHeatPump(unittest.TestCase):
    ...
    def test_create_zonehvacwatertoairheatpump(self):
        ...
        self.assertAlmostEqual(idf2.zonehvacwatertoairheatpumps[0].cooling_supply_air_flow_rate, var_cooling_supply_air_flow_rate)
        self.assertAlmostEqual(idf2.zonehvacwatertoairheatpumps[0].heating_supply_air_flow_rate, var_heating_supply_air_flow_rate)
        self.assertAlmostEqual(idf2.zonehvacwatertoairheatpumps[0].no_load_supply_air_flow_rate, var_no_load_supply_air_flow_rate)
        self.assertAlmostEqual(idf2.zonehvacwatertoairheatpumps[0].cooling_outdoor_air_flow_rate, var_cooling_outdoor_air_flow_rate)
        self.assertAlmostEqual(idf2.zonehvacwatertoairheatpumps[0].heating_outdoor_air_flow_rate, var_heating_outdoor_air_flow_rate)
        self.assertAlmostEqual(idf2.zonehvacwatertoairheatpumps[0].no_load_outdoor_air_flow_rate, var_no_load_outdoor_air_flow_rate)
