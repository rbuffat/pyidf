...
class TestWallDetailed(unittest.TestCase):
    ...
    def test_create_walldetailed(self):
        ...
        self.assertEqual(idf2.walldetaileds[0].construction_name, var_construction_name)
        self.assertEqual(idf2.walldetaileds[0].zone_name, var_zone_name)
        self.assertEqual(idf2.walldetaileds[0].outside_boundary_condition, var_outside_boundary_condition)
        self.assertEqual(idf2.walldetaileds[0].outside_boundary_condition_object, var_outside_boundary_condition_object)
        self.assertEqual(idf2.walldetaileds[0].sun_exposure, var_sun_exposure)
        self.assertEqual(idf2.walldetaileds[0].wind_exposure, var_wind_exposure)
        self.assertAlmostEqual(idf2.walldetaileds[0].view_factor_to_ground, var_view_factor_to_ground)
        self.assertAlmostEqual(idf2.walldetaileds[0].number_of_vertices, var_number_of_vertices)
        index = obj.extensible_field_index("Vertex 1 X-coordinate")
        self.assertAlmostEqual(idf2.walldetaileds[0].extensibles[0][index], var_vertex_1_xcoordinate)
        index = obj.extensible_field_index("Vertex 1 Y-coordinate")
        self.assertAlmostEqual(idf2.walldetaileds[0].extensibles[0][index], var_vertex_1_ycoordinate)
        index = obj.extensible_field_index("Vertex 1 Z-coordinate")
        self.assertAlmostEqual(idf2.walldetaileds[0].extensibles[0][index], var_vertex_1_zcoordinate)