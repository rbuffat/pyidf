...
class TestAirLoopHvacUnitaryFurnaceHeatOnly(unittest.TestCase):
    ...
    def test_create_airloophvacunitaryfurnaceheatonly(self):

        pyidf.validation_level = ValidationLevel.error

        obj = AirLoopHvacUnitaryFurnaceHeatOnly()
        # alpha
        var_name = "Name"
        obj.name = var_name
        # object-list
        ...
        idf2 = IDF(self.path)
        self.assertEqual(idf2.airloophvacunitaryfurnaceheatonlys[0].name, var_name)
        self.assertEqual(idf2.airloophvacunitaryfurnaceheatonlys[0].availability_schedule_name, var_availability_schedule_name)
        self.assertEqual(idf2.airloophvacunitaryfurnaceheatonlys[0].furnace_air_inlet_node_name, var_furnace_air_inlet_node_name)
        ...
        self.assertEqual(idf2.airloophvacunitaryfurnaceheatonlys[0].fan_placement, var_fan_placement)
        self.assertEqual(idf2.airloophvacunitaryfurnaceheatonlys[0].heating_coil_object_type, var_heating_coil_object_type)
        self.assertEqual(idf2.airloophvacunitaryfurnaceheatonlys[0].heating_coil_name, var_heating_coil_name)