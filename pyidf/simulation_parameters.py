...
class Version(DataObject):
 ...
 'fields': OrderedDict([(u'version identifier', {'name': u'Version Identifier', 'pyname': u'version_identifier', 'default': u'8.4', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': 'alpha'})]),
 'format': u'singleline',
...
class SimulationControl(DataObject):
 ...
 'unique-object': True}
    ...
    def do_hvac_sizing_simulation_for_sizing_periods(self, value="No"):
        """  Corresponds to IDD field `Do HVAC Sizing Simulation for Sizing Periods`
    ...
    def maximum_number_of_hvac_sizing_simulation_passes(self, value=1):
        """  Corresponds to IDD field `Maximum Number of HVAC Sizing Simulation Passes`
...
class ProgramControl(DataObject):
    """ Corresponds to IDD object `ProgramControl`
        ...
        This object is currently disabled
    """
    _schema = {'extensible-fields': OrderedDict(),
