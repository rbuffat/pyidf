...
class Version(DataObject):
 ...
 'fields': OrderedDict([(u'version identifier', {'name': u'Version Identifier', 'pyname': u'version_identifier', 'default': u'7.0', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': 'alpha'})]),
 'format': u'singleline',
 ...
 'unique-object': True}
    ...
    def version_identifier(self):
        """The value of field `Version Identifier`
...
class SimulationControl(DataObject):
 ...
 'unique-object': True}
    ...
    def do_zone_sizing_calculation(self):
        """The value of field `Do Zone Sizing Calculation`
    ...
    def do_system_sizing_calculation(self):
        """The value of field `Do System Sizing Calculation`
    ...
    def do_plant_sizing_calculation(self):
        """The value of field `Do Plant Sizing Calculation`
    ...
    def run_simulation_for_sizing_periods(self):
        """The value of field `Run Simulation for Sizing Periods`
    ...
    def run_simulation_for_weather_file_run_periods(self):
        """The value of field `Run Simulation for Weather File Run Periods`
...
class Building(DataObject):
 ...
 'unique-object': True}
    ...
    def loads_convergence_tolerance_value(self):
        """The value of field `Loads Convergence Tolerance Value`
    ...
    def temperature_convergence_tolerance_value(self):
        """The value of field `Temperature Convergence Tolerance Value`
    ...
    def solar_distribution(self):
        """The value of field `Solar Distribution`
    ...
    def maximum_number_of_warmup_days(self):
        """The value of field `Maximum Number of Warmup Days`
    ...
    def minimum_number_of_warmup_days(self):
        """The value of field `Minimum Number of Warmup Days`
...
class ShadowCalculation(DataObject):
 ...
 'unique-object': True}
    ...
    def calculation_frequency(self):
        """The value of field `Calculation Frequency`
    ...
    def maximum_figures_in_shadow_overlap_calculations(self):
        """The value of field `Maximum Figures in Shadow Overlap Calculations`
    ...
    def polygon_clipping_algorithm(self):
        """The value of field `Polygon Clipping Algorithm`
    ...
    def sky_diffuse_modeling_algorithm(self):
        """The value of field `Sky Diffuse Modeling Algorithm`
...
class SurfaceConvectionAlgorithmInside(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict(),
 'fields': OrderedDict([(u'algorithm', {'name': u'Algorithm', 'pyname': u'algorithm', 'default': u'TARP', 'required-field': True, 'autosizable': False, 'accepted-values': [u'Simple', u'TARP', u'CeilingDiffuser', u'AdaptiveConvectionAlgorithm'], 'autocalculatable': False, 'type': 'alpha'})]),
 'format': u'singleline',
 'group': u'Simulation Parameters',
 'min-fields': 0,
...
class SurfaceConvectionAlgorithmOutside(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict(),
 'fields': OrderedDict([(u'algorithm', {'name': u'Algorithm', 'pyname': u'algorithm', 'default': u'DOE-2', 'required-field': True, 'autosizable': False, 'accepted-values': [u'SimpleCombined', u'TARP', u'MoWiTT', u'DOE-2', u'AdaptiveConvectionAlgorithm'], 'autocalculatable': False, 'type': 'alpha'})]),
 'format': u'singleline',
 'group': u'Simulation Parameters',
 'min-fields': 0,
...
class HeatBalanceAlgorithm(DataObject):
 ...
 'unique-object': True}
    ...
    def surface_temperature_upper_limit(self):
        """The value of field `Surface Temperature Upper Limit`
    ...
    def minimum_surface_convection_heat_transfer_coefficient_value(self):
        """The value of field `Minimum Surface Convection Heat Transfer Coefficient Value`
    ...
    def maximum_surface_convection_heat_transfer_coefficient_value(self):
        """The value of field `Maximum Surface Convection Heat Transfer Coefficient Value`
...
class HeatBalanceSettingsConductionFiniteDifference(DataObject):
 ...
 'unique-object': True}
    ...
    def difference_scheme(self):
        """The value of field `Difference Scheme`
    ...
    def space_discretization_constant(self):
        """The value of field `Space Discretization Constant`
    ...
    def relaxation_factor(self):
        """The value of field `Relaxation Factor`
    ...
    def inside_face_surface_temperature_convergence_criteria(self):
        """The value of field `Inside Face Surface Temperature Convergence Criteria`
...
class ZoneAirHeatBalanceAlgorithm(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict(),
 'fields': OrderedDict([(u'algorithm', {'name': u'Algorithm', 'pyname': u'algorithm', 'default': u'ThirdOrderBackwardDifference', 'required-field': False, 'autosizable': False, 'accepted-values': [u'ThirdOrderBackwardDifference', u'AnalyticalSolution', u'EulerMethod'], 'autocalculatable': False, 'type': 'alpha'})]),
 'format': u'singleline',
 'group': u'Simulation Parameters',
 'min-fields': 0,
...
class ZoneAirContaminantBalance(DataObject):
 ...
 'unique-object': True}
    ...
    def carbon_dioxide_concentration(self):
        """The value of field `Carbon Dioxide Concentration`
    ...
    def outdoor_carbon_dioxide_schedule_name(self):
        """The value of field `Outdoor Carbon Dioxide Schedule Name`
    ...
    def generic_contaminant_concentration(self):
        """The value of field `Generic Contaminant Concentration`
    ...
    def outdoor_generic_contaminant_schedule_name(self):
        """The value of field `Outdoor Generic Contaminant Schedule Name`
...
class ZoneAirMassFlowConservation(DataObject):
 ...
 'unique-object': True}
    ...
    def adjust_zone_mixing_for_zone_air_mass_flow_balance(self):
        """The value of field `Adjust Zone Mixing For Zone Air Mass Flow Balance`
    ...
    def source_zone_infiltration_treatment(self):
        """The value of field `Source Zone Infiltration Treatment`
...
class ZoneCapacitanceMultiplierResearchSpecial(DataObject):
 ...
 'unique-object': True}
    ...
    def temperature_capacity_multiplier(self):
        """The value of field `Temperature Capacity Multiplier`
    ...
    def humidity_capacity_multiplier(self):
        """The value of field `Humidity Capacity Multiplier`
    ...
    def carbon_dioxide_capacity_multiplier(self):
        """The value of field `Carbon Dioxide Capacity Multiplier`
    ...
    def generic_contaminant_capacity_multiplier(self):
        """The value of field `Generic Contaminant Capacity Multiplier`
...
class Timestep(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict(),
 'fields': OrderedDict([(u'number of timesteps per hour', {'name': u'Number of Timesteps per Hour', 'pyname': u'number_of_timesteps_per_hour', 'default': 6, 'maximum': 60, 'required-field': True, 'autosizable': False, 'minimum': 1, 'autocalculatable': False, 'type': u'integer'})]),
 'format': u'singleline',
 'group': u'Simulation Parameters',
 'min-fields': 0,
 'name': u'Timestep',
 ...
 'unique-object': True}
    ...
    def number_of_timesteps_per_hour(self):
        """The value of field `Number of Timesteps per Hour`
...
class ConvergenceLimits(DataObject):
 ...
 'unique-object': True}
    ...
    def minimum_system_timestep(self):
        """The value of field `Minimum System Timestep`
    ...
    def maximum_hvac_iterations(self):
        """The value of field `Maximum HVAC Iterations`
    ...
    def minimum_plant_iterations(self):
        """The value of field `Minimum Plant Iterations`
    ...
    def maximum_plant_iterations(self):
        """The value of field `Maximum Plant Iterations`
...
class ProgramControl(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict(),
 'fields': OrderedDict([(u'number of threads allowed', {'name': u'Number of Threads Allowed', 'pyname': u'number_of_threads_allowed', 'required-field': False, 'autosizable': False, 'minimum': 0, 'autocalculatable': False, 'type': u'integer'})]),
 'format': None,
 'group': u'Simulation Parameters',
 'min-fields': 0,
 ...
 'unique-object': False}
    ...
    def number_of_threads_allowed(self):
        """The value of field `Number of Threads Allowed`
