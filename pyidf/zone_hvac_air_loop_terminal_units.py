...
class AirTerminalSingleDuctConstantVolumeFourPipeBeam(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict(),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'}), (u'primary air availability schedule name', {'name': u'Primary Air Availability Schedule Name', 'pyname': u'primary_air_availability_schedule_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'cooling availability schedule name', {'name': u'Cooling Availability Schedule Name', 'pyname': u'cooling_availability_schedule_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'heating availability schedule name', {'name': u'Heating Availability Schedule Name', 'pyname': u'heating_availability_schedule_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'primary air inlet node name', {'name': u'Primary Air Inlet Node Name', 'pyname': u'primary_air_inlet_node_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'node'}), (u'primary air outlet node name', {'name': u'Primary Air Outlet Node Name', 'pyname': u'primary_air_outlet_node_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'node'}), (u'chilled water inlet node name', {'name': u'Chilled Water Inlet Node Name', 'pyname': u'chilled_water_inlet_node_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'node'}), (u'chilled water outlet node name', {'name': u'Chilled Water Outlet Node Name', 'pyname': u'chilled_water_outlet_node_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'node'}), (u'hot water inlet node name', {'name': u'Hot Water Inlet Node Name', 'pyname': u'hot_water_inlet_node_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'node'}), (u'hot water outlet node name', {'name': u'Hot Water Outlet Node Name', 'pyname': u'hot_water_outlet_node_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'node'}), (u'design primary air volume flow rate', {'name': u'Design Primary Air Volume Flow Rate', 'pyname': u'design_primary_air_volume_flow_rate', 'default': 'autosize', 'required-field': False, 'autosizable': True, 'minimum': 0.0, 'autocalculatable': False, 'type': u'real', 'unit': u'm3/s'}), (u'design chilled water volume flow rate', {'name': u'Design Chilled Water Volume Flow Rate', 'pyname': u'design_chilled_water_volume_flow_rate', 'default': 'autosize', 'required-field': False, 'autosizable': True, 'minimum': 0.0, 'autocalculatable': False, 'type': u'real', 'unit': u'm3/s'}), (u'design hot water volume flow rate', {'name': u'Design Hot Water Volume Flow Rate', 'pyname': u'design_hot_water_volume_flow_rate', 'default': 'autosize', 'required-field': False, 'autosizable': True, 'minimum': 0.0, 'autocalculatable': False, 'type': u'real', 'unit': u'm3/s'}), (u'zone total beam length', {'name': u'Zone Total Beam Length', 'pyname': u'zone_total_beam_length', 'default': 'autosize', 'minimum>': 0.0, 'required-field': False, 'autosizable': True, 'autocalculatable': False, 'type': u'real', 'unit': u'm'}), (u'rated primary air flow rate per beam length', {'name': u'Rated Primary Air Flow Rate per Beam Length', 'pyname': u'rated_primary_air_flow_rate_per_beam_length', 'default': 0.035, 'minimum>': 0.0, 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'm3/s-m'}), (u'beam rated cooling capacity per beam length', {'name': u'Beam Rated Cooling Capacity per Beam Length', 'pyname': u'beam_rated_cooling_capacity_per_beam_length', 'default': 600.0, 'minimum>': 0.0, 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'W/m'}), (u'beam rated cooling room air chilled water temperature difference', {'name': u'Beam Rated Cooling Room Air Chilled Water Temperature Difference', 'pyname': u'beam_rated_cooling_room_air_chilled_water_temperature_difference', 'default': 10.0, 'minimum>': 0.0, 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'deltaC'}), (u'beam rated chilled water volume flow rate per beam length', {'name': u'Beam Rated Chilled Water Volume Flow Rate per Beam Length', 'pyname': u'beam_rated_chilled_water_volume_flow_rate_per_beam_length', 'default': 5e-05, 'minimum>': 0.0, 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'm3/s-m'}), (u'beam cooling capacity temperature difference modification factor curve name', {'name': u'Beam Cooling Capacity Temperature Difference Modification Factor Curve Name', 'pyname': u'beam_cooling_capacity_temperature_difference_modification_factor_curve_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'beam cooling capacity air flow modification factor curve name', {'name': u'Beam Cooling Capacity Air Flow Modification Factor Curve Name', 'pyname': u'beam_cooling_capacity_air_flow_modification_factor_curve_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'beam cooling capacity chilled water flow modification factor curve name', {'name': u'Beam Cooling Capacity Chilled Water Flow Modification Factor Curve Name', 'pyname': u'beam_cooling_capacity_chilled_water_flow_modification_factor_curve_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'beam rated heating capacity per beam length', {'name': u'Beam Rated Heating Capacity per Beam Length', 'pyname': u'beam_rated_heating_capacity_per_beam_length', 'default': 1500.0, 'minimum>': 0.0, 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'W/m'}), (u'beam rated heating room air hot water temperature difference', {'name': u'Beam Rated Heating Room Air Hot Water Temperature Difference', 'pyname': u'beam_rated_heating_room_air_hot_water_temperature_difference', 'default': 27.8, 'minimum>': 0.0, 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'deltaC'}), (u'beam rated hot water volume flow rate per beam length', {'name': u'Beam Rated Hot Water Volume Flow Rate per Beam Length', 'pyname': u'beam_rated_hot_water_volume_flow_rate_per_beam_length', 'default': 5e-05, 'minimum>': 0.0, 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'm3/s-m'}), (u'beam heating capacity temperature difference modification factor curve name', {'name': u'Beam Heating Capacity Temperature Difference Modification Factor Curve Name', 'pyname': u'beam_heating_capacity_temperature_difference_modification_factor_curve_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'beam heating capacity air flow modification factor curve name', {'name': u'Beam Heating Capacity Air Flow Modification Factor Curve Name', 'pyname': u'beam_heating_capacity_air_flow_modification_factor_curve_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'beam heating capacity hot water flow modification factor curve name', {'name': u'Beam Heating Capacity Hot Water Flow Modification Factor Curve Name', 'pyname': u'beam_heating_capacity_hot_water_flow_modification_factor_curve_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'})]),
 'format': None,
 'group': u'Zone HVAC Air Loop Terminal Units',
 'min-fields': 0,
 ...
 'unique-object': False}
    ...
    def rated_primary_air_flow_rate_per_beam_length(self, value=0.035):
        """  Corresponds to IDD field `Rated Primary Air Flow Rate per Beam Length`
    ...
    def beam_rated_cooling_capacity_per_beam_length(self, value=600.0):
        """  Corresponds to IDD field `Beam Rated Cooling Capacity per Beam Length`
    ...
    def beam_rated_cooling_room_air_chilled_water_temperature_difference(self):
        ...
        """
        return self["Beam Rated Cooling Room Air Chilled Water Temperature Difference"]

    @beam_rated_cooling_room_air_chilled_water_temperature_difference.setter
    def beam_rated_cooling_room_air_chilled_water_temperature_difference(self, value=10.0):
        """  Corresponds to IDD field `Beam Rated Cooling Room Air Chilled Water Temperature Difference`

        """
        self["Beam Rated Cooling Room Air Chilled Water Temperature Difference"] = value
    ...
    def beam_rated_chilled_water_volume_flow_rate_per_beam_length(self):
        ...
        """
        return self["Beam Rated Chilled Water Volume Flow Rate per Beam Length"]

    @beam_rated_chilled_water_volume_flow_rate_per_beam_length.setter
    def beam_rated_chilled_water_volume_flow_rate_per_beam_length(self, value=5e-05):
        """  Corresponds to IDD field `Beam Rated Chilled Water Volume Flow Rate per Beam Length`

        """
        self["Beam Rated Chilled Water Volume Flow Rate per Beam Length"] = value

    @property
    def beam_cooling_capacity_temperature_difference_modification_factor_curve_name(self):
        ...
        """
        return self["Beam Cooling Capacity Temperature Difference Modification Factor Curve Name"]

    @beam_cooling_capacity_temperature_difference_modification_factor_curve_name.setter
    def beam_cooling_capacity_temperature_difference_modification_factor_curve_name(self, value=None):
        """  Corresponds to IDD field `Beam Cooling Capacity Temperature Difference Modification Factor Curve Name`

        """
        self["Beam Cooling Capacity Temperature Difference Modification Factor Curve Name"] = value
    ...
    def beam_cooling_capacity_air_flow_modification_factor_curve_name(self):
        ...
        """
        return self["Beam Cooling Capacity Air Flow Modification Factor Curve Name"]

    @beam_cooling_capacity_air_flow_modification_factor_curve_name.setter
    def beam_cooling_capacity_air_flow_modification_factor_curve_name(self, value=None):
        """  Corresponds to IDD field `Beam Cooling Capacity Air Flow Modification Factor Curve Name`

        """
        self["Beam Cooling Capacity Air Flow Modification Factor Curve Name"] = value

    @property
    def beam_cooling_capacity_chilled_water_flow_modification_factor_curve_name(self):
        ...
        """
        return self["Beam Cooling Capacity Chilled Water Flow Modification Factor Curve Name"]

    @beam_cooling_capacity_chilled_water_flow_modification_factor_curve_name.setter
    def beam_cooling_capacity_chilled_water_flow_modification_factor_curve_name(self, value=None):
        """  Corresponds to IDD field `Beam Cooling Capacity Chilled Water Flow Modification Factor Curve Name`

        """
        self["Beam Cooling Capacity Chilled Water Flow Modification Factor Curve Name"] = value
    ...
    def beam_rated_heating_capacity_per_beam_length(self, value=1500.0):
        """  Corresponds to IDD field `Beam Rated Heating Capacity per Beam Length`
    ...
    def beam_rated_heating_room_air_hot_water_temperature_difference(self):
        ...
        """
        return self["Beam Rated Heating Room Air Hot Water Temperature Difference"]

    @beam_rated_heating_room_air_hot_water_temperature_difference.setter
    def beam_rated_heating_room_air_hot_water_temperature_difference(self, value=27.8):
        """  Corresponds to IDD field `Beam Rated Heating Room Air Hot Water Temperature Difference`

        """
        self["Beam Rated Heating Room Air Hot Water Temperature Difference"] = value
    ...
    def beam_rated_hot_water_volume_flow_rate_per_beam_length(self, value=5e-05):
        """  Corresponds to IDD field `Beam Rated Hot Water Volume Flow Rate per Beam Length`

        """
        self["Beam Rated Hot Water Volume Flow Rate per Beam Length"] = value

    @property
    def beam_heating_capacity_temperature_difference_modification_factor_curve_name(self):
        ...
        """
        return self["Beam Heating Capacity Temperature Difference Modification Factor Curve Name"]

    @beam_heating_capacity_temperature_difference_modification_factor_curve_name.setter
    def beam_heating_capacity_temperature_difference_modification_factor_curve_name(self, value=None):
        """  Corresponds to IDD field `Beam Heating Capacity Temperature Difference Modification Factor Curve Name`

        """
        self["Beam Heating Capacity Temperature Difference Modification Factor Curve Name"] = value
    ...
    def beam_heating_capacity_air_flow_modification_factor_curve_name(self):
        ...
        """
        return self["Beam Heating Capacity Air Flow Modification Factor Curve Name"]

    @beam_heating_capacity_air_flow_modification_factor_curve_name.setter
    def beam_heating_capacity_air_flow_modification_factor_curve_name(self, value=None):
        """  Corresponds to IDD field `Beam Heating Capacity Air Flow Modification Factor Curve Name`

        """
        self["Beam Heating Capacity Air Flow Modification Factor Curve Name"] = value

    @property
    def beam_heating_capacity_hot_water_flow_modification_factor_curve_name(self):
        ...
        """
        return self["Beam Heating Capacity Hot Water Flow Modification Factor Curve Name"]

    @beam_heating_capacity_hot_water_flow_modification_factor_curve_name.setter
    def beam_heating_capacity_hot_water_flow_modification_factor_curve_name(self, value=None):
        """  Corresponds to IDD field `Beam Heating Capacity Hot Water Flow Modification Factor Curve Name`

        """
        self["Beam Heating Capacity Hot Water Flow Modification Factor Curve Name"] = value
...
class AirTerminalSingleDuctInletSideMixer(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict(),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': 'alpha'}), (u'zonehvac terminal unit object type', {'name': u'ZoneHVAC Terminal Unit Object Type', 'pyname': u'zonehvac_terminal_unit_object_type', 'required-field': True, 'autosizable': False, 'accepted-values': [u'ZoneHVAC:FourPipeFanCoil', u'ZoneHVAC:WaterToAirHeatPump'], 'autocalculatable': False, 'type': 'alpha'}), (u'zonehvac terminal unit name', {'name': u'ZoneHVAC Terminal Unit Name', 'pyname': u'zonehvac_terminal_unit_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'terminal unit outlet node name', {'name': u'Terminal Unit Outlet Node Name', 'pyname': u'terminal_unit_outlet_node_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'node'}), (u'terminal unit primary air inlet node name', {'name': u'Terminal Unit Primary Air Inlet Node Name', 'pyname': u'terminal_unit_primary_air_inlet_node_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'node'}), (u'terminal unit secondary air inlet node name', {'name': u'Terminal Unit Secondary Air Inlet Node Name', 'pyname': u'terminal_unit_secondary_air_inlet_node_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'node'})]),
 'format': None,
 'group': u'Zone HVAC Air Loop Terminal Units',
 'min-fields': 0,
...
class AirTerminalDualDuctConstantVolume(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict(),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': 'alpha'}), (u'availability schedule name', {'name': u'Availability Schedule Name', 'pyname': u'availability_schedule_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'air outlet node name', {'name': u'Air Outlet Node Name', 'pyname': u'air_outlet_node_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'node'}), (u'hot air inlet node name', {'name': u'Hot Air Inlet Node Name', 'pyname': u'hot_air_inlet_node_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'node'}), (u'cold air inlet node name', {'name': u'Cold Air Inlet Node Name', 'pyname': u'cold_air_inlet_node_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'node'}), (u'maximum air flow rate', {'name': u'Maximum Air Flow Rate', 'pyname': u'maximum_air_flow_rate', 'required-field': True, 'autosizable': True, 'minimum': 0.0, 'autocalculatable': False, 'type': 'real', 'unit': u'm3/s'})]),
 'format': None,
 'group': u'Zone HVAC Air Loop Terminal Units',
 'min-fields': 6,
