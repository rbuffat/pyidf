...
class ConnectorSplitter(DataObject):
    ...
    """
    schema = {'extensible-fields': OrderedDict([(u'outlet branch name', {'name': u'Outlet Branch Name', 'pyname': u'outlet_branch_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'})]),
...
class ConnectorMixer(DataObject):
    """ Corresponds to IDD object `Connector:Mixer`
        ...
        a single mixer list.
    """
    schema = {'extensible-fields': OrderedDict([(u'inlet branch name', {'name': u'Inlet Branch Name', 'pyname': u'inlet_branch_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'})]),
...
class NodeList(DataObject):
    ...
    """
    schema = {'extensible-fields': OrderedDict([(u'node name', {'name': u'Node Name', 'pyname': u'node_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'node'})]),
...
class OutdoorAirNodeList(DataObject):
    """ Corresponds to IDD object `OutdoorAir:NodeList`
        ...
        an OutdoorAir:NodeList object.
    """
    schema = {'extensible-fields': OrderedDict([(u'node or nodelist name 1', {'name': u'Node or NodeList Name 1', 'pyname': u'node_or_nodelist_name_1', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'node'})]),
 'fields': OrderedDict(),
 'format': None,
 'group': u'Node',
 'min-fields': 1,
...
class PipingSystemUndergroundDomain(DataObject):
    ...
    """
    schema = {'extensible-fields': OrderedDict([(u'pipe circuit 1', {'name': u'Pipe Circuit 1', 'pyname': u'pipe_circuit_1', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'})]),
...
class PipingSystemUndergroundPipeCircuit(DataObject):
    ...
    """
    schema = {'extensible-fields': OrderedDict([(u'pipe segment 1', {'name': u'Pipe Segment 1', 'pyname': u'pipe_segment_1', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'})]),
