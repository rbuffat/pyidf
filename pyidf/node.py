...
class BranchList(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict([(u'branch 1 name', {'name': u'Branch 1 Name', 'pyname': u'branch_1_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'})]),
...
class ConnectorSplitter(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict([(u'outlet branch 1 name', {'name': u'Outlet Branch 1 Name', 'pyname': u'outlet_branch_1_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'})]),
 ...
 'unique-object': False}
    ...
    def add_extensible(self,
        ...
        """
        vals = []
        outlet_branch_1_name = self.check_value("Outlet Branch 1 Name", outlet_branch_1_name)
...
class ConnectorMixer(DataObject):
    """ Corresponds to IDD object `Connector:Mixer`
        ...
        a single mixer list.
    """
    _schema = {'extensible-fields': OrderedDict([(u'inlet branch 1 name', {'name': u'Inlet Branch 1 Name', 'pyname': u'inlet_branch_1_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'})]),
 ...
 'unique-object': False}
    ...
    def add_extensible(self,
        ...
        """
        vals = []
        inlet_branch_1_name = self.check_value("Inlet Branch 1 Name", inlet_branch_1_name)
...
class NodeList(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict([(u'node 1 name', {'name': u'Node 1 Name', 'pyname': u'node_1_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'node'})]),
...
class OutdoorAirNodeList(DataObject):
    """ Corresponds to IDD object `OutdoorAir:NodeList`
        ...
        an OutdoorAir:NodeList object.
    """
    _schema = {'extensible-fields': OrderedDict([(u'node or nodelist name 1', {'name': u'Node or NodeList Name 1', 'pyname': u'node_or_nodelist_name_1', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'node'})]),
 'fields': OrderedDict(),
 'format': None,
 'group': u'Node',
 'min-fields': 0,
