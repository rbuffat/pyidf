...
class Branch(DataObject):
 ...
 'unique-object': False}
    ...
    def pressure_drop_curve_name(self):
        """The value of field `Pressure Drop Curve Name`
...
class ConnectorSplitter(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict([(u'outlet branch name', {'name': u'Outlet Branch Name', 'pyname': u'outlet_branch_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'})]),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': 'alpha'}), (u'inlet branch name', {'name': u'Inlet Branch Name', 'pyname': u'inlet_branch_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'})]),
 'format': None,
 'group': u'Node',
 'min-fields': 3,
 ...
 'unique-object': False}
    ...
    def inlet_branch_name(self):
        """The value of field `Inlet Branch Name`
...
class ConnectorMixer(DataObject):
    """ Corresponds to IDD object `Connector:Mixer`
        ...
        a single mixer list.
    """
    _schema = {'extensible-fields': OrderedDict([(u'inlet branch name', {'name': u'Inlet Branch Name', 'pyname': u'inlet_branch_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'})]),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': 'alpha'}), (u'outlet branch name', {'name': u'Outlet Branch Name', 'pyname': u'outlet_branch_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'})]),
 'format': None,
 'group': u'Node',
 'min-fields': 3,
 ...
 'unique-object': False}
    ...
    def outlet_branch_name(self):
        """The value of field `Outlet Branch Name`
...
class ConnectorList(DataObject):
 ...
 'unique-object': False}
    ...
    def connector_1_object_type(self):
        """The value of field `Connector 1 Object Type`
    ...
    def connector_1_name(self):
        """The value of field `Connector 1 Name`
    ...
    def connector_2_object_type(self):
        """The value of field `Connector 2 Object Type`
    ...
    def connector_2_name(self):
        """The value of field `Connector 2 Name`
...
class NodeList(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict([(u'node name', {'name': u'Node Name', 'pyname': u'node_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'node'})]),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'node'})]),
 'format': None,
 'group': u'Node',
 'min-fields': 2,
 'name': u'NodeList',
...
class OutdoorAirNode(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict(),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'node'}), (u'height above ground', {'name': u'Height Above Ground', 'pyname': u'height_above_ground', 'default': -1.0, 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'm'})]),
 'format': None,
 'group': u'Node',
 'min-fields': 0,
 ...
 'unique-object': False}
    ...
    def height_above_ground(self):
        """The value of field `Height Above Ground`
...
class OutdoorAirNodeList(DataObject):
    """ Corresponds to IDD object `OutdoorAir:NodeList`
        ...
        an OutdoorAir:NodeList object.
    """
    _schema = {'extensible-fields': OrderedDict([(u'node or nodelist name 1', {'name': u'Node or NodeList Name 1', 'pyname': u'node_or_nodelist_name_1', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'node'})]),
 'fields': OrderedDict(),
 'format': None,
 'group': u'Node',
 'min-fields': 1,
...
class PipeAdiabatic(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict(),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': 'alpha'}), (u'inlet node name', {'name': u'Inlet Node Name', 'pyname': u'inlet_node_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'node'}), (u'outlet node name', {'name': u'Outlet Node Name', 'pyname': u'outlet_node_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'node'})]),
 'format': None,
 'group': u'Node',
 'min-fields': 0,
...
class PipeIndoor(DataObject):
 ...
 'unique-object': False}
    ...
    def environment_type(self):
        """The value of field `Environment Type`
    ...
    def ambient_temperature_zone_name(self):
        """The value of field `Ambient Temperature Zone Name`
    ...
    def ambient_temperature_schedule_name(self):
        """The value of field `Ambient Temperature Schedule Name`
    ...
    def ambient_air_velocity_schedule_name(self):
        """The value of field `Ambient Air Velocity Schedule Name`
    ...
    def pipe_inside_diameter(self):
        """The value of field `Pipe Inside Diameter`
...
class PipeOutdoor(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict(),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': 'alpha'}), (u'construction name', {'name': u'Construction Name', 'pyname': u'construction_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'fluid inlet node name', {'name': u'Fluid Inlet Node Name', 'pyname': u'fluid_inlet_node_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'node'}), (u'fluid outlet node name', {'name': u'Fluid Outlet Node Name', 'pyname': u'fluid_outlet_node_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'node'}), (u'ambient temperature outdoor air node name', {'name': u'Ambient Temperature Outdoor Air Node Name', 'pyname': u'ambient_temperature_outdoor_air_node_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'node'}), (u'pipe inside diameter', {'name': u'Pipe Inside Diameter', 'pyname': u'pipe_inside_diameter', 'minimum>': 0.0, 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'm'}), (u'pipe length', {'name': u'Pipe Length', 'pyname': u'pipe_length', 'minimum>': 0.0, 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'm'})]),
 'format': None,
 'group': u'Node',
 'min-fields': 0,
 'name': u'Pipe:Outdoor',
 ...
 'unique-object': False}
    ...
    def ambient_temperature_outdoor_air_node_name(self):
        """The value of field `Ambient Temperature Outdoor Air Node Name`
...
class PipeUnderground(DataObject):
 ...
 'unique-object': False}
    ...
    def soil_material_name(self):
        """The value of field `Soil Material Name`
...
class PipingSystemUndergroundDomain(DataObject):
 ...
 'unique-object': False}
    ...
    def xdirection_mesh_density_parameter(self):
        """The value of field `X-Direction Mesh Density Parameter`
    ...
    def xdirection_mesh_type(self):
        """The value of field `X-Direction Mesh Type`
    ...
    def xdirection_geometric_coefficient(self):
        """The value of field `X-Direction Geometric Coefficient`
        optional
    ...
    def ydirection_mesh_density_parameter(self):
        """The value of field `Y-Direction Mesh Density Parameter`
        If mesh type is symmetric geometric, this should be an even number.
    ...
    def ydirection_mesh_type(self):
        """The value of field `Y-Direction Mesh Type`
    ...
    def ydirection_geometric_coefficient(self):
        """The value of field `Y-Direction Geometric Coefficient`
        optional
        Only used if mesh type is symmetric geometric
    ...
    def zdirection_mesh_density_parameter(self):
        """The value of field `Z-Direction Mesh Density Parameter`
        If mesh type is symmetric geometric, this should be an even number.
    ...
    def zdirection_mesh_type(self):
        """The value of field `Z-Direction Mesh Type`
    ...
    def zdirection_geometric_coefficient(self):
        """The value of field `Z-Direction Geometric Coefficient`
        optional
        Only used if mesh type is symmetric geometric
    ...
    def this_domain_includes_basement_surface_interaction(self):
        """The value of field `This Domain Includes Basement Surface Interaction`
    ...
    def width_of_basement_floor_in_ground_domain(self):
        """The value of field `Width of Basement Floor in Ground Domain`
    ...
    def depth_of_basement_wall_in_ground_domain(self):
        """The value of field `Depth of Basement Wall In Ground Domain`
        Required only if Domain Has Basement Interaction
    ...
    def shift_pipe_x_coordinates_by_basement_width(self):
        """The value of field `Shift Pipe X Coordinates By Basement Width`
        Required only if Domain Has Basement Interaction
    ...
    def name_of_basement_wall_boundary_condition_model(self):
        """The value of field `Name of Basement Wall Boundary Condition Model`
        Required only if Domain Has Basement Interaction
    ...
    def name_of_basement_floor_boundary_condition_model(self):
        """The value of field `Name of Basement Floor Boundary Condition Model`
        Required only if Domain Has Basement Interaction
    ...
    def convergence_criterion_for_the_outer_cartesian_domain_iteration_loop(self):
        """The value of field `Convergence Criterion for the Outer Cartesian Domain Iteration Loop`
    ...
    def maximum_iterations_in_the_outer_cartesian_domain_iteration_loop(self):
        """The value of field `Maximum Iterations in the Outer Cartesian Domain Iteration Loop`
    ...
    def number_of_pipe_circuits_entered_for_this_domain(self):
        """The value of field `Number of Pipe Circuits Entered for this Domain`
...
class PipingSystemUndergroundPipeCircuit(DataObject):
 ...
 'unique-object': False}
    ...
    def circuit_inlet_node(self):
        """The value of field `Circuit Inlet Node`
    ...
    def circuit_outlet_node(self):
        """The value of field `Circuit Outlet Node`
    ...
    def convergence_criterion_for_the_inner_radial_iteration_loop(self):
        """The value of field `Convergence Criterion for the Inner Radial Iteration Loop`
    ...
    def maximum_iterations_in_the_inner_radial_iteration_loop(self):
        """The value of field `Maximum Iterations in the Inner Radial Iteration Loop`
    ...
    def number_of_soil_nodes_in_the_inner_radial_near_pipe_mesh_region(self):
        """The value of field `Number of Soil Nodes in the Inner Radial Near Pipe Mesh Region`
    ...
    def radial_thickness_of_inner_radial_near_pipe_mesh_region(self):
        """The value of field `Radial Thickness of Inner Radial Near Pipe Mesh Region`
    ...
    def number_of_pipe_segments_entered_for_this_pipe_circuit(self):
        """The value of field `Number of Pipe Segments Entered for this Pipe Circuit`
...
class PipingSystemUndergroundPipeSegment(DataObject):
 ...
 'unique-object': False}
    ...
    def flow_direction(self):
        """The value of field `Flow Direction`
