...
class EnergyManagementSystemSensor(DataObject):
 ...
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'}), (u'output:variable or output:meter index key name', {'name': u'Output:Variable or Output:Meter Index Key Name', 'pyname': u'outputvariable_or_outputmeter_index_key_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'}), (u'output:variable or output:meter name', {'name': u'Output:Variable or Output:Meter Name', 'pyname': u'outputvariable_or_outputmeter_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'external-list'})]),
 'format': None,
 ...
 'unique-object': False}
    ...
    def outputvariable_or_outputmeter_index_key_name(self):
        """The value of field `Output:Variable or Output:Meter Index Key Name`
    ...
    def outputvariable_or_outputmeter_name(self):
        """The value of field `Output:Variable or Output:Meter Name`
...
class EnergyManagementSystemActuator(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict(),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'}), (u'actuated component unique name', {'name': u'Actuated Component Unique Name', 'pyname': u'actuated_component_unique_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'}), (u'actuated component type', {'name': u'Actuated Component Type', 'pyname': u'actuated_component_type', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'}), (u'actuated component control type', {'name': u'Actuated Component Control Type', 'pyname': u'actuated_component_control_type', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'})]),
 'format': None,
 'group': u'Energy Management System',
 'min-fields': 4,
 ...
 'unique-object': False}
    ...
    def actuated_component_unique_name(self):
        """The value of field `Actuated Component Unique Name`
    ...
    def actuated_component_type(self):
        """The value of field `Actuated Component Type`
    ...
    def actuated_component_control_type(self):
        """The value of field `Actuated Component Control Type`
...
class EnergyManagementSystemProgramCallingManager(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict([(u'program name 1', {'name': u'Program Name 1', 'pyname': u'program_name_1', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'})]),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'}), (u'energyplus model calling point', {'name': u'EnergyPlus Model Calling Point', 'pyname': u'energyplus_model_calling_point', 'required-field': False, 'autosizable': False, 'accepted-values': [u'BeginNewEnvironment', u'AfterNewEnvironmentWarmUpIsComplete', u'BeginTimestepBeforePredictor', u'AfterPredictorBeforeHVACManagers', u'AfterPredictorAfterHVACManagers', u'InsideHVACSystemIterationLoop', u'EndOfZoneTimestepBeforeZoneReporting', u'EndOfZoneTimestepAfterZoneReporting', u'EndOfSystemTimestepBeforeHVACReporting', u'EndOfSystemTimestepAfterHVACReporting', u'EndOfZoneSizing', u'EndOfSystemSizing', u'AfterComponentInputReadIn', u'UserDefinedComponentModel', u'UnitarySystemSizing'], 'autocalculatable': False, 'type': 'alpha'})]),
 'format': None,
 'group': u'Energy Management System',
 'min-fields': 3,
 ...
 'unique-object': False}
    ...
    def energyplus_model_calling_point(self):
        """The value of field `EnergyPlus Model Calling Point`
...
class EnergyManagementSystemProgram(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict([(u'program line 1', {'name': u'Program Line 1', 'pyname': u'program_line_1', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'})]),
...
class EnergyManagementSystemSubroutine(DataObject):
    """ Corresponds to IDD object `EnergyManagementSystem:Subroutine`
        ...
        Each field after the name is a line of EMS Runtime Language
    """
    _schema = {'extensible-fields': OrderedDict([(u'program line', {'name': u'Program Line', 'pyname': u'program_line', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'})]),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'})]),
 'format': None,
 'group': u'Energy Management System',
 'min-fields': 2,
...
class EnergyManagementSystemGlobalVariable(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict([(u'erl variable 1 name', {'name': u'Erl Variable 1 Name', 'pyname': u'erl_variable_1_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'})]),
 'fields': OrderedDict(),
 'format': None,
 'group': u'Energy Management System',
 'min-fields': 1,
 ...
 'unique-object': False}
    ...
    def add_extensible(self,
        ...
        """
        vals = []
        erl_variable_1_name = self.check_value("Erl Variable 1 Name", erl_variable_1_name)
...
class EnergyManagementSystemOutputVariable(DataObject):
 ...
 'unique-object': False}
    ...
    def ems_variable_name(self):
        """The value of field `EMS Variable Name`
    ...
    def type_of_data_in_variable(self):
        """The value of field `Type of Data in Variable`
    ...
    def update_frequency(self):
        """The value of field `Update Frequency`
    ...
    def ems_program_or_subroutine_name(self):
        """The value of field `EMS Program or Subroutine Name`
...
class EnergyManagementSystemMeteredOutputVariable(DataObject):
 ...
 'unique-object': False}
    ...
    def resource_type(self):
        """The value of field `Resource Type`
    ...
    def enduse_category(self):
        """The value of field `End-Use Category`
...
class EnergyManagementSystemTrendVariable(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict(),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'}), (u'ems variable name', {'name': u'EMS Variable Name', 'pyname': u'ems_variable_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'}), (u'number of timesteps to be logged', {'name': u'Number of Timesteps to be Logged', 'pyname': u'number_of_timesteps_to_be_logged', 'required-field': True, 'autosizable': False, 'minimum': 1, 'autocalculatable': False, 'type': u'integer'})]),
 'format': None,
 'group': u'Energy Management System',
 'min-fields': 3,
 ...
 'unique-object': False}
    ...
    def number_of_timesteps_to_be_logged(self):
        """The value of field `Number of Timesteps to be Logged`
...
class EnergyManagementSystemInternalVariable(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict(),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'}), (u'internal data index key name', {'name': u'Internal Data Index Key Name', 'pyname': u'internal_data_index_key_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'}), (u'internal data type', {'name': u'Internal Data Type', 'pyname': u'internal_data_type', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'})]),
 'format': None,
 'group': u'Energy Management System',
 'min-fields': 3,
 ...
 'unique-object': False}
    ...
    def internal_data_index_key_name(self):
        """The value of field `Internal Data Index Key Name`
    ...
    def internal_data_type(self):
        """The value of field `Internal Data Type`
...
class EnergyManagementSystemCurveOrTableIndexVariable(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict(),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'}), (u'curve or table object name', {'name': u'Curve or Table Object Name', 'pyname': u'curve_or_table_object_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'})]),
 'format': None,
 'group': u'Energy Management System',
 'min-fields': 2,
 ...
 'unique-object': False}
    ...
    def curve_or_table_object_name(self):
        """The value of field `Curve or Table Object Name`
...
class EnergyManagementSystemConstructionIndexVariable(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict(),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'}), (u'construction object name', {'name': u'Construction Object Name', 'pyname': u'construction_object_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'})]),
 'format': None,
 'group': u'Energy Management System',
 'min-fields': 2,
 ...
 'unique-object': False}
    ...
    def construction_object_name(self):
        """The value of field `Construction Object Name`
