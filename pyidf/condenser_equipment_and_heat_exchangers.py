...
class GroundHeatExchangerSlinky(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict(),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': 'alpha'}), (u'inlet node name', {'name': u'Inlet Node Name', 'pyname': u'inlet_node_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'node'}), (u'outlet node name', {'name': u'Outlet Node Name', 'pyname': u'outlet_node_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'node'}), (u'design flow rate', {'name': u'Design Flow Rate', 'pyname': u'design_flow_rate', 'default': 0.002, 'minimum>': 0.0, 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'm3/s'}), (u'soil thermal conductivity', {'name': u'Soil Thermal Conductivity', 'pyname': u'soil_thermal_conductivity', 'default': 1.08, 'minimum>': 0.0, 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'W/m-K'}), (u'soil density', {'name': u'Soil Density', 'pyname': u'soil_density', 'default': 962.0, 'minimum>': 0.0, 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'kg/m3'}), (u'soil specific heat', {'name': u'Soil Specific Heat', 'pyname': u'soil_specific_heat', 'default': 2576.0, 'minimum>': 0.0, 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'J/kg-K'}), (u'pipe thermal conductivity', {'name': u'Pipe Thermal Conductivity', 'pyname': u'pipe_thermal_conductivity', 'default': 0.4, 'minimum>': 0.0, 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'W/m-K'}), (u'pipe density', {'name': u'Pipe Density', 'pyname': u'pipe_density', 'default': 641.0, 'minimum>': 0.0, 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'kg/m3'}), (u'pipe specific heat', {'name': u'Pipe Specific Heat', 'pyname': u'pipe_specific_heat', 'default': 2405.0, 'minimum>': 0.0, 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'J/kg-K'}), (u'pipe outer diameter', {'name': u'Pipe Outer Diameter', 'pyname': u'pipe_outer_diameter', 'default': 0.02667, 'minimum>': 0.0, 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'm'}), (u'pipe thickness', {'name': u'Pipe Thickness', 'pyname': u'pipe_thickness', 'default': 0.002413, 'minimum>': 0.0, 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'm'}), (u'heat exchanger configuration', {'name': u'Heat Exchanger Configuration', 'pyname': u'heat_exchanger_configuration', 'required-field': False, 'autosizable': False, 'accepted-values': [u'Vertical', u'Horizontal'], 'autocalculatable': False, 'type': 'alpha'}), (u'coil diameter', {'name': u'Coil Diameter', 'pyname': u'coil_diameter', 'default': 1.0, 'minimum>': 0.0, 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'm'}), (u'coil pitch', {'name': u'Coil Pitch', 'pyname': u'coil_pitch', 'default': 0.2, 'minimum>': 0.0, 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'm'}), (u'trench depth', {'name': u'Trench Depth', 'pyname': u'trench_depth', 'default': 1.8, 'minimum>': 0.0, 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'm'}), (u'trench length', {'name': u'Trench Length', 'pyname': u'trench_length', 'default': 10.0, 'minimum>': 0.0, 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'm'}), (u'number of trenches', {'name': u'Number of Trenches', 'pyname': u'number_of_trenches', 'default': 1, 'required-field': False, 'autosizable': False, 'minimum': 1, 'autocalculatable': False, 'type': u'integer'}), (u'horizontal spacing between pipes', {'name': u'Horizontal Spacing Between Pipes', 'pyname': u'horizontal_spacing_between_pipes', 'default': 2.0, 'minimum>': 0.0, 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'm'}), (u'undisturbed ground temperature model type', {'name': u'Undisturbed Ground Temperature Model Type', 'pyname': u'undisturbed_ground_temperature_model_type', 'required-field': True, 'autosizable': False, 'accepted-values': [u'Site:GroundTemperature:Undisturbed:FiniteDifference', u'Site:GroundTemperature:Undisturbed:KusudaAchenbach', u'Site:GroundTemperature:Undisturbed:Xing'], 'autocalculatable': False, 'type': 'alpha'}), (u'undisturbed ground temperature model name', {'name': u'Undisturbed Ground Temperature Model Name', 'pyname': u'undisturbed_ground_temperature_model_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'maximum length of simulation', {'name': u'Maximum Length of Simulation', 'pyname': u'maximum_length_of_simulation', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'years'})]),
 'format': None,
 'group': u'Condenser Equipment and Heat Exchangers',
 'min-fields': 0,
