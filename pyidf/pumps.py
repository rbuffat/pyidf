...
class BranchList(DataObject):
    ...
    """
    schema = {'extensible-fields': OrderedDict([(u'branch name', {'name': u'Branch Name', 'pyname': u'branch_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'})]),
