...
class BranchList(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict([(u'branch name', {'name': u'Branch Name', 'pyname': u'branch_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'})]),
...
class PumpVariableSpeed(DataObject):
 ...
 'unique-object': False}
    ...
    def coefficient_1_of_the_part_load_performance_curve(self):
        """The value of field `Coefficient 1 of the Part Load Performance Curve`
    ...
    def coefficient_2_of_the_part_load_performance_curve(self):
        """The value of field `Coefficient 2 of the Part Load Performance Curve`
    ...
    def coefficient_3_of_the_part_load_performance_curve(self):
        """The value of field `Coefficient 3 of the Part Load Performance Curve`
    ...
    def coefficient_4_of_the_part_load_performance_curve(self):
        """The value of field `Coefficient 4 of the Part Load Performance Curve`
    ...
    def pump_control_type(self):
        """The value of field `Pump Control Type`
    ...
    def pump_curve_name(self):
        """The value of field `Pump Curve Name`
    ...
    def impeller_diameter(self):
        """The value of field `Impeller Diameter`
    ...
    def vfd_control_type(self):
        """The value of field `VFD Control Type`
    ...
    def pump_rpm_schedule_name(self):
        """The value of field `Pump rpm Schedule Name`
    ...
    def minimum_pressure_schedule(self):
        """The value of field `Minimum Pressure Schedule`
    ...
    def maximum_pressure_schedule(self):
        """The value of field `Maximum Pressure Schedule`
    ...
    def minimum_rpm_schedule(self):
        """The value of field `Minimum RPM Schedule`
    ...
    def maximum_rpm_schedule(self):
        """The value of field `Maximum RPM Schedule`
    ...
    def skin_loss_radiative_fraction(self):
        """The value of field `Skin Loss Radiative Fraction`
...
class PumpConstantSpeed(DataObject):
 ...
 'unique-object': False}
    ...
    def rotational_speed(self):
        """The value of field `Rotational Speed`
...
class HeaderedPumpsConstantSpeed(DataObject):
 ...
 'unique-object': False}
    ...
    def total_rated_flow_rate(self):
        """The value of field `Total Rated Flow Rate`
    ...
    def number_of_pumps_in_bank(self):
        """The value of field `Number of Pumps in Bank`
    ...
    def flow_sequencing_control_scheme(self):
        """The value of field `Flow Sequencing Control Scheme`
...
class HeaderedPumpsVariableSpeed(DataObject):
 ...
 'unique-object': False}
    ...
    def minimum_flow_rate_fraction(self):
        """The value of field `Minimum Flow Rate Fraction`
        This value can be zero and will be defaulted to that if not specified.
