...
class ExteriorLights(DataObject):
 ...
 'unique-object': False}
    ...
    def control_option(self):
        """The value of field `Control Option`
...
class ExteriorFuelEquipment(DataObject):
 ...
 'unique-object': False}
    ...
    def fuel_use_type(self):
        """The value of field `Fuel Use Type`
