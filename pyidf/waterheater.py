...
class WaterHeaterMixed(object):
    ...
    def __init__(self):
        """ Init data dictionary object for EPW IDD  `WaterHeater:Mixed`
        """
...
class WaterHeaterStratified(object):
    ...
    def __init__(self):
        """ Init data dictionary object for EPW IDD  `WaterHeater:Stratified`
        """
        self._data = OrderedDict()
        self._data["Name"] = None
...
class WaterHeaterSizing(object):
    ...
    def __init__(self):
        """ Init data dictionary object for EPW IDD  `WaterHeater:Sizing`
        """
        self._data = OrderedDict()
...
class WaterHeaterHeatPump(object):
    ...
    def __init__(self):
        """ Init data dictionary object for EPW IDD  `WaterHeater:HeatPump`
        """
        self._data = OrderedDict()
        self._data["Name"] = None
