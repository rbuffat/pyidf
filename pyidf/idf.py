...
class IDF(object):
    ...
    def __init__(self):
        ...
        self._data[u"lead input"] = []
        self._data[u"simulation data"] = []
        self._data[u"version"] = []
        self._data[u"simulationcontrol"] = []
        self._data[u"building"] = []
        self._data[u"shadowcalculation"] = []
        self._data[u"surfaceconvectionalgorithm:inside"] = []
        self._data[u"surfaceconvectionalgorithm:outside"] = []
        self._data[u"heatbalancealgorithm"] = []
        self._data[u"heatbalancesettings:conductionfinitedifference"] = []
        self._data[u"zoneairheatbalancealgorithm"] = []
        self._data[u"zoneaircontaminantbalance"] = []
        self._data[u"zoneairmassflowconservation"] = []
        self._data[u"zonecapacitancemultiplier:researchspecial"] = []
        self._data[u"timestep"] = []
        self._data[u"convergencelimits"] = []
        self._data[u"programcontrol"] = []
        self._data[u"compliance:building"] = []
        self._data[u"site:location"] = []
        self._data[u"sizingperiod:designday"] = []
        self._data[u"sizingperiod:weatherfiledays"] = []
        self._data[u"sizingperiod:weatherfileconditiontype"] = []
        self._data[u"runperiod"] = []
        self._data[u"runperiod:customrange"] = []
        self._data[u"runperiodcontrol:specialdays"] = []
        self._data[u"runperiodcontrol:daylightsavingtime"] = []
        self._data[u"weatherproperty:skytemperature"] = []
        self._data[u"site:weatherstation"] = []
        self._data[u"site:heightvariation"] = []
        self._data[u"site:groundtemperature:buildingsurface"] = []
        self._data[u"site:groundtemperature:fcfactormethod"] = []
        self._data[u"site:groundtemperature:shallow"] = []
        self._data[u"site:groundtemperature:deep"] = []
        self._data[u"site:grounddomain"] = []
        self._data[u"site:groundreflectance"] = []
        self._data[u"site:groundreflectance:snowmodifier"] = []
        self._data[u"site:watermainstemperature"] = []
        self._data[u"site:precipitation"] = []
        self._data[u"roofirrigation"] = []
        self._data[u"site:solarandvisiblespectrum"] = []
        self._data[u"site:spectrumdata"] = []
        self._data[u"scheduletypelimits"] = []
        self._data[u"schedule:day:hourly"] = []
        self._data[u"schedule:day:interval"] = []
        self._data[u"schedule:day:list"] = []
        self._data[u"schedule:week:daily"] = []
        self._data[u"schedule:week:compact"] = []
        self._data[u"schedule:year"] = []
        self._data[u"schedule:compact"] = []
        self._data[u"schedule:constant"] = []
        self._data[u"schedule:file"] = []
        self._data[u"material"] = []
        self._data[u"material:nomass"] = []
        self._data[u"material:infraredtransparent"] = []
        self._data[u"material:airgap"] = []
        self._data[u"material:roofvegetation"] = []
        self._data[u"windowmaterial:simpleglazingsystem"] = []
        self._data[u"windowmaterial:glazing"] = []
        self._data[u"windowmaterial:glazinggroup:thermochromic"] = []
        self._data[u"windowmaterial:glazing:refractionextinctionmethod"] = []
        self._data[u"windowmaterial:gas"] = []
        self._data[u"windowgap:supportpillar"] = []
        self._data[u"windowgap:deflectionstate"] = []
        self._data[u"windowmaterial:gasmixture"] = []
        self._data[u"windowmaterial:gap"] = []
        self._data[u"windowmaterial:shade"] = []
        self._data[u"windowmaterial:complexshade"] = []
        self._data[u"windowmaterial:blind"] = []
        self._data[u"windowmaterial:screen"] = []
        self._data[u"windowmaterial:shade:equivalentlayer"] = []
        self._data[u"windowmaterial:drape:equivalentlayer"] = []
        self._data[u"windowmaterial:blind:equivalentlayer"] = []
        self._data[u"windowmaterial:screen:equivalentlayer"] = []
        self._data[u"windowmaterial:glazing:equivalentlayer"] = []
        self._data[u"construction:windowequivalentlayer"] = []
        self._data[u"windowmaterial:gap:equivalentlayer"] = []
        self._data[u"materialproperty:moisturepenetrationdepth:settings"] = []
        self._data[u"materialproperty:phasechange"] = []
        self._data[u"materialproperty:variablethermalconductivity"] = []
        self._data[u"materialproperty:heatandmoisturetransfer:settings"] = []
        self._data[u"materialproperty:heatandmoisturetransfer:sorptionisotherm"] = []
        self._data[u"materialproperty:heatandmoisturetransfer:suction"] = []
        self._data[u"materialproperty:heatandmoisturetransfer:redistribution"] = []
        self._data[u"materialproperty:heatandmoisturetransfer:diffusion"] = []
        self._data[u"materialproperty:heatandmoisturetransfer:thermalconductivity"] = []
        self._data[u"materialproperty:glazingspectraldata"] = []
        self._data[u"construction"] = []
        self._data[u"construction:cfactorundergroundwall"] = []
        self._data[u"construction:ffactorgroundfloor"] = []
        self._data[u"construction:internalsource"] = []
        self._data[u"windowthermalmodel:params"] = []
        self._data[u"construction:complexfenestrationstate"] = []
        self._data[u"construction:windowdatafile"] = []
        self._data[u"globalgeometryrules"] = []
        self._data[u"geometrytransform"] = []
        self._data[u"zone"] = []
        self._data[u"zonelist"] = []
        self._data[u"zonegroup"] = []
        self._data[u"buildingsurface:detailed"] = []
        self._data[u"wall:detailed"] = []
        self._data[u"roofceiling:detailed"] = []
        self._data[u"floor:detailed"] = []
        self._data[u"wall:exterior"] = []
        self._data[u"wall:adiabatic"] = []
        self._data[u"wall:underground"] = []
        self._data[u"wall:interzone"] = []
        self._data[u"roof"] = []
        self._data[u"ceiling:adiabatic"] = []
        self._data[u"ceiling:interzone"] = []
        self._data[u"floor:groundcontact"] = []
        self._data[u"floor:adiabatic"] = []
        self._data[u"floor:interzone"] = []
        self._data[u"fenestrationsurface:detailed"] = []
        self._data[u"window"] = []
        self._data[u"door"] = []
        self._data[u"glazeddoor"] = []
        self._data[u"window:interzone"] = []
        self._data[u"door:interzone"] = []
        self._data[u"glazeddoor:interzone"] = []
        self._data[u"windowproperty:shadingcontrol"] = []
        self._data[u"windowproperty:frameanddivider"] = []
        self._data[u"windowproperty:airflowcontrol"] = []
        self._data[u"windowproperty:stormwindow"] = []
        self._data[u"internalmass"] = []
        self._data[u"shading:site"] = []
        self._data[u"shading:building"] = []
        self._data[u"shading:site:detailed"] = []
        self._data[u"shading:building:detailed"] = []
        self._data[u"shading:overhang"] = []
        self._data[u"shading:overhang:projection"] = []
        self._data[u"shading:fin"] = []
        self._data[u"shading:fin:projection"] = []
        self._data[u"shading:zone:detailed"] = []
        self._data[u"shadingproperty:reflectance"] = []
        self._data[u"surfaceproperty:heattransferalgorithm"] = []
        self._data[u"surfaceproperty:heattransferalgorithm:multiplesurface"] = []
        self._data[u"surfaceproperty:heattransferalgorithm:surfacelist"] = []
        self._data[u"surfaceproperty:heattransferalgorithm:construction"] = []
        self._data[u"surfacecontrol:movableinsulation"] = []
        self._data[u"surfaceproperty:othersidecoefficients"] = []
        self._data[u"surfaceproperty:othersideconditionsmodel"] = []
        self._data[u"surfaceconvectionalgorithm:inside:adaptivemodelselections"] = []
        self._data[u"surfaceconvectionalgorithm:outside:adaptivemodelselections"] = []
        self._data[u"surfaceconvectionalgorithm:inside:usercurve"] = []
        self._data[u"surfaceconvectionalgorithm:outside:usercurve"] = []
        self._data[u"surfaceproperty:convectioncoefficients"] = []
        self._data[u"surfaceproperty:convectioncoefficients:multiplesurface"] = []
        self._data[u"surfaceproperties:vaporcoefficients"] = []
        self._data[u"surfaceproperty:exteriornaturalventedcavity"] = []
        self._data[u"surfaceproperty:solarincidentinside"] = []
        self._data[u"complexfenestrationproperty:solarabsorbedlayers"] = []
        self._data[u"zoneproperty:userviewfactors:bysurfacename"] = []
        self._data[u"groundheattransfer:control"] = []
        self._data[u"groundheattransfer:slab:materials"] = []
        self._data[u"groundheattransfer:slab:matlprops"] = []
        self._data[u"groundheattransfer:slab:boundconds"] = []
        self._data[u"groundheattransfer:slab:bldgprops"] = []
        self._data[u"groundheattransfer:slab:insulation"] = []
        self._data[u"groundheattransfer:slab:equivalentslab"] = []
        self._data[u"groundheattransfer:slab:autogrid"] = []
        self._data[u"groundheattransfer:slab:manualgrid"] = []
        self._data[u"groundheattransfer:slab:xface"] = []
        self._data[u"groundheattransfer:slab:yface"] = []
        self._data[u"groundheattransfer:slab:zface"] = []
        self._data[u"groundheattransfer:basement:simparameters"] = []
        self._data[u"groundheattransfer:basement:matlprops"] = []
        self._data[u"groundheattransfer:basement:insulation"] = []
        self._data[u"groundheattransfer:basement:surfaceprops"] = []
        self._data[u"groundheattransfer:basement:bldgdata"] = []
        self._data[u"groundheattransfer:basement:interior"] = []
        self._data[u"groundheattransfer:basement:combldg"] = []
        self._data[u"groundheattransfer:basement:equivslab"] = []
        self._data[u"groundheattransfer:basement:equivautogrid"] = []
        self._data[u"groundheattransfer:basement:autogrid"] = []
        self._data[u"groundheattransfer:basement:manualgrid"] = []
        self._data[u"groundheattransfer:basement:xface"] = []
        self._data[u"groundheattransfer:basement:yface"] = []
        self._data[u"groundheattransfer:basement:zface"] = []
        self._data[u"roomairmodeltype"] = []
        self._data[u"roomair:temperaturepattern:userdefined"] = []
        self._data[u"roomair:temperaturepattern:constantgradient"] = []
        self._data[u"roomair:temperaturepattern:twogradient"] = []
        self._data[u"roomair:temperaturepattern:nondimensionalheight"] = []
        self._data[u"roomair:temperaturepattern:surfacemapping"] = []
        self._data[u"roomair:node"] = []
        self._data[u"roomairsettings:onenodedisplacementventilation"] = []
        self._data[u"roomairsettings:threenodedisplacementventilation"] = []
        self._data[u"roomairsettings:crossventilation"] = []
        self._data[u"roomairsettings:underfloorairdistributioninterior"] = []
        self._data[u"roomairsettings:underfloorairdistributionexterior"] = []
        self._data[u"people"] = []
        self._data[u"comfortviewfactorangles"] = []
        self._data[u"lights"] = []
        self._data[u"electricequipment"] = []
        self._data[u"gasequipment"] = []
        self._data[u"hotwaterequipment"] = []
        self._data[u"steamequipment"] = []
        self._data[u"otherequipment"] = []
        self._data[u"zonebaseboard:outdoortemperaturecontrolled"] = []
        self._data[u"zonecontaminantsourceandsink:carbondioxide"] = []
        self._data[u"zonecontaminantsourceandsink:generic:constant"] = []
        self._data[u"surfacecontaminantsourceandsink:generic:pressuredriven"] = []
        self._data[u"zonecontaminantsourceandsink:generic:cutoffmodel"] = []
        self._data[u"zonecontaminantsourceandsink:generic:decaysource"] = []
        self._data[u"surfacecontaminantsourceandsink:generic:boundarylayerdiffusion"] = []
        self._data[u"surfacecontaminantsourceandsink:generic:depositionvelocitysink"] = []
        self._data[u"zonecontaminantsourceandsink:generic:depositionratesink"] = []
        self._data[u"daylighting:controls"] = []
        self._data[u"daylighting:delight:controls"] = []
        self._data[u"daylighting:delight:referencepoint"] = []
        self._data[u"daylighting:delight:complexfenestration"] = []
        self._data[u"daylightingdevice:tubular"] = []
        self._data[u"daylightingdevice:shelf"] = []
        self._data[u"daylightingdevice:lightwell"] = []
        self._data[u"output:daylightfactors"] = []
        self._data[u"output:illuminancemap"] = []
        self._data[u"outputcontrol:illuminancemap:style"] = []
        self._data[u"zoneinfiltration:designflowrate"] = []
        self._data[u"zoneinfiltration:effectiveleakagearea"] = []
        self._data[u"zoneinfiltration:flowcoefficient"] = []
        self._data[u"zoneventilation:designflowrate"] = []
        self._data[u"zoneventilation:windandstackopenarea"] = []
        self._data[u"zoneairbalance:outdoorair"] = []
        self._data[u"zonemixing"] = []
        self._data[u"zonecrossmixing"] = []
        self._data[u"zonerefrigerationdoormixing"] = []
        self._data[u"zoneearthtube"] = []
        self._data[u"zonecooltower:shower"] = []
        self._data[u"zonethermalchimney"] = []
        self._data[u"airflownetwork:simulationcontrol"] = []
        self._data[u"airflownetwork:multizone:zone"] = []
        self._data[u"airflownetwork:multizone:surface"] = []
        self._data[u"airflownetwork:multizone:referencecrackconditions"] = []
        self._data[u"airflownetwork:multizone:surface:crack"] = []
        self._data[u"airflownetwork:multizone:surface:effectiveleakagearea"] = []
        self._data[u"airflownetwork:multizone:component:detailedopening"] = []
        self._data[u"airflownetwork:multizone:component:simpleopening"] = []
        self._data[u"airflownetwork:multizone:component:horizontalopening"] = []
        self._data[u"airflownetwork:multizone:component:zoneexhaustfan"] = []
        self._data[u"airflownetwork:multizone:externalnode"] = []
        self._data[u"airflownetwork:multizone:windpressurecoefficientarray"] = []
        self._data[u"airflownetwork:multizone:windpressurecoefficientvalues"] = []
        self._data[u"airflownetwork:distribution:node"] = []
        self._data[u"airflownetwork:distribution:component:leak"] = []
        self._data[u"airflownetwork:distribution:component:leakageratio"] = []
        self._data[u"airflownetwork:distribution:component:duct"] = []
        self._data[u"airflownetwork:distribution:component:fan"] = []
        self._data[u"airflownetwork:distribution:component:coil"] = []
        self._data[u"airflownetwork:distribution:component:heatexchanger"] = []
        self._data[u"airflownetwork:distribution:component:terminalunit"] = []
        self._data[u"airflownetwork:distribution:component:constantpressuredrop"] = []
        self._data[u"airflownetwork:distribution:linkage"] = []
        self._data[u"exterior:lights"] = []
        self._data[u"exterior:fuelequipment"] = []
        self._data[u"exterior:waterequipment"] = []
        self._data[u"hvactemplate:thermostat"] = []
        self._data[u"hvactemplate:zone:idealloadsairsystem"] = []
        self._data[u"hvactemplate:zone:baseboardheat"] = []
        self._data[u"hvactemplate:zone:fancoil"] = []
        self._data[u"hvactemplate:zone:ptac"] = []
        self._data[u"hvactemplate:zone:pthp"] = []
        self._data[u"hvactemplate:zone:watertoairheatpump"] = []
        self._data[u"hvactemplate:zone:vrf"] = []
        self._data[u"hvactemplate:zone:unitary"] = []
        self._data[u"hvactemplate:zone:vav"] = []
        self._data[u"hvactemplate:zone:vav:fanpowered"] = []
        self._data[u"hvactemplate:zone:vav:heatandcool"] = []
        self._data[u"hvactemplate:zone:constantvolume"] = []
        self._data[u"hvactemplate:zone:dualduct"] = []
        self._data[u"hvactemplate:system:vrf"] = []
        self._data[u"hvactemplate:system:unitary"] = []
        self._data[u"hvactemplate:system:unitaryheatpump:airtoair"] = []
        self._data[u"hvactemplate:system:unitarysystem"] = []
        self._data[u"hvactemplate:system:vav"] = []
        self._data[u"hvactemplate:system:packagedvav"] = []
        self._data[u"hvactemplate:system:constantvolume"] = []
        self._data[u"hvactemplate:system:dualduct"] = []
        self._data[u"hvactemplate:system:dedicatedoutdoorair"] = []
        self._data[u"hvactemplate:plant:chilledwaterloop"] = []
        self._data[u"hvactemplate:plant:chiller"] = []
        self._data[u"hvactemplate:plant:chiller:objectreference"] = []
        self._data[u"hvactemplate:plant:tower"] = []
        self._data[u"hvactemplate:plant:tower:objectreference"] = []
        self._data[u"hvactemplate:plant:hotwaterloop"] = []
        self._data[u"hvactemplate:plant:boiler"] = []
        self._data[u"hvactemplate:plant:boiler:objectreference"] = []
        self._data[u"hvactemplate:plant:mixedwaterloop"] = []
        self._data[u"designspecification:outdoorair"] = []
        self._data[u"designspecification:zoneairdistribution"] = []
        self._data[u"sizing:parameters"] = []
        self._data[u"sizing:zone"] = []
        self._data[u"designspecification:zonehvac:sizing"] = []
        self._data[u"sizing:system"] = []
        self._data[u"sizing:plant"] = []
        self._data[u"outputcontrol:sizing:style"] = []
        self._data[u"zonecontrol:humidistat"] = []
        self._data[u"zonecontrol:thermostat"] = []
        self._data[u"zonecontrol:thermostat:operativetemperature"] = []
        self._data[u"zonecontrol:thermostat:thermalcomfort"] = []
        self._data[u"zonecontrol:thermostat:temperatureandhumidity"] = []
        self._data[u"thermostatsetpoint:singleheating"] = []
        self._data[u"thermostatsetpoint:singlecooling"] = []
        self._data[u"thermostatsetpoint:singleheatingorcooling"] = []
        self._data[u"thermostatsetpoint:dualsetpoint"] = []
        self._data[u"thermostatsetpoint:thermalcomfort:fanger:singleheating"] = []
        self._data[u"thermostatsetpoint:thermalcomfort:fanger:singlecooling"] = []
        self._data[u"thermostatsetpoint:thermalcomfort:fanger:singleheatingorcooling"] = []
        self._data[u"thermostatsetpoint:thermalcomfort:fanger:dualsetpoint"] = []
        self._data[u"zonecontrol:thermostat:stageddualsetpoint"] = []
        self._data[u"zonecontrol:contaminantcontroller"] = []
        self._data[u"zonehvac:idealloadsairsystem"] = []
        self._data[u"zonehvac:fourpipefancoil"] = []
        self._data[u"zonehvac:windowairconditioner"] = []
        self._data[u"zonehvac:packagedterminalairconditioner"] = []
        self._data[u"zonehvac:packagedterminalheatpump"] = []
        self._data[u"zonehvac:watertoairheatpump"] = []
        self._data[u"zonehvac:dehumidifier:dx"] = []
        self._data[u"zonehvac:energyrecoveryventilator"] = []
        self._data[u"zonehvac:energyrecoveryventilator:controller"] = []
        self._data[u"zonehvac:unitventilator"] = []
        self._data[u"zonehvac:unitheater"] = []
        self._data[u"zonehvac:evaporativecoolerunit"] = []
        self._data[u"zonehvac:outdoorairunit"] = []
        self._data[u"zonehvac:outdoorairunit:equipmentlist"] = []
        self._data[u"zonehvac:terminalunit:variablerefrigerantflow"] = []
        self._data[u"zonehvac:baseboard:radiantconvective:water"] = []
        self._data[u"zonehvac:baseboard:radiantconvective:steam"] = []
        self._data[u"zonehvac:baseboard:radiantconvective:electric"] = []
        self._data[u"zonehvac:baseboard:convective:water"] = []
        self._data[u"zonehvac:baseboard:convective:electric"] = []
        self._data[u"zonehvac:lowtemperatureradiant:variableflow"] = []
        self._data[u"zonehvac:lowtemperatureradiant:constantflow"] = []
        self._data[u"zonehvac:lowtemperatureradiant:electric"] = []
        self._data[u"zonehvac:lowtemperatureradiant:surfacegroup"] = []
        self._data[u"zonehvac:hightemperatureradiant"] = []
        self._data[u"zonehvac:ventilatedslab"] = []
        self._data[u"zonehvac:ventilatedslab:slabgroup"] = []
        self._data[u"airterminal:singleduct:uncontrolled"] = []
        self._data[u"airterminal:singleduct:constantvolume:reheat"] = []
        self._data[u"airterminal:singleduct:vav:noreheat"] = []
        self._data[u"airterminal:singleduct:vav:reheat"] = []
        self._data[u"airterminal:singleduct:vav:reheat:variablespeedfan"] = []
        self._data[u"airterminal:singleduct:vav:heatandcool:noreheat"] = []
        self._data[u"airterminal:singleduct:vav:heatandcool:reheat"] = []
        self._data[u"airterminal:singleduct:seriespiu:reheat"] = []
        self._data[u"airterminal:singleduct:parallelpiu:reheat"] = []
        self._data[u"airterminal:singleduct:constantvolume:fourpipeinduction"] = []
        self._data[u"airterminal:singleduct:constantvolume:cooledbeam"] = []
        self._data[u"airterminal:singleduct:inletsidemixer"] = []
        self._data[u"airterminal:singleduct:supplysidemixer"] = []
        self._data[u"airterminal:dualduct:constantvolume"] = []
        self._data[u"airterminal:dualduct:vav"] = []
        self._data[u"airterminal:dualduct:vav:outdoorair"] = []
        self._data[u"zonehvac:airdistributionunit"] = []
        self._data[u"zonehvac:equipmentlist"] = []
        self._data[u"zonehvac:equipmentconnections"] = []
        self._data[u"fan:constantvolume"] = []
        self._data[u"fan:variablevolume"] = []
        self._data[u"fan:onoff"] = []
        self._data[u"fan:zoneexhaust"] = []
        self._data[u"fanperformance:nightventilation"] = []
        self._data[u"fan:componentmodel"] = []
        self._data[u"coil:cooling:water"] = []
        self._data[u"coil:cooling:water:detailedgeometry"] = []
        self._data[u"coil:cooling:dx:singlespeed"] = []
        self._data[u"coil:cooling:dx:twospeed"] = []
        self._data[u"coil:cooling:dx:multispeed"] = []
        self._data[u"coil:cooling:dx:variablespeed"] = []
        self._data[u"coil:cooling:dx:twostagewithhumiditycontrolmode"] = []
        self._data[u"coilperformance:dx:cooling"] = []
        self._data[u"coil:cooling:dx:variablerefrigerantflow"] = []
        self._data[u"coil:heating:dx:variablerefrigerantflow"] = []
        self._data[u"coil:heating:water"] = []
        self._data[u"coil:heating:steam"] = []
        self._data[u"coil:heating:electric"] = []
        self._data[u"coil:heating:electric:multistage"] = []
        self._data[u"coil:heating:gas"] = []
        self._data[u"coil:heating:gas:multistage"] = []
        self._data[u"coil:heating:desuperheater"] = []
        self._data[u"coil:heating:dx:singlespeed"] = []
        self._data[u"coil:heating:dx:multispeed"] = []
        self._data[u"coil:heating:dx:variablespeed"] = []
        self._data[u"coil:cooling:watertoairheatpump:parameterestimation"] = []
        self._data[u"coil:heating:watertoairheatpump:parameterestimation"] = []
        self._data[u"coil:cooling:watertoairheatpump:equationfit"] = []
        self._data[u"coil:cooling:watertoairheatpump:variablespeedequationfit"] = []
        self._data[u"coil:heating:watertoairheatpump:equationfit"] = []
        self._data[u"coil:heating:watertoairheatpump:variablespeedequationfit"] = []
        self._data[u"coil:waterheating:airtowaterheatpump"] = []
        self._data[u"coil:waterheating:desuperheater"] = []
        self._data[u"coilsystem:cooling:dx"] = []
        self._data[u"coilsystem:heating:dx"] = []
        self._data[u"coilsystem:cooling:water:heatexchangerassisted"] = []
        self._data[u"coilsystem:cooling:dx:heatexchangerassisted"] = []
        self._data[u"coil:cooling:dx:singlespeed:thermalstorage"] = []
        self._data[u"evaporativecooler:direct:celdekpad"] = []
        self._data[u"evaporativecooler:indirect:celdekpad"] = []
        self._data[u"evaporativecooler:indirect:wetcoil"] = []
        self._data[u"evaporativecooler:indirect:researchspecial"] = []
        self._data[u"evaporativecooler:direct:researchspecial"] = []
        self._data[u"humidifier:steam:electric"] = []
        self._data[u"dehumidifier:desiccant:nofans"] = []
        self._data[u"dehumidifier:desiccant:system"] = []
        self._data[u"heatexchanger:airtoair:flatplate"] = []
        self._data[u"heatexchanger:airtoair:sensibleandlatent"] = []
        self._data[u"heatexchanger:desiccant:balancedflow"] = []
        self._data[u"heatexchanger:desiccant:balancedflow:performancedatatype1"] = []
        self._data[u"airloophvac:unitarysystem"] = []
        self._data[u"unitarysystemperformance:heatpump:multispeed"] = []
        self._data[u"airloophvac:unitary:furnace:heatonly"] = []
        self._data[u"airloophvac:unitary:furnace:heatcool"] = []
        self._data[u"airloophvac:unitaryheatonly"] = []
        self._data[u"airloophvac:unitaryheatcool"] = []
        self._data[u"airloophvac:unitaryheatpump:airtoair"] = []
        self._data[u"airloophvac:unitaryheatpump:watertoair"] = []
        self._data[u"airloophvac:unitaryheatcool:vavchangeoverbypass"] = []
        self._data[u"airloophvac:unitaryheatpump:airtoair:multispeed"] = []
        self._data[u"airconditioner:variablerefrigerantflow"] = []
        self._data[u"zoneterminalunitlist"] = []
        self._data[u"controller:watercoil"] = []
        self._data[u"controller:outdoorair"] = []
        self._data[u"controller:mechanicalventilation"] = []
        self._data[u"airloophvac:controllerlist"] = []
        self._data[u"airloophvac"] = []
        self._data[u"airloophvac:outdoorairsystem:equipmentlist"] = []
        self._data[u"airloophvac:outdoorairsystem"] = []
        self._data[u"outdoorair:mixer"] = []
        self._data[u"airloophvac:zonesplitter"] = []
        self._data[u"airloophvac:supplyplenum"] = []
        self._data[u"airloophvac:supplypath"] = []
        self._data[u"airloophvac:zonemixer"] = []
        self._data[u"airloophvac:returnplenum"] = []
        self._data[u"airloophvac:returnpath"] = []
        self._data[u"branch"] = []
        self._data[u"branchlist"] = []
        self._data[u"connector:splitter"] = []
        self._data[u"connector:mixer"] = []
        self._data[u"connectorlist"] = []
        self._data[u"nodelist"] = []
        self._data[u"outdoorair:node"] = []
        self._data[u"outdoorair:nodelist"] = []
        self._data[u"pipe:adiabatic"] = []
        self._data[u"pipe:adiabatic:steam"] = []
        self._data[u"pipe:indoor"] = []
        self._data[u"pipe:outdoor"] = []
        self._data[u"pipe:underground"] = []
        self._data[u"pipingsystem:underground:domain"] = []
        self._data[u"pipingsystem:underground:pipecircuit"] = []
        self._data[u"pipingsystem:underground:pipesegment"] = []
        self._data[u"duct"] = []
        self._data[u"pump:variablespeed"] = []
        self._data[u"pump:constantspeed"] = []
        self._data[u"pump:variablespeed:condensate"] = []
        self._data[u"headeredpumps:constantspeed"] = []
        self._data[u"headeredpumps:variablespeed"] = []
        self._data[u"temperingvalve"] = []
        self._data[u"loadprofile:plant"] = []
        self._data[u"solarcollectorperformance:flatplate"] = []
        self._data[u"solarcollector:flatplate:water"] = []
        self._data[u"solarcollector:flatplate:photovoltaicthermal"] = []
        self._data[u"solarcollectorperformance:photovoltaicthermal:simple"] = []
        self._data[u"solarcollector:integralcollectorstorage"] = []
        self._data[u"solarcollectorperformance:integralcollectorstorage"] = []
        self._data[u"solarcollector:unglazedtranspired"] = []
        self._data[u"solarcollector:unglazedtranspired:multisystem"] = []
        self._data[u"boiler:hotwater"] = []
        self._data[u"boiler:steam"] = []
        self._data[u"chiller:electric:eir"] = []
        self._data[u"chiller:electric:reformulatedeir"] = []
        self._data[u"chiller:electric"] = []
        self._data[u"chiller:absorption:indirect"] = []
        self._data[u"chiller:absorption"] = []
        self._data[u"chiller:constantcop"] = []
        self._data[u"chiller:enginedriven"] = []
        self._data[u"chiller:combustionturbine"] = []
        self._data[u"chillerheater:absorption:directfired"] = []
        self._data[u"chillerheater:absorption:doubleeffect"] = []
        self._data[u"heatpump:watertowater:equationfit:heating"] = []
        self._data[u"heatpump:watertowater:equationfit:cooling"] = []
        self._data[u"heatpump:watertowater:parameterestimation:cooling"] = []
        self._data[u"heatpump:watertowater:parameterestimation:heating"] = []
        self._data[u"districtcooling"] = []
        self._data[u"districtheating"] = []
        self._data[u"plantcomponent:temperaturesource"] = []
        self._data[u"centralheatpumpsystem"] = []
        self._data[u"chillerheaterperformance:electric:eir"] = []
        self._data[u"coolingtower:singlespeed"] = []
        self._data[u"coolingtower:twospeed"] = []
        self._data[u"coolingtower:variablespeed:merkel"] = []
        self._data[u"coolingtower:variablespeed"] = []
        self._data[u"coolingtowerperformance:cooltools"] = []
        self._data[u"coolingtowerperformance:yorkcalc"] = []
        self._data[u"evaporativefluidcooler:singlespeed"] = []
        self._data[u"evaporativefluidcooler:twospeed"] = []
        self._data[u"fluidcooler:singlespeed"] = []
        self._data[u"fluidcooler:twospeed"] = []
        self._data[u"groundheatexchanger:vertical"] = []
        self._data[u"groundheatexchanger:pond"] = []
        self._data[u"groundheatexchanger:surface"] = []
        self._data[u"groundheatexchanger:horizontaltrench"] = []
        self._data[u"heatexchanger:fluidtofluid"] = []
        self._data[u"waterheater:mixed"] = []
        self._data[u"waterheater:stratified"] = []
        self._data[u"waterheater:sizing"] = []
        self._data[u"waterheater:heatpump"] = []
        self._data[u"thermalstorage:ice:simple"] = []
        self._data[u"thermalstorage:ice:detailed"] = []
        self._data[u"thermalstorage:chilledwater:mixed"] = []
        self._data[u"thermalstorage:chilledwater:stratified"] = []
        self._data[u"plantloop"] = []
        self._data[u"condenserloop"] = []
        self._data[u"plantequipmentlist"] = []
        self._data[u"condenserequipmentlist"] = []
        self._data[u"plantequipmentoperation:uncontrolled"] = []
        self._data[u"plantequipmentoperation:coolingload"] = []
        self._data[u"plantequipmentoperation:heatingload"] = []
        self._data[u"plantequipmentoperation:outdoordrybulb"] = []
        self._data[u"plantequipmentoperation:outdoorwetbulb"] = []
        self._data[u"plantequipmentoperation:outdoorrelativehumidity"] = []
        self._data[u"plantequipmentoperation:outdoordewpoint"] = []
        self._data[u"plantequipmentoperation:componentsetpoint"] = []
        self._data[u"plantequipmentoperation:outdoordrybulbdifference"] = []
        self._data[u"plantequipmentoperation:outdoorwetbulbdifference"] = []
        self._data[u"plantequipmentoperation:outdoordewpointdifference"] = []
        self._data[u"plantequipmentoperationschemes"] = []
        self._data[u"condenserequipmentoperationschemes"] = []
        self._data[u"energymanagementsystem:sensor"] = []
        self._data[u"energymanagementsystem:actuator"] = []
        self._data[u"energymanagementsystem:programcallingmanager"] = []
        self._data[u"energymanagementsystem:program"] = []
        self._data[u"energymanagementsystem:subroutine"] = []
        self._data[u"energymanagementsystem:globalvariable"] = []
        self._data[u"energymanagementsystem:outputvariable"] = []
        self._data[u"energymanagementsystem:meteredoutputvariable"] = []
        self._data[u"energymanagementsystem:trendvariable"] = []
        self._data[u"energymanagementsystem:internalvariable"] = []
        self._data[u"energymanagementsystem:curveortableindexvariable"] = []
        self._data[u"energymanagementsystem:constructionindexvariable"] = []
        self._data[u"externalinterface"] = []
        self._data[u"externalinterface:schedule"] = []
        self._data[u"externalinterface:variable"] = []
        self._data[u"externalinterface:actuator"] = []
        self._data[u"externalinterface:functionalmockupunitimport"] = []
        self._data[u"externalinterface:functionalmockupunitimport:from:variable"] = []
        self._data[u"externalinterface:functionalmockupunitimport:to:schedule"] = []
        self._data[u"externalinterface:functionalmockupunitimport:to:actuator"] = []
        self._data[u"externalinterface:functionalmockupunitimport:to:variable"] = []
        self._data[u"externalinterface:functionalmockupunitexport:from:variable"] = []
        self._data[u"externalinterface:functionalmockupunitexport:to:schedule"] = []
        self._data[u"externalinterface:functionalmockupunitexport:to:actuator"] = []
        self._data[u"externalinterface:functionalmockupunitexport:to:variable"] = []
        self._data[u"zonehvac:forcedair:userdefined"] = []
        self._data[u"airterminal:singleduct:userdefined"] = []
        self._data[u"coil:userdefined"] = []
        self._data[u"plantcomponent:userdefined"] = []
        self._data[u"plantequipmentoperation:userdefined"] = []
        self._data[u"availabilitymanager:scheduled"] = []
        self._data[u"availabilitymanager:scheduledon"] = []
        self._data[u"availabilitymanager:scheduledoff"] = []
        self._data[u"availabilitymanager:optimumstart"] = []
        self._data[u"availabilitymanager:nightcycle"] = []
        self._data[u"availabilitymanager:differentialthermostat"] = []
        self._data[u"availabilitymanager:hightemperatureturnoff"] = []
        self._data[u"availabilitymanager:hightemperatureturnon"] = []
        self._data[u"availabilitymanager:lowtemperatureturnoff"] = []
        self._data[u"availabilitymanager:lowtemperatureturnon"] = []
        self._data[u"availabilitymanager:nightventilation"] = []
        self._data[u"availabilitymanager:hybridventilation"] = []
        self._data[u"availabilitymanagerassignmentlist"] = []
        self._data[u"setpointmanager:scheduled"] = []
        self._data[u"setpointmanager:scheduled:dualsetpoint"] = []
        self._data[u"setpointmanager:outdoorairreset"] = []
        self._data[u"setpointmanager:singlezone:reheat"] = []
        self._data[u"setpointmanager:singlezone:heating"] = []
        self._data[u"setpointmanager:singlezone:cooling"] = []
        self._data[u"setpointmanager:singlezone:humidity:minimum"] = []
        self._data[u"setpointmanager:singlezone:humidity:maximum"] = []
        self._data[u"setpointmanager:mixedair"] = []
        self._data[u"setpointmanager:outdoorairpretreat"] = []
        self._data[u"setpointmanager:warmest"] = []
        self._data[u"setpointmanager:coldest"] = []
        self._data[u"setpointmanager:returnairbypassflow"] = []
        self._data[u"setpointmanager:warmesttemperatureflow"] = []
        self._data[u"setpointmanager:multizone:heating:average"] = []
        self._data[u"setpointmanager:multizone:cooling:average"] = []
        self._data[u"setpointmanager:multizone:minimumhumidity:average"] = []
        self._data[u"setpointmanager:multizone:maximumhumidity:average"] = []
        self._data[u"setpointmanager:multizone:humidity:minimum"] = []
        self._data[u"setpointmanager:multizone:humidity:maximum"] = []
        self._data[u"setpointmanager:followoutdoorairtemperature"] = []
        self._data[u"setpointmanager:followsystemnodetemperature"] = []
        self._data[u"setpointmanager:followgroundtemperature"] = []
        self._data[u"setpointmanager:condenserenteringreset"] = []
        self._data[u"setpointmanager:condenserenteringreset:ideal"] = []
        self._data[u"setpointmanager:singlezone:onestagecooling"] = []
        self._data[u"setpointmanager:singlezone:onestageheating"] = []
        self._data[u"refrigeration:case"] = []
        self._data[u"refrigeration:compressorrack"] = []
        self._data[u"refrigeration:caseandwalkinlist"] = []
        self._data[u"refrigeration:condenser:aircooled"] = []
        self._data[u"refrigeration:condenser:evaporativecooled"] = []
        self._data[u"refrigeration:condenser:watercooled"] = []
        self._data[u"refrigeration:condenser:cascade"] = []
        self._data[u"refrigeration:gascooler:aircooled"] = []
        self._data[u"refrigeration:transferloadlist"] = []
        self._data[u"refrigeration:subcooler"] = []
        self._data[u"refrigeration:compressor"] = []
        self._data[u"refrigeration:compressorlist"] = []
        self._data[u"refrigeration:system"] = []
        self._data[u"refrigeration:transcriticalsystem"] = []
        self._data[u"refrigeration:secondarysystem"] = []
        self._data[u"refrigeration:walkin"] = []
        self._data[u"refrigeration:airchiller"] = []
        self._data[u"zonehvac:refrigerationchillerset"] = []
        self._data[u"demandmanagerassignmentlist"] = []
        self._data[u"demandmanager:exteriorlights"] = []
        self._data[u"demandmanager:lights"] = []
        self._data[u"demandmanager:electricequipment"] = []
        self._data[u"demandmanager:thermostats"] = []
        self._data[u"generator:internalcombustionengine"] = []
        self._data[u"generator:combustionturbine"] = []
        self._data[u"generator:microturbine"] = []
        self._data[u"generator:photovoltaic"] = []
        self._data[u"photovoltaicperformance:simple"] = []
        self._data[u"photovoltaicperformance:equivalentone-diode"] = []
        self._data[u"photovoltaicperformance:sandia"] = []
        self._data[u"generator:fuelcell"] = []
        self._data[u"generator:fuelcell:powermodule"] = []
        self._data[u"generator:fuelcell:airsupply"] = []
        self._data[u"generator:fuelcell:watersupply"] = []
        self._data[u"generator:fuelcell:auxiliaryheater"] = []
        self._data[u"generator:fuelcell:exhaustgastowaterheatexchanger"] = []
        self._data[u"generator:fuelcell:electricalstorage"] = []
        self._data[u"generator:fuelcell:inverter"] = []
        self._data[u"generator:fuelcell:stackcooler"] = []
        self._data[u"generator:microchp"] = []
        self._data[u"generator:microchp:nonnormalizedparameters"] = []
        self._data[u"generator:fuelsupply"] = []
        self._data[u"generator:windturbine"] = []
        self._data[u"electricloadcenter:generators"] = []
        self._data[u"electricloadcenter:inverter:simple"] = []
        self._data[u"electricloadcenter:inverter:functionofpower"] = []
        self._data[u"electricloadcenter:inverter:lookuptable"] = []
        self._data[u"electricloadcenter:storage:simple"] = []
        self._data[u"electricloadcenter:storage:battery"] = []
        self._data[u"electricloadcenter:transformer"] = []
        self._data[u"electricloadcenter:distribution"] = []
        self._data[u"wateruse:equipment"] = []
        self._data[u"wateruse:connections"] = []
        self._data[u"wateruse:storage"] = []
        self._data[u"wateruse:well"] = []
        self._data[u"wateruse:raincollector"] = []
        self._data[u"faultmodel:temperaturesensoroffset:outdoorair"] = []
        self._data[u"faultmodel:humiditysensoroffset:outdoorair"] = []
        self._data[u"faultmodel:enthalpysensoroffset:outdoorair"] = []
        self._data[u"faultmodel:pressuresensoroffset:outdoorair"] = []
        self._data[u"faultmodel:temperaturesensoroffset:returnair"] = []
        self._data[u"faultmodel:enthalpysensoroffset:returnair"] = []
        self._data[u"faultmodel:fouling:coil"] = []
        self._data[u"matrix:twodimension"] = []
        self._data[u"curve:linear"] = []
        self._data[u"curve:quadlinear"] = []
        self._data[u"curve:quadratic"] = []
        self._data[u"curve:cubic"] = []
        self._data[u"curve:quartic"] = []
        self._data[u"curve:exponent"] = []
        self._data[u"curve:bicubic"] = []
        self._data[u"curve:biquadratic"] = []
        self._data[u"curve:quadraticlinear"] = []
        self._data[u"curve:triquadratic"] = []
        self._data[u"curve:functional:pressuredrop"] = []
        self._data[u"curve:fanpressurerise"] = []
        self._data[u"curve:exponentialskewnormal"] = []
        self._data[u"curve:sigmoid"] = []
        self._data[u"curve:rectangularhyperbola1"] = []
        self._data[u"curve:rectangularhyperbola2"] = []
        self._data[u"curve:exponentialdecay"] = []
        self._data[u"curve:doubleexponentialdecay"] = []
        self._data[u"table:oneindependentvariable"] = []
        self._data[u"table:twoindependentvariables"] = []
        self._data[u"table:multivariablelookup"] = []
        self._data[u"fluidproperties:name"] = []
        self._data[u"fluidproperties:glycolconcentration"] = []
        self._data[u"fluidproperties:temperatures"] = []
        self._data[u"fluidproperties:saturated"] = []
        self._data[u"fluidproperties:superheated"] = []
        self._data[u"fluidproperties:concentration"] = []
        self._data[u"currencytype"] = []
        self._data[u"componentcost:adjustments"] = []
        self._data[u"componentcost:reference"] = []
        self._data[u"componentcost:lineitem"] = []
        self._data[u"utilitycost:tariff"] = []
        self._data[u"utilitycost:qualify"] = []
        self._data[u"utilitycost:charge:simple"] = []
        self._data[u"utilitycost:charge:block"] = []
        self._data[u"utilitycost:ratchet"] = []
        self._data[u"utilitycost:variable"] = []
        self._data[u"utilitycost:computation"] = []
        self._data[u"lifecyclecost:parameters"] = []
        self._data[u"lifecyclecost:recurringcosts"] = []
        self._data[u"lifecyclecost:nonrecurringcost"] = []
        self._data[u"lifecyclecost:usepriceescalation"] = []
        self._data[u"lifecyclecost:useadjustment"] = []
        self._data[u"parametric:setvalueforrun"] = []
        self._data[u"parametric:logic"] = []
        self._data[u"parametric:runcontrol"] = []
        self._data[u"parametric:filenamesuffix"] = []
        self._data[u"output:variabledictionary"] = []
        self._data[u"output:surfaces:list"] = []
        self._data[u"output:surfaces:drawing"] = []
        self._data[u"output:schedules"] = []
        self._data[u"output:constructions"] = []
        self._data[u"output:energymanagementsystem"] = []
        self._data[u"outputcontrol:surfacecolorscheme"] = []
        self._data[u"output:table:summaryreports"] = []
        self._data[u"output:table:timebins"] = []
        self._data[u"output:table:monthly"] = []
        self._data[u"outputcontrol:table:style"] = []
        self._data[u"outputcontrol:reportingtolerances"] = []
        self._data[u"output:variable"] = []
        self._data[u"output:meter"] = []
        self._data[u"output:meter:meterfileonly"] = []
        self._data[u"output:meter:cumulative"] = []
        self._data[u"output:meter:cumulative:meterfileonly"] = []
        self._data[u"meter:custom"] = []
        self._data[u"meter:customdecrement"] = []
        self._data[u"output:sqlite"] = []
        self._data[u"output:environmentalimpactfactors"] = []
        self._data[u"environmentalimpactfactors"] = []
        self._data[u"fuelfactors"] = []
        self._data[u"output:diagnostics"] = []
        self._data[u"output:debuggingdata"] = []
        self._data[u"output:preprocessormessage"] = []
