...
class GeneratorPhotovoltaic(DataObject):
    ...
    """
    schema = {'min-fields': 0, 'name': u'Generator:Photovoltaic', 'pyname': u'GeneratorPhotovoltaic', 'format': None, 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': 'alpha'}), (u'surface name', {'name': u'Surface Name', 'pyname': u'surface_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'photovoltaic performance object type', {'name': u'Photovoltaic Performance Object Type', 'pyname': u'photovoltaic_performance_object_type', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': 'alpha'}), (u'module performance name', {'name': u'Module Performance Name', 'pyname': u'module_performance_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'heat transfer integration mode', {'name': u'Heat Transfer Integration Mode', 'pyname': u'heat_transfer_integration_mode', 'default': u'Decoupled', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': 'alpha'}), (u'number of series strings in parallel', {'name': u'Number of Series Strings in Parallel', 'pyname': u'number_of_series_strings_in_parallel', 'default': 1.0, 'required-field': False, 'autosizable': False, 'minimum': 1.0, 'autocalculatable': False, 'type': 'real', 'unit': u'dimensionless'}), (u'number of modules in series', {'name': u'Number of Modules in Series', 'pyname': u'number_of_modules_in_series', 'default': 1.0, 'required-field': False, 'autosizable': False, 'minimum': 1.0, 'autocalculatable': False, 'type': 'real', 'unit': u'dimensionless'})]), 'extensible-fields': OrderedDict(), 'unique-object': False, 'required-object': False}
...
class GeneratorFuelCell(DataObject):
    ...
    """
    schema = {'min-fields': 0, 'name': u'Generator:FuelCell', 'pyname': u'GeneratorFuelCell', 'format': None, 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': 'alpha'}), (u'power module name', {'name': u'Power Module Name', 'pyname': u'power_module_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'air supply name', {'name': u'Air Supply Name', 'pyname': u'air_supply_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'fuel supply name', {'name': u'Fuel Supply Name', 'pyname': u'fuel_supply_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'water supply name', {'name': u'Water Supply Name', 'pyname': u'water_supply_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'auxiliary heater name', {'name': u'Auxiliary Heater Name', 'pyname': u'auxiliary_heater_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'heat exchanger name', {'name': u'Heat Exchanger Name', 'pyname': u'heat_exchanger_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'electrical storage name', {'name': u'Electrical Storage Name', 'pyname': u'electrical_storage_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'inverter name', {'name': u'Inverter Name', 'pyname': u'inverter_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'stack cooler name', {'name': u'Stack Cooler Name', 'pyname': u'stack_cooler_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'})]), 'extensible-fields': OrderedDict(), 'unique-object': False, 'required-object': False}
...
class GeneratorFuelCellAirSupply(DataObject):
    ...
    """
    schema = {'min-fields': 0, 'name': u'Generator:FuelCell:AirSupply', 'pyname': u'GeneratorFuelCellAirSupply', 'format': None, 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': 'alpha'}), (u'air inlet node name', {'name': u'Air Inlet Node Name', 'pyname': u'air_inlet_node_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'node'}), (u'blower power curve name', {'name': u'Blower Power Curve Name', 'pyname': u'blower_power_curve_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'blower heat loss factor', {'name': u'Blower Heat Loss Factor', 'pyname': u'blower_heat_loss_factor', 'maximum': 1.0, 'required-field': False, 'autosizable': False, 'minimum': 0.0, 'autocalculatable': False, 'type': 'real'}), (u'air supply rate calculation mode', {'name': u'Air Supply Rate Calculation Mode', 'pyname': u'air_supply_rate_calculation_mode', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': 'alpha'}), (u'stoichiometric ratio', {'name': u'Stoichiometric Ratio', 'pyname': u'stoichiometric_ratio', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': 'real'}), (u'air rate function of electric power curve name', {'name': u'Air Rate Function of Electric Power Curve Name', 'pyname': u'air_rate_function_of_electric_power_curve_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'air rate air temperature coefficient', {'name': u'Air Rate Air Temperature Coefficient', 'pyname': u'air_rate_air_temperature_coefficient', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': 'real'}), (u'air rate function of fuel rate curve name', {'name': u'Air Rate Function of Fuel Rate Curve Name', 'pyname': u'air_rate_function_of_fuel_rate_curve_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'air intake heat recovery mode', {'name': u'Air Intake Heat Recovery Mode', 'pyname': u'air_intake_heat_recovery_mode', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': 'alpha'}), (u'air supply constituent mode', {'name': u'Air Supply Constituent Mode', 'pyname': u'air_supply_constituent_mode', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': 'alpha'}), (u'number of userdefined constituents', {'name': u'Number of UserDefined Constituents', 'pyname': u'number_of_userdefined_constituents', 'maximum': 5.0, 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': 'real'})]), 'extensible-fields': OrderedDict([(u'constituent 1 name', {'name': u'Constituent 1 Name', 'pyname': u'constituent_1_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': 'alpha'}), (u'molar fraction 1', {'name': u'Molar Fraction 1', 'pyname': u'molar_fraction_1', 'maximum': 1.0, 'required-field': False, 'autosizable': False, 'minimum': 0.0, 'autocalculatable': False, 'type': 'real'})]), 'unique-object': False, 'required-object': False}
...
class GeneratorFuelCellInverter(DataObject):
    ...
    """
    schema = {'min-fields': 0, 'name': u'Generator:FuelCell:Inverter', 'pyname': u'GeneratorFuelCellInverter', 'format': None, 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': 'alpha'}), (u'inverter efficiency calculation mode', {'name': u'Inverter Efficiency Calculation Mode', 'pyname': u'inverter_efficiency_calculation_mode', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': 'alpha'}), (u'inverter efficiency', {'name': u'Inverter Efficiency', 'pyname': u'inverter_efficiency', 'maximum': 1.0, 'required-field': False, 'autosizable': False, 'minimum': 0.0, 'autocalculatable': False, 'type': 'real'}), (u'efficiency function of dc power curve name', {'name': u'Efficiency Function of DC Power Curve Name', 'pyname': u'efficiency_function_of_dc_power_curve_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'})]), 'extensible-fields': OrderedDict(), 'unique-object': False, 'required-object': False}
...
class ElectricLoadCenterGenerators(DataObject):
    ...
    """
    schema = {'min-fields': 6, 'name': u'ElectricLoadCenter:Generators', 'pyname': u'ElectricLoadCenterGenerators', 'format': None, 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': 'alpha'})]), 'extensible-fields': OrderedDict([(u'generator 1 name', {'name': u'Generator 1 Name', 'pyname': u'generator_1_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'generator 1 object type', {'name': u'Generator 1 Object Type', 'pyname': u'generator_1_object_type', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': 'alpha'}), (u'generator 1 rated electric power output', {'name': u'Generator 1 Rated Electric Power Output', 'pyname': u'generator_1_rated_electric_power_output', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'W'}), (u'generator 1 availability schedule name', {'name': u'Generator 1 Availability Schedule Name', 'pyname': u'generator_1_availability_schedule_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'generator 1 rated thermal to electrical power ratio', {'name': u'Generator 1 Rated Thermal to Electrical Power Ratio', 'pyname': u'generator_1_rated_thermal_to_electrical_power_ratio', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': 'real'})]), 'unique-object': False, 'required-object': False}
