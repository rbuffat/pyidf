...
class ElectricLoadCenterTransformer(DataObject):
    ...
    """
    schema = {'extensible-fields': OrderedDict([(u'meter 1 name', {'name': u'Meter 1 Name', 'pyname': u'meter_1_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'external-list'})]),
