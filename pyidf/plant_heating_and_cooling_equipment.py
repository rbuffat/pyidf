...
class ChillerElectricReformulatedEir(DataObject):
 ...
 'unique-object': False}
    ...
    @property
    def electric_input_to_cooling_output_ratio_function_of_part_load_ratio_curve_type(self):
        ...
        """
        return self["Electric Input to Cooling Output Ratio Function of Part Load Ratio Curve Type"]

    @electric_input_to_cooling_output_ratio_function_of_part_load_ratio_curve_type.setter
    def electric_input_to_cooling_output_ratio_function_of_part_load_ratio_curve_type(self, value="LeavingCondenserWaterTemperature"):
        """  Corresponds to IDD field `Electric Input to Cooling Output Ratio Function of Part Load Ratio Curve Type`

        """
        self["Electric Input to Cooling Output Ratio Function of Part Load Ratio Curve Type"] = value
...
class DistrictHeating(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict(),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': 'alpha'}), (u'hot water inlet node name', {'name': u'Hot Water Inlet Node Name', 'pyname': u'hot_water_inlet_node_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'node'}), (u'hot water outlet node name', {'name': u'Hot Water Outlet Node Name', 'pyname': u'hot_water_outlet_node_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'node'}), (u'nominal capacity', {'name': u'Nominal Capacity', 'pyname': u'nominal_capacity', 'required-field': False, 'autosizable': True, 'minimum': 0.0, 'autocalculatable': False, 'type': 'real', 'unit': u'W'}), (u'capacity fraction schedule name', {'name': u'Capacity Fraction Schedule Name', 'pyname': u'capacity_fraction_schedule_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'})]),
 'format': None,
 'group': u'Plant Heating and Cooling Equipment',
 'min-fields': 0,
