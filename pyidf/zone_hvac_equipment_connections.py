...
class ZoneHvacEquipmentConnections(DataObject):
 ...
 'unique-object': False}
    ...
    def zone_return_air_flow_rate_fraction_schedule_name(self, value=None):
        """  Corresponds to IDD field `Zone Return Air Flow Rate Fraction Schedule Name`
    ...
    def zone_return_air_flow_rate_basis_node_or_nodelist_name(self, value=None):
        """  Corresponds to IDD field `Zone Return Air Flow Rate Basis Node or NodeList Name`
