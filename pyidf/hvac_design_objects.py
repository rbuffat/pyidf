...
class DesignSpecificationOutdoorAir(DataObject):
    ...
    def outdoor_air_flow_per_zone_floor_area(self, value=None):
        """Corresponds to IDD field `Outdoor Air Flow per Zone Floor Area` This
        input should be used if the field Outdoor Air Method is Flow/Area. This
        input is used if the field Outdoor Air Method is Flow/Area, Sum, or
        Maximum.
    ...
    def outdoor_air_flow_per_zone(self, value=None):
        """Corresponds to IDD field `Outdoor Air Flow per Zone` This input
        should be used if the field Outdoor Air Method is Flow/Zone. This input
    ...
    def outdoor_air_flow_air_changes_per_hour(self, value=None):
        ...
        This input should be used if the field Outdoor Air Method is
        AirChanges/Hour. This input is used if the field Outdoor Air Method is
        AirChanges/Hour, Sum, or Maximum.
...
class DesignSpecificationZoneAirDistribution(DataObject):
    ...
    def zone_air_distribution_effectiveness_schedule_name(self, value=None):
        ...
        Schedule Name` optionally used to replace Zone Air Distribution
        Effectiveness in Cooling and Heating Mode.
...
class SizingZone(DataObject):
    ...
    def cooling_design_air_flow_rate(self, value=None):
        """Corresponds to IDD field `Cooling Design Air Flow Rate` This input
        is used if Cooling Design Air Flow Method is Flow/Zone This value will
        be multiplied by the global or zone sizing factor and by zone
        multipliers.
    ...
    def cooling_minimum_air_flow_per_zone_floor_area(self, value=0.000762):
        ...
        Area` default is .15 cfm/ft2 This input is used if Cooling Design Air
        Flow Method is DesignDayWithLimit.
    ...
    def cooling_minimum_air_flow(self, value=None):
        """Corresponds to IDD field `Cooling Minimum Air Flow` This input is
        used if Cooling Design Air Flow Method is DesignDayWithLimit.
    ...
    def cooling_minimum_air_flow_fraction(self, value=None):
        ...
        fraction of the Cooling design Air Flow Rate This input is currently
        used in sizing the Fan minimum Flow Rate. It does not currently affect
        other component autosizing.
    ...
    def heating_design_air_flow_rate(self, value=None):
        """Corresponds to IDD field `Heating Design Air Flow Rate` This input
        is used if Heating Design Air Flow Method is Flow/Zone. This value will
        be multiplied by the global or zone sizing factor and by zone
        multipliers.
...
class DesignSpecificationZoneHvacSizing(DataObject):
    ...
    def cooling_design_supply_air_flow_rate(self, value=None):
        """Corresponds to IDD field `Cooling Design Supply Air Flow Rate` Enter
        the magnitude of supply air volume flow rate during cooling operation.
    ...
    def cooling_design_supply_air_flow_rate_per_floor_area(self, value=None):
        ...
        Floor Area` Enter the cooling supply air volume flow rate per total
        conditioned floor area. Required field when Supply air Flow Rate Method
    ...
    def fraction_of_autosized_cooling_design_supply_air_flow_rate(
        ...
        FractionOfAutosizedCoolingAirflow. This field may be blank if a cooling
        coil is not included in the Zone HVAC equipment.
    ...
    def cooling_design_supply_air_flow_rate_per_unit_cooling_capacity(
            ...
            value=None):
        """Corresponds to IDD field `Cooling Design Supply Air Flow Rate Per
        Unit Cooling Capacity` Enter the cooling supply air volume flow rate
        unit cooling capacity. Required field when Supply air Flow Rate Method
        During Cooling Operation is FlowPerCoolingCapacity. This field may be
        blank if a cooling coil is not included in the Zone HVAC equipment.
    ...
    def supply_air_flow_rate_per_floor_area_when_no_clg_or_htg_is_required(
            self):
        """Get
        supply_air_flow_rate_per_floor_area_when_no_clg_or_htg_is_required.
    ...
    def supply_air_flow_rate_per_floor_area_when_no_clg_or_htg_is_required(
        ...
        No Clg or Htg is Required` Enter the supply air volume flow rate per
        total floor area. Required field when Supply air Flow Rate Method When
        No Cooling or Heating is Required is FlowPerFloorArea.
    ...
    def fraction_of_design_cooling_supply_air_flow_rate_when_no_clg_or_htg_required(
            self):
        """Get fraction_of_design_cooling_supply_air_flow_rate_when_no_clg_or_h
        tg_required.
    ...
    def fraction_of_design_cooling_supply_air_flow_rate_when_no_clg_or_htg_required(
        ...
        Rate When No Clg or Htg Required` Enter the supply air volume flow rate
        as a fraction of the cooling supply air flow rate. Required field when
        Supply air Flow Rate Method When No Cooling or Heating is Required is
    ...
    def fraction_of_design_heating_supply_air_flow_rate_when_no_clg_or_htg_required(
            self):
        """Get fraction_of_design_heating_supply_air_flow_rate_when_no_clg_or_h
        tg_required.
    ...
    def fraction_of_design_heating_supply_air_flow_rate_when_no_clg_or_htg_required(
        ...
        Rate When No Clg or Htg Required` Enter the supply air volume flow rate
        as a fraction of the heating supply air flow rate. Required field when
        Supply air Flow Rate Method When No Cooling or Heating is Required is
    ...
    def heating_design_supply_air_flow_rate(self, value=None):
        """Corresponds to IDD field `Heating Design Supply Air Flow Rate` Enter
        the magnitude of the supply air volume flow rate during heating
        operation. Required field when Supply air Flow Rate Method During
        Heating Operation is SupplyAirFlowRate. This field may be blank if a
        heating coil is not included in the Zone HVAC equipment.
    ...
    def heating_design_supply_air_flow_rate_per_floor_area(self, value=None):
        ...
        Floor Area` Enter the heating supply air volume flow rate per total
        conditioned floor area. Required field when Supply air Flow Rate Method
    ...
    def fraction_of_heating_design_supply_air_flow_rate(self, value=None):
        ...
        Rate` Enter the supply air volume flow rate as a fraction of the
        heating supply air flow rate. Required field when Supply air Flow Rate
        Method During Heating Operation is FractionOfAutosizedHeatingAirflow.
        This field may be blank if a heating coil is not included in the Zone
        HVAC equipment.
    ...
    def heating_design_supply_air_flow_rate_per_unit_heating_capacity(
            ...
            value=None):
        """Corresponds to IDD field `Heating Design Supply Air Flow Rate Per
        Unit Heating Capacity` Enter the supply air volume flow rate per unit
        heating capacity. Required field when Supply air Flow Rate Method
        During Heating Operation is FlowPerHeatingCapacity. This field may be
        blank if a heating coil is not included in the Zone HVAC equipment.
    ...
    def cooling_design_capacity(self, value=None):
        """Corresponds to IDD field `Cooling Design Capacity` Enter the design
        cooling capacity. Required field when the cooling design capacity
    ...
    def cooling_design_capacity_per_floor_area(self, value=None):
        ...
        Enter the cooling design capacity per zone floor area. Required field
        when the cooling design capacity method field is CapacityPerFloorArea.
    ...
    def heating_design_capacity(self, value=None):
        """Corresponds to IDD field `Heating Design Capacity` Enter the design
        heating capacity. Required field when the heating design capacity
    ...
    def heating_design_capacity_per_floor_area(self, value=None):
        ...
        Enter the heating design capacity per zone floor area. Required field
        when the heating design capacity method field is CapacityPerFloorArea.
...
class SizingSystem(DataObject):
    ...
    def type_of_load_to_size_on(self, value="Sensible"):
        """Corresponds to IDD field `Type of Load to Size On` Specifies the
        basis for sizing the system supply air flow rate Sensible and
        VentilationRequirement are the only available options Sensible uses the
        zone design air flow rates VentilationRequirement uses the system
    ...
    def supply_air_flow_rate_per_floor_area_during_cooling_operation(
        ...
        Cooling Operation` Enter the cooling supply air volume flow rate per
        total conditioned floor area. Required field when Supply air Flow Rate
        Method during cooling operation is FlowPerFloorArea.
    ...
    def design_supply_air_flow_rate_per_unit_cooling_capacity(
        ...
        Cooling Capacity` Enter the supply air volume flow rate per unit
        cooling capacity. Required field when Supply air Flow Rate Method
        During Cooling Operation is FlowPerCoolingCapacity.
    ...
    def supply_air_flow_rate_per_floor_area_during_heating_operation(
            ...
            value=None):
        """Corresponds to IDD field `Supply Air Flow Rate Per Floor Area During
        Heating Operation` Enter the heating supply air volume flow rate per
        total conditioned floor area. Required field when Supply air Flow Rate
        Method during heating operation is FlowPerFloorArea.
    ...
    def design_supply_air_flow_rate_per_unit_heating_capacity(
            ...
            value=None):
        """Corresponds to IDD field `Design Supply Air Flow Rate Per Unit
        Heating Capacity` Enter the heating supply air volume flow rate per
        unit heating capacity. Required field when Supply air Flow Rate Method
        during heating operation is FlowPerHeatingCapacity.
    ...
    def cooling_design_capacity_per_floor_area(self, value=None):
        """Corresponds to IDD field `Cooling Design Capacity Per Floor Area`
        Enter the cooling design capacity per total floor area of cooled zones
        served by an airloop. Required field when the cooling design capacity
        method field is CapacityPerFloorArea.
...
class SizingPlant(DataObject):
    ...
    def plant_or_condenser_loop_name(self, value=None):
        """Corresponds to IDD field `Plant or Condenser Loop Name` Enter the
        name of a PlantLoop or a CondenserLoop object.
