...
class SolarCollectorPerformanceFlatPlate(DataObject):
 ...
 'unique-object': False}
    ...
    def test_flow_rate(self):
        """The value of field `Test Flow Rate`
    ...
    def test_correlation_type(self):
        """The value of field `Test Correlation Type`
    ...
    def coefficient_1_of_efficiency_equation(self):
        """The value of field `Coefficient 1 of Efficiency Equation`
        Y-intercept term
    ...
    def coefficient_2_of_efficiency_equation(self):
        """The value of field `Coefficient 2 of Efficiency Equation`
        1st Order term
    ...
    def coefficient_3_of_efficiency_equation(self):
        """The value of field `Coefficient 3 of Efficiency Equation`
        2nd order term
    ...
    def coefficient_2_of_incident_angle_modifier(self):
        """The value of field `Coefficient 2 of Incident Angle Modifier`
        1st order term
    ...
    def coefficient_3_of_incident_angle_modifier(self):
        """The value of field `Coefficient 3 of Incident Angle Modifier`
        2nd order term
...
class SolarCollectorFlatPlateWater(DataObject):
 ...
 'unique-object': False}
    ...
    def solarcollectorperformance_name(self):
        """The value of field `SolarCollectorPerformance Name`
...
class SolarCollectorFlatPlatePhotovoltaicThermal(DataObject):
 ...
 'unique-object': False}
    ...
    def photovoltaicthermal_model_performance_name(self):
        """The value of field `Photovoltaic-Thermal Model Performance Name`
    ...
    def photovoltaic_name(self):
        """The value of field `Photovoltaic Name`
    ...
    def thermal_working_fluid_type(self):
        """The value of field `Thermal Working Fluid Type`
...
class SolarCollectorPerformancePhotovoltaicThermalSimple(DataObject):
 ...
 'unique-object': False}
    ...
    def fraction_of_surface_area_with_active_thermal_collector(self):
        """The value of field `Fraction of Surface Area with Active Thermal Collector`
    ...
    def thermal_conversion_efficiency_input_mode_type(self):
        """The value of field `Thermal Conversion Efficiency Input Mode Type`
    ...
    def value_for_thermal_conversion_efficiency_if_fixed(self):
        """The value of field `Value for Thermal Conversion Efficiency if Fixed`
    ...
    def thermal_conversion_efficiency_schedule_name(self):
        """The value of field `Thermal Conversion Efficiency Schedule Name`
    ...
    def front_surface_emittance(self):
        """The value of field `Front Surface Emittance`
...
class SolarCollectorIntegralCollectorStorage(DataObject):
 ...
 'unique-object': False}
    ...
    def integralcollectorstorageparameters_name(self):
        """The value of field `IntegralCollectorStorageParameters Name`
    ...
    def bottom_surface_boundary_conditions_type(self):
        """The value of field `Bottom Surface Boundary Conditions Type`
    ...
    def boundary_condition_model_name(self):
        """The value of field `Boundary Condition Model Name`
...
class SolarCollectorPerformanceIntegralCollectorStorage(DataObject):
 ...
 'unique-object': False}
    ...
    def ics_collector_type(self):
        """The value of field `ICS Collector Type`
    ...
    def collector_water_volume(self):
        """The value of field `Collector Water Volume`
    ...
    def bottom_heat_loss_conductance(self):
        """The value of field `Bottom Heat Loss Conductance`
    ...
    def side_heat_loss_conductance(self):
        """The value of field `Side Heat Loss Conductance`
    ...
    def collector_side_height(self):
        """The value of field `Collector Side Height`
    ...
    def thermal_mass_of_absorber_plate(self):
        """The value of field `Thermal Mass of Absorber Plate`
    ...
    def number_of_covers(self):
        """The value of field `Number of Covers`
    ...
    def cover_spacing(self):
        """The value of field `Cover Spacing`
    ...
    def refractive_index_of_outer_cover(self):
        """The value of field `Refractive Index of Outer Cover`
    ...
    def extinction_coefficient_times_thickness_of_outer_cover(self):
        """The value of field `Extinction Coefficient Times Thickness of Outer Cover`
    ...
    def emissivity_of_outer_cover(self):
        """The value of field `Emissivity of Outer Cover`
    ...
    def refractive_index_of_inner_cover(self):
        """The value of field `Refractive Index of Inner Cover`
    ...
    def extinction_coefficient_times_thickness_of_the_inner_cover(self):
        """The value of field `Extinction Coefficient Times Thickness of the inner Cover`
    ...
    def emmissivity_of_inner_cover(self):
        """The value of field `Emmissivity of Inner Cover`
    ...
    def absorptance_of_absorber_plate(self):
        """The value of field `Absorptance of Absorber Plate`
    ...
    def emissivity_of_absorber_plate(self):
        """The value of field `Emissivity of Absorber Plate`
...
class SolarCollectorUnglazedTranspired(DataObject):
 ...
 'unique-object': False}
    ...
    def setpoint_node_name(self):
        """The value of field `Setpoint Node Name`
    ...
    def free_heating_setpoint_schedule_name(self):
        """The value of field `Free Heating Setpoint Schedule Name`
    ...
    def diameter_of_perforations_in_collector(self):
        """The value of field `Diameter of Perforations in Collector`
    ...
    def distance_between_perforations_in_collector(self):
        """The value of field `Distance Between Perforations in Collector`
    ...
    def thermal_emissivity_of_collector_surface(self):
        """The value of field `Thermal Emissivity of Collector Surface`
    ...
    def solar_absorbtivity_of_collector_surface(self):
        """The value of field `Solar Absorbtivity of Collector Surface`
    ...
    def effective_overall_height_of_collector(self):
        """The value of field `Effective Overall Height of Collector`
    ...
    def effective_gap_thickness_of_plenum_behind_collector(self):
        """The value of field `Effective Gap Thickness of Plenum Behind Collector`
    ...
    def effective_cross_section_area_of_plenum_behind_collector(self):
        """The value of field `Effective Cross Section Area of Plenum Behind Collector`
        if corrugated, use average depth
    ...
    def hole_layout_pattern_for_pitch(self):
        """The value of field `Hole Layout Pattern for Pitch`
    ...
    def heat_exchange_effectiveness_correlation(self):
        """The value of field `Heat Exchange Effectiveness Correlation`
    ...
    def ratio_of_actual_collector_surface_area_to_projected_surface_area(self):
        """The value of field `Ratio of Actual Collector Surface Area to Projected Surface Area`
    ...
    def roughness_of_collector(self):
        """The value of field `Roughness of Collector`
    ...
    def collector_thickness(self):
        """The value of field `Collector Thickness`
...
class SolarCollectorUnglazedTranspiredMultisystem(DataObject):
 ...
 'unique-object': False}
    ...
    def solar_collector_name(self):
        """The value of field `Solar Collector Name`
