...
class CurrencyType(DataObject):
 ...
 'unique-object': True}
    ...
    def monetary_unit(self):
        """The value of field `Monetary Unit`
...
class ComponentCostAdjustments(DataObject):
 ...
 'unique-object': False}
    ...
    def miscellaneous_cost_per_conditioned_area(self):
        """The value of field `Miscellaneous Cost per Conditioned Area`
    ...
    def design_and_engineering_fees(self):
        """The value of field `Design and Engineering Fees`
    ...
    def contractor_fee(self):
        """The value of field `Contractor Fee`
    ...
    def contingency(self):
        """The value of field `Contingency`
    ...
    def permits_bonding_and_insurance(self):
        """The value of field `Permits, Bonding and Insurance`
    ...
    def commissioning_fee(self):
        """The value of field `Commissioning Fee`
    ...
    def regional_adjustment_factor(self):
        """The value of field `Regional Adjustment Factor`
...
class ComponentCostReference(DataObject):
 ...
 'unique-object': False}
    ...
    def reference_building_line_item_costs(self):
        """The value of field `Reference Building Line Item Costs`
    ...
    def reference_building_miscellaneous_cost_per_conditioned_area(self):
        """The value of field `Reference Building Miscellaneous Cost per Conditioned Area`
        based on conditioned floor area
    ...
    def reference_building_design_and_engineering_fees(self):
        """The value of field `Reference Building Design and Engineering Fees`
    ...
    def reference_building_contractor_fee(self):
        """The value of field `Reference Building Contractor Fee`
    ...
    def reference_building_contingency(self):
        """The value of field `Reference Building Contingency`
    ...
    def reference_building_permits_bonding_and_insurance(self):
        """The value of field `Reference Building Permits, Bonding and Insurance`
    ...
    def reference_building_commissioning_fee(self):
        """The value of field `Reference Building Commissioning Fee`
    ...
    def reference_building_regional_adjustment_factor(self):
        """The value of field `Reference Building Regional Adjustment Factor`
        for use with average data in line item and Misc cost models
...
class ComponentCostLineItem(DataObject):
 ...
 'unique-object': False}
    ...
    def line_item_type(self):
        """The value of field `Line Item Type`
    ...
    def object_enduse_key(self):
        """The value of field `Object End-Use Key`
        not yet used
    ...
    def cost_per_each(self):
        """The value of field `Cost per Each`
    ...
    def cost_per_area(self):
        """The value of field `Cost per Area`
    ...
    def cost_per_unit_of_output_capacity(self):
        """The value of field `Cost per Unit of Output Capacity`
    ...
    def cost_per_unit_of_output_capacity_per_cop(self):
        """The value of field `Cost per Unit of Output Capacity per COP`
    ...
    def cost_per_volume(self):
        """The value of field `Cost per Volume`
    ...
    def cost_per_volume_rate(self):
        """The value of field `Cost per Volume Rate`
    ...
    def cost_per_energy_per_temperature_difference(self):
        """The value of field `Cost per Energy per Temperature Difference`
...
class UtilityCostTariff(DataObject):
 ...
 'unique-object': False}
    ...
    def output_meter_name(self):
        """The value of field `Output Meter Name`
    ...
    def conversion_factor_choice(self):
        """The value of field `Conversion Factor Choice`
    ...
    def energy_conversion_factor(self):
        """The value of field `Energy Conversion Factor`
    ...
    def demand_conversion_factor(self):
        """The value of field `Demand Conversion Factor`
    ...
    def time_of_use_period_schedule_name(self):
        """The value of field `Time of Use Period Schedule Name`
    ...
    def season_schedule_name(self):
        """The value of field `Season Schedule Name`
    ...
    def month_schedule_name(self):
        """The value of field `Month Schedule Name`
    ...
    def demand_window_length(self):
        """The value of field `Demand Window Length`
    ...
    def monthly_charge_or_variable_name(self):
        """The value of field `Monthly Charge or Variable Name`
    ...
    def minimum_monthly_charge_or_variable_name(self):
        """The value of field `Minimum Monthly Charge or Variable Name`
    ...
    def real_time_pricing_charge_schedule_name(self):
        """The value of field `Real Time Pricing Charge Schedule Name`
    ...
    def customer_baseline_load_schedule_name(self):
        """The value of field `Customer Baseline Load Schedule Name`
    ...
    def buy_or_sell(self):
        """The value of field `Buy Or Sell`
...
class UtilityCostQualify(DataObject):
 ...
 'unique-object': False}
    ...
    def tariff_name(self):
        """The value of field `Tariff Name`
    ...
    def variable_name(self):
        """The value of field `Variable Name`
    ...
    def qualify_type(self):
        """The value of field `Qualify Type`
    ...
    def threshold_value_or_variable_name(self):
        """The value of field `Threshold Value or Variable Name`
    ...
    def threshold_test(self):
        """The value of field `Threshold Test`
    ...
    def number_of_months(self):
        """The value of field `Number of Months`
...
class UtilityCostChargeSimple(DataObject):
 ...
 'unique-object': False}
    ...
    def source_variable(self):
        """The value of field `Source Variable`
    ...
    def category_variable_name(self):
        """The value of field `Category Variable Name`
    ...
    def cost_per_unit_value_or_variable_name(self):
        """The value of field `Cost per Unit Value or Variable Name`
...
class UtilityCostChargeBlock(DataObject):
 ...
 'unique-object': False}
    ...
    def remaining_into_variable(self):
        """The value of field `Remaining Into Variable`
    ...
    def block_size_multiplier_value_or_variable_name(self):
        """The value of field `Block Size Multiplier Value or Variable Name`
    ...
    def block_size_1_value_or_variable_name(self):
        """The value of field `Block Size 1 Value or Variable Name`
    ...
    def block_1_cost_per_unit_value_or_variable_name(self):
        """The value of field `Block 1 Cost per Unit Value or Variable Name`
    ...
    def block_size_2_value_or_variable_name(self):
        """The value of field `Block Size 2 Value or Variable Name`
        The size of the block of the charges is entered here. For most rates that use multiple blocks this will
        be the value for the block size. Using remaining may be used when the remaining amount should be included
        in that block.  This field is unusual because it can be either a number or a name of a variable.
    ...
    def block_2_cost_per_unit_value_or_variable_name(self):
        """The value of field `Block 2 Cost per Unit Value or Variable Name`
        The cost of the block. This field is unusual for the EnergyPlus syntax because it can be either a number
        or a name of a variable.
    ...
    def block_size_3_value_or_variable_name(self):
        """The value of field `Block Size 3 Value or Variable Name`
        The size of the block of the charges is entered here. For most rates that use multiple blocks this will
        be the value for the block size. Using remaining may be used when the remaining amount should be included
        in that block.  This field is unusual because it can be either a number or a name of a variable.
    ...
    def block_3_cost_per_unit_value_or_variable_name(self):
        """The value of field `Block 3 Cost per Unit Value or Variable Name`
        The cost of the block. This field is unusual for the EnergyPlus syntax because it can be either a number
        or a name of a variable.
    ...
    def block_size_4_value_or_variable_name(self):
        """The value of field `Block Size 4 Value or Variable Name`
        The size of the block of the charges is entered here. For most rates that use multiple blocks this will
        be the value for the block size. Using remaining may be used when the remaining amount should be included
        in that block.  This field is unusual because it can be either a number or a name of a variable.
    ...
    def block_4_cost_per_unit_value_or_variable_name(self):
        """The value of field `Block 4 Cost per Unit Value or Variable Name`
        The cost of the block. This field is unusual for the EnergyPlus syntax because it can be either a number
        or a name of a variable.
    ...
    def block_size_5_value_or_variable_name(self):
        """The value of field `Block Size 5 Value or Variable Name`
        The size of the block of the charges is entered here. For most rates that use multiple blocks this will
        be the value for the block size. Using remaining may be used when the remaining amount should be included
        in that block.  This field is unusual because it can be either a number or a name of a variable.
    ...
    def block_5_cost_per_unit_value_or_variable_name(self):
        """The value of field `Block 5 Cost per Unit Value or Variable Name`
        The cost of the block. This field is unusual for the EnergyPlus syntax because it can be either a number
        or a name of a variable.
    ...
    def block_size_6_value_or_variable_name(self):
        """The value of field `Block Size 6 Value or Variable Name`
        The size of the block of the charges is entered here. For most rates that use multiple blocks this will
        be the value for the block size. Using remaining may be used when the remaining amount should be included
        in that block.  This field is unusual because it can be either a number or a name of a variable.
    ...
    def block_6_cost_per_unit_value_or_variable_name(self):
        """The value of field `Block 6 Cost per Unit Value or Variable Name`
        The cost of the block. This field is unusual for the EnergyPlus syntax because it can be either a number
        or a name of a variable.
    ...
    def block_size_7_value_or_variable_name(self):
        """The value of field `Block Size 7 Value or Variable Name`
        The size of the block of the charges is entered here. For most rates that use multiple blocks this will
        be the value for the block size. Using remaining may be used when the remaining amount should be included
        in that block.  This field is unusual because it can be either a number or a name of a variable.
    ...
    def block_7_cost_per_unit_value_or_variable_name(self):
        """The value of field `Block 7 Cost per Unit Value or Variable Name`
        The cost of the block. This field is unusual for the EnergyPlus syntax because it can be either a number
        or a name of a variable.
    ...
    def block_size_8_value_or_variable_name(self):
        """The value of field `Block Size 8 Value or Variable Name`
        The size of the block of the charges is entered here. For most rates that use multiple blocks this will
        be the value for the block size. Using remaining may be used when the remaining amount should be included
        in that block.  This field is unusual because it can be either a number or a name of a variable.
    ...
    def block_8_cost_per_unit_value_or_variable_name(self):
        """The value of field `Block 8 Cost per Unit Value or Variable Name`
        The cost of the block. This field is unusual for the EnergyPlus syntax because it can be either a number
        or a name of a variable.
    ...
    def block_size_9_value_or_variable_name(self):
        """The value of field `Block Size 9 Value or Variable Name`
        The size of the block of the charges is entered here. For most rates that use multiple blocks this will
        be the value for the block size. Using remaining may be used when the remaining amount should be included
        in that block.  This field is unusual because it can be either a number or a name of a variable.
    ...
    def block_9_cost_per_unit_value_or_variable_name(self):
        """The value of field `Block 9 Cost per Unit Value or Variable Name`
        The cost of the block. This field is unusual for the EnergyPlus syntax because it can be either a number
        or a name of a variable.
    ...
    def block_size_10_value_or_variable_name(self):
        """The value of field `Block Size 10 Value or Variable Name`
        The size of the block of the charges is entered here. For most rates that use multiple blocks this will
        be the value for the block size. Using remaining may be used when the remaining amount should be included
        in that block.  This field is unusual because it can be either a number or a name of a variable.
    ...
    def block_10_cost_per_unit_value_or_variable_name(self):
        """The value of field `Block 10 Cost per Unit Value or Variable Name`
        The cost of the block. This field is unusual for the EnergyPlus syntax because it can be either a number
        or a name of a variable.
    ...
    def block_size_11_value_or_variable_name(self):
        """The value of field `Block Size 11 Value or Variable Name`
        The size of the block of the charges is entered here. For most rates that use multiple blocks this will
        be the value for the block size. Using remaining may be used when the remaining amount should be included
        in that block.  This field is unusual because it can be either a number or a name of a variable.
    ...
    def block_11_cost_per_unit_value_or_variable_name(self):
        """The value of field `Block 11 Cost per Unit Value or Variable Name`
        The cost of the block. This field is unusual for the EnergyPlus syntax because it can be either a number
        or a name of a variable.
    ...
    def block_size_12_value_or_variable_name(self):
        """The value of field `Block Size 12 Value or Variable Name`
        The size of the block of the charges is entered here. For most rates that use multiple blocks this will
        be the value for the block size. Using remaining may be used when the remaining amount should be included
        in that block.  This field is unusual because it can be either a number or a name of a variable.
    ...
    def block_12_cost_per_unit_value_or_variable_name(self):
        """The value of field `Block 12 Cost per Unit Value or Variable Name`
        The cost of the block. This field is unusual for the EnergyPlus syntax because it can be either a number
        or a name of a variable.
    ...
    def block_size_13_value_or_variable_name(self):
        """The value of field `Block Size 13 Value or Variable Name`
        The size of the block of the charges is entered here. For most rates that use multiple blocks this will
        be the value for the block size. Using remaining may be used when the remaining amount should be included
        in that block.  This field is unusual because it can be either a number or a name of a variable.
    ...
    def block_13_cost_per_unit_value_or_variable_name(self):
        """The value of field `Block 13 Cost per Unit Value or Variable Name`
        The cost of the block. This field is unusual for the EnergyPlus syntax because it can be either a number
        or a name of a variable.
    ...
    def block_size_14_value_or_variable_name(self):
        """The value of field `Block Size 14 Value or Variable Name`
        The size of the block of the charges is entered here. For most rates that use multiple blocks this will
        be the value for the block size. Using remaining may be used when the remaining amount should be included
        in that block.  This field is unusual because it can be either a number or a name of a variable.
    ...
    def block_14_cost_per_unit_value_or_variable_name(self):
        """The value of field `Block 14 Cost per Unit Value or Variable Name`
        The cost of the block. This field is unusual for the EnergyPlus syntax because it can be either a number
        or a name of a variable.
    ...
    def block_size_15_value_or_variable_name(self):
        """The value of field `Block Size 15 Value or Variable Name`
        The size of the block of the charges is entered here. For most rates that use multiple blocks this will
        be the value for the block size. Using remaining may be used when the remaining amount should be included
        in that block.  This field is unusual because it can be either a number or a name of a variable.
    ...
    def block_15_cost_per_unit_value_or_variable_name(self):
        """The value of field `Block 15 Cost per Unit Value or Variable Name`
        The cost of the block. This field is unusual for the EnergyPlus syntax because it can be either a number
        or a name of a variable.
...
class UtilityCostRatchet(DataObject):
 ...
 'unique-object': False}
    ...
    def baseline_source_variable(self):
        """The value of field `Baseline Source Variable`
    ...
    def adjustment_source_variable(self):
        """The value of field `Adjustment Source Variable`
    ...
    def season_from(self):
        """The value of field `Season From`
    ...
    def multiplier_value_or_variable_name(self):
        """The value of field `Multiplier Value or Variable Name`
    ...
    def offset_value_or_variable_name(self):
        """The value of field `Offset Value or Variable Name`
...
class UtilityCostVariable(DataObject):
 ...
 'unique-object': False}
    ...
    def variable_type(self):
        """The value of field `Variable Type`
    ...
    def january_value(self):
        """The value of field `January Value`
    ...
    def february_value(self):
        """The value of field `February Value`
    ...
    def march_value(self):
        """The value of field `March Value`
    ...
    def april_value(self):
        """The value of field `April Value`
    ...
    def august_value(self):
        """The value of field `August Value`
    ...
    def september_value(self):
        """The value of field `September Value`
    ...
    def october_value(self):
        """The value of field `October Value`
    ...
    def november_value(self):
        """The value of field `November Value`
    ...
    def december_value(self):
        """The value of field `December Value`
...
class UtilityCostComputation(DataObject):
 ...
 'unique-object': False}
    ...
    def compute_step_1(self):
        """The value of field `Compute Step 1`
    ...
    def compute_step_2(self):
        """The value of field `Compute Step 2`
    ...
    def compute_step_3(self):
        """The value of field `Compute Step 3`
    ...
    def compute_step_4(self):
        """The value of field `Compute Step 4`
    ...
    def compute_step_5(self):
        """The value of field `Compute Step 5`
    ...
    def compute_step_6(self):
        """The value of field `Compute Step 6`
    ...
    def compute_step_7(self):
        """The value of field `Compute Step 7`
    ...
    def compute_step_8(self):
        """The value of field `Compute Step 8`
    ...
    def compute_step_9(self):
        """The value of field `Compute Step 9`
    ...
    def compute_step_10(self):
        """The value of field `Compute Step 10`
    ...
    def compute_step_11(self):
        """The value of field `Compute Step 11`
    ...
    def compute_step_12(self):
        """The value of field `Compute Step 12`
    ...
    def compute_step_13(self):
        """The value of field `Compute Step 13`
    ...
    def compute_step_14(self):
        """The value of field `Compute Step 14`
    ...
    def compute_step_15(self):
        """The value of field `Compute Step 15`
    ...
    def compute_step_16(self):
        """The value of field `Compute Step 16`
    ...
    def compute_step_17(self):
        """The value of field `Compute Step 17`
    ...
    def compute_step_18(self):
        """The value of field `Compute Step 18`
    ...
    def compute_step_19(self):
        """The value of field `Compute Step 19`
    ...
    def compute_step_20(self):
        """The value of field `Compute Step 20`
    ...
    def compute_step_21(self):
        """The value of field `Compute Step 21`
    ...
    def compute_step_22(self):
        """The value of field `Compute Step 22`
    ...
    def compute_step_23(self):
        """The value of field `Compute Step 23`
    ...
    def compute_step_24(self):
        """The value of field `Compute Step 24`
    ...
    def compute_step_25(self):
        """The value of field `Compute Step 25`
    ...
    def compute_step_26(self):
        """The value of field `Compute Step 26`
    ...
    def compute_step_27(self):
        """The value of field `Compute Step 27`
    ...
    def compute_step_28(self):
        """The value of field `Compute Step 28`
    ...
    def compute_step_29(self):
        """The value of field `Compute Step 29`
    ...
    def compute_step_30(self):
        """The value of field `Compute Step 30`
...
class LifeCycleCostParameters(DataObject):
 ...
 'unique-object': True}
    ...
    def discounting_convention(self):
        """The value of field `Discounting Convention`
    ...
    def inflation_approach(self):
        """The value of field `Inflation Approach`
    ...
    def real_discount_rate(self):
        """The value of field `Real Discount Rate`
    ...
    def nominal_discount_rate(self):
        """The value of field `Nominal Discount Rate`
    ...
    def base_date_month(self):
        """The value of field `Base Date Month`
    ...
    def base_date_year(self):
        """The value of field `Base Date Year`
    ...
    def service_date_month(self):
        """The value of field `Service Date Month`
    ...
    def service_date_year(self):
        """The value of field `Service Date Year`
    ...
    def length_of_study_period_in_years(self):
        """The value of field `Length of Study Period in Years`
    ...
    def depreciation_method(self):
        """The value of field `Depreciation Method`
...
class LifeCycleCostRecurringCosts(DataObject):
 ...
 'unique-object': False}
    ...
    def start_of_costs(self):
        """The value of field `Start of Costs`
    ...
    def years_from_start(self):
        """The value of field `Years from Start`
    ...
    def months_from_start(self):
        """The value of field `Months from Start`
    ...
    def repeat_period_years(self):
        """The value of field `Repeat Period Years`
    ...
    def repeat_period_months(self):
        """The value of field `Repeat Period Months`
    ...
    def annual_escalation_rate(self):
        """The value of field `Annual escalation rate`
...
class LifeCycleCostNonrecurringCost(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict(),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'}), (u'category', {'name': u'Category', 'pyname': u'category', 'default': u'Construction', 'required-field': False, 'autosizable': False, 'accepted-values': [u'Construction', u'Salvage', u'OtherCapital'], 'autocalculatable': False, 'type': 'alpha'}), (u'cost', {'name': u'Cost', 'pyname': u'cost', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'real'}), (u'start of costs', {'name': u'Start of Costs', 'pyname': u'start_of_costs', 'default': u'ServicePeriod', 'required-field': False, 'autosizable': False, 'accepted-values': [u'ServicePeriod', u'BasePeriod'], 'autocalculatable': False, 'type': 'alpha'}), (u'years from start', {'name': u'Years from Start', 'pyname': u'years_from_start', 'maximum': 100, 'required-field': False, 'autosizable': False, 'minimum': 0, 'autocalculatable': False, 'type': u'integer'}), (u'months from start', {'name': u'Months from Start', 'pyname': u'months_from_start', 'maximum': 1200, 'required-field': False, 'autosizable': False, 'minimum': 0, 'autocalculatable': False, 'type': u'integer'})]),
 'format': None,
 'group': u'Economics',
 'min-fields': 0,
...
class LifeCycleCostUsePriceEscalation(DataObject):
 ...
 'unique-object': False}
    ...
    def escalation_start_year(self):
        """The value of field `Escalation Start Year`
    ...
    def escalation_start_month(self):
        """The value of field `Escalation Start Month`
...
class LifeCycleCostUseAdjustment(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict([(u'year 1 multiplier', {'name': u'Year 1 Multiplier', 'pyname': u'year_1_multiplier', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'real'})]),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'}), (u'resource', {'name': u'Resource', 'pyname': u'resource', 'required-field': True, 'autosizable': False, 'accepted-values': [u'Electricity', u'ElectricityPurchased', u'ElectricityProduced', u'ElectricitySurplusSold', u'ElectricityNet', u'NaturalGas', u'Steam', u'Gasoline', u'Diesel', u'Coal', u'FuelOil#1', u'FuelOil#2', u'Propane', u'OtherFuel1', u'OtherFuel2', u'Water'], 'autocalculatable': False, 'type': 'alpha'})]),
 'format': None,
 'group': u'Economics',
 'min-fields': 0,
