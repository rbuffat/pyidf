...
class LifeCycleCostUsePriceEscalation(DataObject):
    ...
    """
    schema = {'extensible-fields': OrderedDict([(u'year 1 escalation', {'name': u'Year 1 Escalation', 'pyname': u'year_1_escalation', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'real'})]),
...
class LifeCycleCostUseAdjustment(DataObject):
    ...
    """
    schema = {'extensible-fields': OrderedDict([(u'year 1 multiplier', {'name': u'Year 1 Multiplier', 'pyname': u'year_1_multiplier', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'real'})]),
