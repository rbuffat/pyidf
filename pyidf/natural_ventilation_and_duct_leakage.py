...
class AirflowNetworkMultiZoneZone(DataObject):
 ...
 'unique-object': False}
    ...
    @property
    def indoor_and_outdoor_temperature_difference_upper_limit_for_minimum_venting_open_factor(self):
        ...
        """
        return self["Indoor and Outdoor Temperature Difference Upper Limit for Minimum Venting Open Factor"]

    @indoor_and_outdoor_temperature_difference_upper_limit_for_minimum_venting_open_factor.setter
    def indoor_and_outdoor_temperature_difference_upper_limit_for_minimum_venting_open_factor(self, value=100.0):
        """  Corresponds to IDD field `Indoor and Outdoor Temperature Difference Upper Limit for Minimum Venting Open Factor`

        """
        self["Indoor and Outdoor Temperature Difference Upper Limit for Minimum Venting Open Factor"] = value
    ...
    @property
    def indoor_and_outdoor_enthalpy_difference_upper_limit_for_minimum_venting_open_factor(self):
        ...
        """
        return self["Indoor and Outdoor Enthalpy Difference Upper Limit for Minimum Venting Open Factor"]

    @indoor_and_outdoor_enthalpy_difference_upper_limit_for_minimum_venting_open_factor.setter
    def indoor_and_outdoor_enthalpy_difference_upper_limit_for_minimum_venting_open_factor(self, value=300000.0):
        """  Corresponds to IDD field `Indoor and Outdoor Enthalpy Difference Upper Limit for Minimum Venting Open Factor`

        """
        self["Indoor and Outdoor Enthalpy Difference Upper Limit for Minimum Venting Open Factor"] = value
...
class AirflowNetworkMultiZoneComponentDetailedOpening(DataObject):
 ...
 'unique-object': False}
    ...
    def type_of_rectangular_large_vertical_opening_lvo(self, value="NonPivoted"):
        """  Corresponds to IDD field `Type of Rectangular Large Vertical Opening (LVO)`
...
class AirflowNetworkDistributionLinkage(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict(),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'}), (u'node 1 name', {'name': u'Node 1 Name', 'pyname': u'node_1_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'node 2 name', {'name': u'Node 2 Name', 'pyname': u'node_2_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'component name', {'name': u'Component Name', 'pyname': u'component_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'thermal zone name', {'name': u'Thermal Zone Name', 'pyname': u'thermal_zone_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'})]),
 'format': None,
 'group': u'Natural Ventilation and Duct Leakage',
 'min-fields': 4,
...
class AirflowNetworkOccupantVentilationControl(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict(),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'}), (u'minimum opening time', {'name': u'Minimum Opening Time', 'pyname': u'minimum_opening_time', 'default': 0.0, 'required-field': False, 'autosizable': False, 'minimum': 0.0, 'autocalculatable': False, 'type': u'real', 'unit': u'minutes'}), (u'minimum closing time', {'name': u'Minimum Closing Time', 'pyname': u'minimum_closing_time', 'default': 0.0, 'required-field': False, 'autosizable': False, 'minimum': 0.0, 'autocalculatable': False, 'type': u'real', 'unit': u'minutes'}), (u'thermal comfort low temperature curve name', {'name': u'Thermal Comfort Low Temperature Curve Name', 'pyname': u'thermal_comfort_low_temperature_curve_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'thermal comfort temperature boundary point', {'name': u'Thermal Comfort Temperature Boundary Point', 'pyname': u'thermal_comfort_temperature_boundary_point', 'default': 10.0, 'required-field': False, 'autosizable': False, 'minimum': 0.0, 'autocalculatable': False, 'type': u'real', 'unit': u'C'}), (u'thermal comfort high temperature curve name', {'name': u'Thermal Comfort High Temperature Curve Name', 'pyname': u'thermal_comfort_high_temperature_curve_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'maximum threshold for persons dissatisfied ppd', {'name': u'Maximum Threshold for Persons Dissatisfied PPD', 'pyname': u'maximum_threshold_for_persons_dissatisfied_ppd', 'default': 10.0, 'maximum': 100.0, 'required-field': False, 'autosizable': False, 'minimum': 0.0, 'autocalculatable': False, 'type': u'real', 'unit': u'percent'}), (u'occupancy check', {'name': u'Occupancy Check', 'pyname': u'occupancy_check', 'default': u'No', 'required-field': False, 'autosizable': False, 'accepted-values': [u'Yes', u'No'], 'autocalculatable': False, 'type': 'alpha'}), (u'opening probability schedule name', {'name': u'Opening Probability Schedule Name', 'pyname': u'opening_probability_schedule_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'closing probability schedule name', {'name': u'Closing Probability Schedule Name', 'pyname': u'closing_probability_schedule_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'})]),
 'format': None,
 'group': u'Natural Ventilation and Duct Leakage',
 'min-fields': 0,
 ...
 'unique-object': False}
    ...
    def thermal_comfort_low_temperature_curve_name(self, value=None):
        """  Corresponds to IDD field `Thermal Comfort Low Temperature Curve Name`
    ...
    def thermal_comfort_temperature_boundary_point(self, value=10.0):
        """  Corresponds to IDD field `Thermal Comfort Temperature Boundary Point`
    ...
    def thermal_comfort_high_temperature_curve_name(self, value=None):
        """  Corresponds to IDD field `Thermal Comfort High Temperature Curve Name`
    ...
    def maximum_threshold_for_persons_dissatisfied_ppd(self, value=10.0):
        """  Corresponds to IDD field `Maximum Threshold for Persons Dissatisfied PPD`
...
class AirflowNetworkIntraZoneNode(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict(),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'}), (u'roomair:node:airflownetwork name', {'name': u'RoomAir:Node:AirflowNetwork Name', 'pyname': u'roomairnodeairflownetwork_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'}), (u'zone name', {'name': u'Zone Name', 'pyname': u'zone_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'node height', {'name': u'Node Height', 'pyname': u'node_height', 'default': 0.0, 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'm'})]),
 'format': None,
 'group': u'Natural Ventilation and Duct Leakage',
 'min-fields': 2,
...
class AirflowNetworkIntraZoneLinkage(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict(),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'}), (u'node 1 name', {'name': u'Node 1 Name', 'pyname': u'node_1_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'}), (u'node 2 name', {'name': u'Node 2 Name', 'pyname': u'node_2_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'}), (u'component name', {'name': u'Component Name', 'pyname': u'component_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'airflownetwork:multizone:surface name', {'name': u'AirflowNetwork:MultiZone:Surface Name', 'pyname': u'airflownetworkmultizonesurface_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'})]),
 'format': None,
 'group': u'Natural Ventilation and Duct Leakage',
 'min-fields': 4,
