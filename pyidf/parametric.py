...
class ParametricSetValueForRun(object):
    ...
    def __init__(self):
        """ Init data dictionary object for EPW IDD  `Parametric:SetValueForRun`
        """
...
class ParametricLogic(object):
    ...
    def __init__(self):
        """ Init data dictionary object for EPW IDD  `Parametric:Logic`
        """
        self._data = OrderedDict()
        self._data["Name"] = None
...
class ParametricRunControl(object):
    ...
    def __init__(self):
        """ Init data dictionary object for EPW IDD  `Parametric:RunControl`
        """
        self._data = OrderedDict()
        self._data["Name"] = None
...
class ParametricFileNameSuffix(object):
    ...
    def __init__(self):
        """ Init data dictionary object for EPW IDD  `Parametric:FileNameSuffix`
        """
        self._data = OrderedDict()
        self._data["Name"] = None
