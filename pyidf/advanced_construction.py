...
class SurfacePropertyHeatTransferAlgorithmSurfaceList(DataObject):
    """ Corresponds to IDD object `SurfaceProperty:HeatTransferAlgorithm:SurfaceList`
        ...
        Advanced/Research Usage: HAMT (Combined Heat And Moisture Finite Element)
    """
    schema = {'extensible-fields': OrderedDict([(u'surface name 1', {'name': u'Surface Name 1', 'pyname': u'surface_name_1', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'})]),
...
class SurfacePropertyExteriorNaturalVentedCavity(DataObject):
    ...
    """
    schema = {'extensible-fields': OrderedDict([(u'surface 1 name', {'name': u'Surface 1 Name', 'pyname': u'surface_1_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'})]),
