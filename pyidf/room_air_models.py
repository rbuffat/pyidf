...
class RoomAirTemperaturePatternSurfaceMapping(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict([(u'surface name pair 1', {'name': u'Surface Name Pair 1', 'pyname': u'surface_name_pair_1', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'delta adjacent air temperature pair 1', {'name': u'Delta Adjacent Air Temperature Pair 1', 'pyname': u'delta_adjacent_air_temperature_pair_1', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'deltaC'})]),
...
class RoomAirNodeAirflowNetwork(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict(),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'Alpha'}), (u'zone name', {'name': u'Zone Name', 'pyname': u'zone_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'fraction of zone air volume', {'name': u'Fraction of Zone Air Volume', 'pyname': u'fraction_of_zone_air_volume', 'maximum': 1.0, 'required-field': False, 'autosizable': False, 'minimum': 0.0, 'autocalculatable': False, 'type': u'real'}), (u'roomair:node:airflownetwork:adjacentsurfacelist name', {'name': u'RoomAir:Node:AirflowNetwork:AdjacentSurfaceList Name', 'pyname': u'roomairnodeairflownetworkadjacentsurfacelist_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'roomair:node:airflownetwork:internalgains name', {'name': u'RoomAir:Node:AirflowNetwork:InternalGains Name', 'pyname': u'roomairnodeairflownetworkinternalgains_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'roomair:node:airflownetwork:hvacequipment name', {'name': u'RoomAir:Node:AirflowNetwork:HVACEquipment Name', 'pyname': u'roomairnodeairflownetworkhvacequipment_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'})]),
 'format': None,
 'group': u'Room Air Models',
 'min-fields': 0,
...
class RoomAirNodeAirflowNetworkAdjacentSurfaceList(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict([(u'surface 1 name', {'name': u'Surface 1 Name', 'pyname': u'surface_1_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'})]),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'Alpha'})]),
 'format': None,
 'group': u'Room Air Models',
 'min-fields': 2,
...
class RoomAirNodeAirflowNetworkInternalGains(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict([(u'internal gain object 1 type', {'name': u'Internal Gain Object 1 Type', 'pyname': u'internal_gain_object_1_type', 'required-field': False, 'autosizable': False, 'accepted-values': [u'People', u'Lights', u'ElectricEquipment', u'GasEquipment', u'HotWaterEquipment', u'SteamEquipment', u'OtherEquipment', u'ZoneBaseboard:OutdoorTemperatureControlled', u'ZoneContaminantSourceAndSink:CarbonDioxide', u'WaterUse:Equipment', u'DaylightingDevice:Tubular', u'WaterHeater:Mixed', u'WaterHeater:Stratified', u'ThermalStorage:ChilledWater:Mixed', u'ThermalStorage:ChilledWater:Stratified', u'Generator:FuelCell', u'Generator:MicroCHP', u'ElectricLoadCenter:Transformer', u'ElectricLoadCenter:Inverter:Simple', u'ElectricLoadCenter:Inverter:FunctionOfPower', u'ElectricLoadCenter:Inverter:LookUpTable', u'ElectricLoadCenter:Storage:Battery', u'ElectricLoadCenter:Storage:Simple', u'Pipe:Indoor', u'Refrigeration:Case', u'Refrigeration:CompressorRack', u'Refrigeration:System:Condenser:AirCooled', u'Refrigeration:TranscriticalSystem:GasCooler:AirCooled', u'Refrigeration:System:SuctionPipe', u'Refrigeration:TranscriticalSystem:SuctionPipeMT', u'Refrigeration:TranscriticalSystem:SuctionPipeLT', u'Refrigeration:SecondarySystem:Receiver', u'Refrigeration:SecondarySystem:Pipe', u'Refrigeration:WalkIn', u'Pump:VariableSpeed', u'Pump:ConstantSpeed', u'Pump:VariableSpeed:Condensate', u'HeaderedPumps:VariableSpeed', u'HeaderedPumps:ConstantSpeed', u'ZoneContaminantSourceAndSink:GenericContaminant', u'PlantComponent:UserDefined', u'Coil:UserDefined', u'ZoneHVAC:ForcedAir:UserDefined', u'AirTerminal:SingleDuct:UserDefined'], 'autocalculatable': False, 'type': 'alpha'}), (u'internal gain object 1 name', {'name': u'Internal Gain Object 1 Name', 'pyname': u'internal_gain_object_1_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'}), (u'fraction of gains to node 1', {'name': u'Fraction of Gains to Node 1', 'pyname': u'fraction_of_gains_to_node_1', 'maximum': 1.0, 'required-field': False, 'autosizable': False, 'minimum': 0.0, 'autocalculatable': False, 'type': u'real'}), (u'internal gain object 2 type', {'name': u'Internal Gain Object 2 Type', 'pyname': u'internal_gain_object_2_type', 'required-field': False, 'autosizable': False, 'accepted-values': [u'People', u'Lights', u'ElectricEquipment', u'GasEquipment', u'HotWaterEquipment', u'SteamEquipment', u'OtherEquipment', u'ZoneBaseboard:OutdoorTemperatureControlled', u'ZoneContaminantSourceAndSink:CarbonDioxide', u'WaterUse:Equipment', u'DaylightingDevice:Tubular', u'WaterHeater:Mixed', u'WaterHeater:Stratified', u'ThermalStorage:ChilledWater:Mixed', u'ThermalStorage:ChilledWater:Stratified', u'Generator:FuelCell', u'Generator:MicroCHP', u'ElectricLoadCenter:Transformer', u'ElectricLoadCenter:Inverter:Simple', u'ElectricLoadCenter:Inverter:FunctionOfPower', u'ElectricLoadCenter:Inverter:LookUpTable', u'ElectricLoadCenter:Storage:Battery', u'ElectricLoadCenter:Storage:Simple', u'Pipe:Indoor', u'Refrigeration:Case', u'Refrigeration:CompressorRack', u'Refrigeration:System:Condenser:AirCooled', u'Refrigeration:TranscriticalSystem:GasCooler:AirCooled', u'Refrigeration:System:SuctionPipe', u'Refrigeration:TranscriticalSystem:SuctionPipeMT', u'Refrigeration:TranscriticalSystem:SuctionPipeLT', u'Refrigeration:SecondarySystem:Receiver', u'Refrigeration:SecondarySystem:Pipe', u'Refrigeration:WalkIn', u'Pump:VariableSpeed', u'Pump:ConstantSpeed', u'Pump:VariableSpeed:Condensate', u'HeaderedPumps:VariableSpeed', u'HeaderedPumps:ConstantSpeed', u'ZoneContaminantSourceAndSink:GenericContaminant', u'PlantComponent:UserDefined', u'Coil:UserDefined', u'ZoneHVAC:ForcedAir:UserDefined', u'AirTerminal:SingleDuct:UserDefined'], 'autocalculatable': False, 'type': 'alpha'})]),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'Alpha'})]),
 'format': None,
 'group': u'Room Air Models',
 'min-fields': 5,
 ...
 'unique-object': False}
    ...
    def add_extensible(self,
        ...
        """
        vals = []
        internal_gain_object_1_type = self.check_value("Internal Gain Object 1 Type", internal_gain_object_1_type)
        vals.append(internal_gain_object_1_type)
        internal_gain_object_1_name = self.check_value("Internal Gain Object 1 Name", internal_gain_object_1_name)
        vals.append(internal_gain_object_1_name)
        fraction_of_gains_to_node_1 = self.check_value("Fraction of Gains to Node 1", fraction_of_gains_to_node_1)
        vals.append(fraction_of_gains_to_node_1)
        internal_gain_object_2_type = self.check_value("Internal Gain Object 2 Type", internal_gain_object_2_type)
...
class RoomAirNodeAirflowNetworkHvacequipment(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict([(u'zonehvac or air terminal equipment object type 1', {'name': u'ZoneHVAC or Air Terminal Equipment Object Type 1', 'pyname': u'zonehvac_or_air_terminal_equipment_object_type_1', 'required-field': False, 'autosizable': False, 'accepted-values': [u'ZoneHVAC:TerminalUnit:VariableRefrigerantFlow', u'ZoneHVAC:EnergyRecoveryVentilator', u'ZoneHVAC:FourPipeFanCoil', u'ZoneHVAC:OutdoorAirUnit', u'ZoneHVAC:PackagedTerminalAirConditioner', u'ZoneHVAC:PackagedTerminalHeatPump', u'ZoneHVAC:UnitHeater', u'ZoneHVAC:UnitVentilator', u'ZoneHVAC:VentilatedSlab', u'ZoneHVAC:WaterToAirHeatPump', u'ZoneHVAC:WindowAirConditioner', u'ZoneHVAC:Baseboard:RadiantConvective:Electric', u'ZoneHVAC:Baseboard:RadiantConvective:Water', u'ZoneHVAC:Baseboard:RadiantConvective:Steam', u'ZoneHVAC:Baseboard:Convective:Electric', u'ZoneHVAC:Baseboard:Convective:Water', u'ZoneHVAC:HighTemperatureRadiant', u'ZoneHVAC:Dehumidifier:DX', u'ZoneHVAC:IdealLoadsAirSystem', u'ZoneHVAC:RefrigerationChillerSet', u'Fan:ZoneExhaust', u'WaterHeater:HeatPump', u'AirTerminal:SingleDuct:Uncontrolled', u'AirTerminal:DualDuct:ConstantVolume', u'AirTerminal:DualDuct:VAV', u'AirTerminal:SingleDuct:ConstantVolume:Reheat', u'AirTerminal:SingleDuct:VAV:Reheat', u'AirTerminal:SingleDuct:VAV:NoReheat', u'AirTerminal:SingleDuct:SeriesPIU:Reheat', u'AirTerminal:SingleDuct:ParallelPIU:Reheat', u'AirTerminal:SingleDuct:ConstantVolume:FourPipeInduction', u'AirTerminal:SingleDuct:VAV:Reheat:VariableSpeedFan', u'AirTerminal:SingleDuct:VAV:HeatAndCool:Reheat', u'AirTerminal:SingleDuct:VAV:HeatAndCool:NoReheat', u'AirTerminal:SingleDuct:ConstantVolume:CooledBeam', u'AirTerminal:DualDuct:VAV:OutdoorAir', u'AirLoopHVACReturnAir'], 'autocalculatable': False, 'type': 'alpha'}), (u'zonehvac or air terminal equipment object name 1', {'name': u'ZoneHVAC or Air Terminal Equipment Object Name 1', 'pyname': u'zonehvac_or_air_terminal_equipment_object_name_1', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'}), (u'fraction of output or supply air from hvac equipment 1', {'name': u'Fraction of Output or Supply Air from HVAC Equipment 1', 'pyname': u'fraction_of_output_or_supply_air_from_hvac_equipment_1', 'maximum': 1.0, 'required-field': False, 'autosizable': False, 'minimum': 0.0, 'autocalculatable': False, 'type': u'real'}), (u'fraction of input or return air to hvac equipment 1', {'name': u'Fraction of Input or Return Air to HVAC Equipment 1', 'pyname': u'fraction_of_input_or_return_air_to_hvac_equipment_1', 'maximum': 1.0, 'required-field': False, 'autosizable': False, 'minimum': 0.0, 'autocalculatable': False, 'type': u'real'})]),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'Alpha'})]),
 'format': None,
 'group': u'Room Air Models',
 'min-fields': 0,
 ...
 'unique-object': False}
    ...
    def add_extensible(self,
        ...
        """
        vals = []
        zonehvac_or_air_terminal_equipment_object_type_1 = self.check_value("ZoneHVAC or Air Terminal Equipment Object Type 1", zonehvac_or_air_terminal_equipment_object_type_1)
        vals.append(zonehvac_or_air_terminal_equipment_object_type_1)
        zonehvac_or_air_terminal_equipment_object_name_1 = self.check_value("ZoneHVAC or Air Terminal Equipment Object Name 1", zonehvac_or_air_terminal_equipment_object_name_1)
        vals.append(zonehvac_or_air_terminal_equipment_object_name_1)
        fraction_of_output_or_supply_air_from_hvac_equipment_1 = self.check_value("Fraction of Output or Supply Air from HVAC Equipment 1", fraction_of_output_or_supply_air_from_hvac_equipment_1)
        vals.append(fraction_of_output_or_supply_air_from_hvac_equipment_1)
        fraction_of_input_or_return_air_to_hvac_equipment_1 = self.check_value("Fraction of Input or Return Air to HVAC Equipment 1", fraction_of_input_or_return_air_to_hvac_equipment_1)
...
class RoomAirSettingsAirflowNetwork(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict([(u'roomairflownetwork:node name 1', {'name': u'RoomAirflowNetwork:Node Name 1', 'pyname': u'roomairflownetworknode_name_1', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'})]),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'}), (u'zone name', {'name': u'Zone Name', 'pyname': u'zone_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'control point roomairflownetwork:node name', {'name': u'Control Point RoomAirflowNetwork:Node Name', 'pyname': u'control_point_roomairflownetworknode_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'})]),
 'format': None,
 'group': u'Room Air Models',
 'min-fields': 5,
 ...
 'unique-object': False}
    ...
    def add_extensible(self,
        ...
        """
        vals = []
        roomairflownetworknode_name_1 = self.check_value("RoomAirflowNetwork:Node Name 1", roomairflownetworknode_name_1)
