...
class FaultModelThermostatOffset(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict(),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'}), (u'thermostat name', {'name': u'Thermostat Name', 'pyname': u'thermostat_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'availability schedule name', {'name': u'Availability Schedule Name', 'pyname': u'availability_schedule_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'severity schedule name', {'name': u'Severity Schedule Name', 'pyname': u'severity_schedule_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'reference thermostat offset', {'name': u'Reference Thermostat Offset', 'pyname': u'reference_thermostat_offset', 'default': 2.0, 'minimum>': -10.0, 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'maximum<': 10.0, 'unit': u'deltaC'})]),
 'format': None,
 'group': u'Operational Faults',
 'min-fields': 3,
...
class FaultModelHumidistatOffset(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict(),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'}), (u'humidistat name', {'name': u'Humidistat Name', 'pyname': u'humidistat_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'humidistat offset type', {'name': u'Humidistat Offset Type', 'pyname': u'humidistat_offset_type', 'default': u'ThermostatOffsetIndependent', 'required-field': False, 'autosizable': False, 'accepted-values': [u'ThermostatOffsetIndependent', u'ThermostatOffsetDependent'], 'autocalculatable': False, 'type': 'alpha'}), (u'availability schedule name', {'name': u'Availability Schedule Name', 'pyname': u'availability_schedule_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'severity schedule name', {'name': u'Severity Schedule Name', 'pyname': u'severity_schedule_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'reference humidistat offset', {'name': u'Reference Humidistat Offset', 'pyname': u'reference_humidistat_offset', 'default': 5.0, 'minimum>': -20.0, 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'maximum<': 20.0, 'unit': u'percent'}), (u'related thermostat offset fault name', {'name': u'Related Thermostat Offset Fault Name', 'pyname': u'related_thermostat_offset_fault_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'})]),
 'format': None,
 'group': u'Operational Faults',
 'min-fields': 4,
...
class FaultModelFoulingAirFilter(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict(),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'}), (u'fan object type', {'name': u'Fan Object Type', 'pyname': u'fan_object_type', 'required-field': True, 'autosizable': False, 'accepted-values': [u'Fan:OnOff', u'Fan:ConstantVolume', u'Fan:VariableVolume'], 'autocalculatable': False, 'type': 'alpha'}), (u'fan name', {'name': u'Fan Name', 'pyname': u'fan_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'availability schedule name', {'name': u'Availability Schedule Name', 'pyname': u'availability_schedule_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'pressure fraction schedule name', {'name': u'Pressure Fraction Schedule Name', 'pyname': u'pressure_fraction_schedule_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'fan curve name', {'name': u'Fan Curve Name', 'pyname': u'fan_curve_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'})]),
 'format': None,
 'group': u'Operational Faults',
 'min-fields': 4,
