...
class EvaporativeCoolerDirectCelDekPad(DataObject):
 ...
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'}), (u'availability schedule name', {'name': u'Availability Schedule Name', 'pyname': u'availability_schedule_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'direct pad area', {'name': u'Direct Pad Area', 'pyname': u'direct_pad_area', 'default': 'Autosize', 'required-field': True, 'autosizable': True, 'minimum': 0.0, 'autocalculatable': False, 'type': 'real', 'unit': u'm2'}), (u'direct pad depth', {'name': u'Direct Pad Depth', 'pyname': u'direct_pad_depth', 'default': 'Autosize', 'required-field': True, 'autosizable': True, 'minimum': 0.0, 'autocalculatable': False, 'type': 'real', 'unit': u'm'}), (u'recirculating water pump power consumption', {'name': u'Recirculating Water Pump Power Consumption', 'pyname': u'recirculating_water_pump_power_consumption', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': 'real', 'unit': u'W'}), (u'air inlet node name', {'name': u'Air Inlet Node Name', 'pyname': u'air_inlet_node_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'node'}), (u'air outlet node name', {'name': u'Air Outlet Node Name', 'pyname': u'air_outlet_node_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'node'}), (u'control type', {'name': u'Control Type', 'pyname': u'control_type', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': 'alpha'}), (u'water supply storage tank name', {'name': u'Water Supply Storage Tank Name', 'pyname': u'water_supply_storage_tank_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'})]),
 'format': None,
...
class EvaporativeCoolerIndirectCelDekPad(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict(),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'}), (u'availability schedule name', {'name': u'Availability Schedule Name', 'pyname': u'availability_schedule_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'direct pad area', {'name': u'Direct Pad Area', 'pyname': u'direct_pad_area', 'default': 'Autosize', 'required-field': True, 'autosizable': True, 'minimum': 0.0, 'autocalculatable': False, 'type': u'real', 'unit': u'm2'}), (u'direct pad depth', {'name': u'Direct Pad Depth', 'pyname': u'direct_pad_depth', 'default': 'Autosize', 'required-field': True, 'autosizable': True, 'minimum': 0.0, 'autocalculatable': False, 'type': u'real', 'unit': u'm'}), (u'recirculating water pump power consumption', {'name': u'Recirculating Water Pump Power Consumption', 'pyname': u'recirculating_water_pump_power_consumption', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'W'}), (u'secondary air fan flow rate', {'name': u'Secondary Air Fan Flow Rate', 'pyname': u'secondary_air_fan_flow_rate', 'required-field': True, 'autosizable': False, 'minimum': 0.0, 'autocalculatable': False, 'type': u'real', 'unit': u'm3/s'}), (u'secondary air fan total efficiency', {'name': u'Secondary Air Fan Total Efficiency', 'pyname': u'secondary_air_fan_total_efficiency', 'minimum>': 0.0, 'maximum': 1.0, 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'real'}), (u'secondary air fan delta pressure', {'name': u'Secondary Air Fan Delta Pressure', 'pyname': u'secondary_air_fan_delta_pressure', 'required-field': True, 'autosizable': False, 'minimum': 0.0, 'autocalculatable': False, 'type': u'real', 'unit': u'Pa'}), (u'indirect heat exchanger effectiveness', {'name': u'Indirect Heat Exchanger Effectiveness', 'pyname': u'indirect_heat_exchanger_effectiveness', 'required-field': True, 'autosizable': False, 'minimum': 0.0, 'autocalculatable': False, 'type': u'real'}), (u'primary air inlet node name', {'name': u'Primary Air Inlet Node Name', 'pyname': u'primary_air_inlet_node_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'node'}), (u'primary air outlet node name', {'name': u'Primary Air Outlet Node Name', 'pyname': u'primary_air_outlet_node_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'node'}), (u'control type', {'name': u'Control Type', 'pyname': u'control_type', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': 'alpha'}), (u'water supply storage tank name', {'name': u'Water Supply Storage Tank Name', 'pyname': u'water_supply_storage_tank_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'secondary air inlet node name', {'name': u'Secondary Air Inlet Node Name', 'pyname': u'secondary_air_inlet_node_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'node'})]),
 'format': None,
 'group': u'Evaporative Coolers',
 'min-fields': 14,
...
class EvaporativeCoolerIndirectWetCoil(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict(),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'}), (u'availability schedule name', {'name': u'Availability Schedule Name', 'pyname': u'availability_schedule_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'coil maximum efficiency', {'name': u'Coil Maximum Efficiency', 'pyname': u'coil_maximum_efficiency', 'maximum': 1.0, 'required-field': True, 'autosizable': False, 'minimum': 0.0, 'autocalculatable': False, 'type': u'real'}), (u'coil flow ratio', {'name': u'Coil Flow Ratio', 'pyname': u'coil_flow_ratio', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'real'}), (u'recirculating water pump power consumption', {'name': u'Recirculating Water Pump Power Consumption', 'pyname': u'recirculating_water_pump_power_consumption', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': 'real', 'unit': u'W'}), (u'secondary air fan flow rate', {'name': u'Secondary Air Fan Flow Rate', 'pyname': u'secondary_air_fan_flow_rate', 'required-field': True, 'autosizable': False, 'minimum': 0.0, 'autocalculatable': False, 'type': 'real', 'unit': u'm3/s'}), (u'secondary air fan total efficiency', {'name': u'Secondary Air Fan Total Efficiency', 'pyname': u'secondary_air_fan_total_efficiency', 'minimum>': 0.0, 'maximum': 1.0, 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'real'}), (u'secondary air fan delta pressure', {'name': u'Secondary Air Fan Delta Pressure', 'pyname': u'secondary_air_fan_delta_pressure', 'required-field': True, 'autosizable': False, 'minimum': 0.0, 'autocalculatable': False, 'type': 'real', 'unit': u'Pa'}), (u'primary air inlet node name', {'name': u'Primary Air Inlet Node Name', 'pyname': u'primary_air_inlet_node_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'node'}), (u'primary air outlet node name', {'name': u'Primary Air Outlet Node Name', 'pyname': u'primary_air_outlet_node_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'node'}), (u'control type', {'name': u'Control Type', 'pyname': u'control_type', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': 'alpha'}), (u'water supply storage tank name', {'name': u'Water Supply Storage Tank Name', 'pyname': u'water_supply_storage_tank_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'secondary air inlet node name', {'name': u'Secondary Air Inlet Node Name', 'pyname': u'secondary_air_inlet_node_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'node'})]),
 'format': None,
 'group': u'Evaporative Coolers',
 'min-fields': 13,
...
class EvaporativeCoolerIndirectResearchSpecial(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict(),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'}), (u'availability schedule name', {'name': u'Availability Schedule Name', 'pyname': u'availability_schedule_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'cooler wetbulb design effectiveness', {'name': u'Cooler Wetbulb Design Effectiveness', 'pyname': u'cooler_wetbulb_design_effectiveness', 'maximum': 2.0, 'required-field': True, 'autosizable': False, 'minimum': 0.0, 'autocalculatable': False, 'type': u'real'}), (u'wetbulb effectiveness flow ratio modifier curve name', {'name': u'Wetbulb Effectiveness Flow Ratio Modifier Curve Name', 'pyname': u'wetbulb_effectiveness_flow_ratio_modifier_curve_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'cooler drybulb design effectiveness', {'name': u'Cooler Drybulb Design Effectiveness', 'pyname': u'cooler_drybulb_design_effectiveness', 'required-field': False, 'autosizable': False, 'minimum': 0.0, 'autocalculatable': False, 'type': u'real'}), (u'drybulb effectiveness flow ratio modifier curve name', {'name': u'Drybulb Effectiveness Flow Ratio Modifier Curve Name', 'pyname': u'drybulb_effectiveness_flow_ratio_modifier_curve_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'recirculating water pump design power', {'name': u'Recirculating Water Pump Design Power', 'pyname': u'recirculating_water_pump_design_power', 'required-field': False, 'autosizable': True, 'autocalculatable': False, 'type': 'real', 'unit': u'W'}), (u'water pump power sizing factor', {'name': u'Water Pump Power Sizing Factor', 'pyname': u'water_pump_power_sizing_factor', 'default': 90.0, 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'W/(m3/s)'}), (u'water pump power modifier curve name', {'name': u'Water Pump Power Modifier Curve Name', 'pyname': u'water_pump_power_modifier_curve_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'secondary air design flow rate', {'name': u'Secondary Air Design Flow Rate', 'pyname': u'secondary_air_design_flow_rate', 'minimum>': 0.0, 'required-field': False, 'autosizable': True, 'autocalculatable': False, 'type': u'real', 'unit': u'm3/s'}), (u'secondary air flow scaling factor', {'name': u'Secondary Air Flow Scaling Factor', 'pyname': u'secondary_air_flow_scaling_factor', 'default': 1.0, 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'dimensionless'}), (u'secondary air fan design power', {'name': u'Secondary Air Fan Design Power', 'pyname': u'secondary_air_fan_design_power', 'required-field': False, 'autosizable': True, 'autocalculatable': False, 'type': u'real', 'unit': u'W'}), (u'secondary air fan sizing specific power', {'name': u'Secondary Air Fan Sizing Specific Power', 'pyname': u'secondary_air_fan_sizing_specific_power', 'default': 250.0, 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'W/(m3/s)'}), (u'secondary air fan power modifier curve name', {'name': u'Secondary Air Fan Power Modifier Curve Name', 'pyname': u'secondary_air_fan_power_modifier_curve_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'primary air inlet node name', {'name': u'Primary Air Inlet Node Name', 'pyname': u'primary_air_inlet_node_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'node'}), (u'primary air outlet node name', {'name': u'Primary Air Outlet Node Name', 'pyname': u'primary_air_outlet_node_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'node'}), (u'primary air design flow rate', {'name': u'Primary Air Design Flow Rate', 'pyname': u'primary_air_design_flow_rate', 'minimum>': 0.0, 'required-field': False, 'autosizable': True, 'autocalculatable': False, 'type': u'real', 'unit': u'm3/s'}), (u'dewpoint effectiveness factor', {'name': u'Dewpoint Effectiveness Factor', 'pyname': u'dewpoint_effectiveness_factor', 'required-field': False, 'autosizable': False, 'minimum': 0.0, 'autocalculatable': False, 'type': u'real'}), (u'secondary air inlet node name', {'name': u'Secondary Air Inlet Node Name', 'pyname': u'secondary_air_inlet_node_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'node'}), (u'secondary air outlet node name', {'name': u'Secondary Air Outlet Node Name', 'pyname': u'secondary_air_outlet_node_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'node'}), (u'sensor node name', {'name': u'Sensor Node Name', 'pyname': u'sensor_node_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'node'}), (u'relief air inlet node name', {'name': u'Relief Air Inlet Node Name', 'pyname': u'relief_air_inlet_node_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'node'}), (u'water supply storage tank name', {'name': u'Water Supply Storage Tank Name', 'pyname': u'water_supply_storage_tank_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'drift loss fraction', {'name': u'Drift Loss Fraction', 'pyname': u'drift_loss_fraction', 'default': 0.0, 'required-field': False, 'autosizable': False, 'minimum': 0.0, 'autocalculatable': False, 'type': u'real'}), (u'blowdown concentration ratio', {'name': u'Blowdown Concentration Ratio', 'pyname': u'blowdown_concentration_ratio', 'required-field': False, 'autosizable': False, 'minimum': 2.0, 'autocalculatable': False, 'type': u'real'}), (u'evaporative operation minimum limit secondary air drybulb temperature', {'name': u'Evaporative Operation Minimum Limit Secondary Air Drybulb Temperature', 'pyname': u'evaporative_operation_minimum_limit_secondary_air_drybulb_temperature', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'real'}), (u'evaporative operation maximum limit outdoor wetbulb temperature', {'name': u'Evaporative Operation Maximum Limit Outdoor Wetbulb Temperature', 'pyname': u'evaporative_operation_maximum_limit_outdoor_wetbulb_temperature', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'real'}), (u'dry operation maximum limit outdoor drybulb temperature', {'name': u'Dry Operation Maximum Limit Outdoor Drybulb Temperature', 'pyname': u'dry_operation_maximum_limit_outdoor_drybulb_temperature', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'real'})]),
 'format': None,
 'group': u'Evaporative Coolers',
 'min-fields': 21,
 ...
 'unique-object': False}
    ...
    def wetbulb_effectiveness_flow_ratio_modifier_curve_name(self, value=None):
        """  Corresponds to IDD field `Wetbulb Effectiveness Flow Ratio Modifier Curve Name`
    ...
    def drybulb_effectiveness_flow_ratio_modifier_curve_name(self, value=None):
        """  Corresponds to IDD field `Drybulb Effectiveness Flow Ratio Modifier Curve Name`
    ...
    def secondary_air_fan_sizing_specific_power(self, value=250.0):
        """  Corresponds to IDD field `Secondary Air Fan Sizing Specific Power`
    ...
    def secondary_air_fan_power_modifier_curve_name(self, value=None):
        """  Corresponds to IDD field `Secondary Air Fan Power Modifier Curve Name`
    ...
    @property
    def evaporative_operation_minimum_limit_secondary_air_drybulb_temperature(self):
        ...
        """
        return self["Evaporative Operation Minimum Limit Secondary Air Drybulb Temperature"]

    @evaporative_operation_minimum_limit_secondary_air_drybulb_temperature.setter
    def evaporative_operation_minimum_limit_secondary_air_drybulb_temperature(self, value=None):
        """  Corresponds to IDD field `Evaporative Operation Minimum Limit Secondary Air Drybulb Temperature`

        """
        self["Evaporative Operation Minimum Limit Secondary Air Drybulb Temperature"] = value
    ...
    def evaporative_operation_maximum_limit_outdoor_wetbulb_temperature(self):
        ...
        """
        return self["Evaporative Operation Maximum Limit Outdoor Wetbulb Temperature"]

    @evaporative_operation_maximum_limit_outdoor_wetbulb_temperature.setter
    def evaporative_operation_maximum_limit_outdoor_wetbulb_temperature(self, value=None):
        """  Corresponds to IDD field `Evaporative Operation Maximum Limit Outdoor Wetbulb Temperature`

        """
        self["Evaporative Operation Maximum Limit Outdoor Wetbulb Temperature"] = value
    ...
    def dry_operation_maximum_limit_outdoor_drybulb_temperature(self, value=None):
        """  Corresponds to IDD field `Dry Operation Maximum Limit Outdoor Drybulb Temperature`
...
class EvaporativeCoolerDirectResearchSpecial(DataObject):
 ...
 'unique-object': False}
    ...
    def effectiveness_flow_ratio_modifier_curve_name(self, value=None):
        """  Corresponds to IDD field `Effectiveness Flow Ratio Modifier Curve Name`
    ...
    def evaporative_operation_minimum_drybulb_temperature(self, value=None):
        """  Corresponds to IDD field `Evaporative Operation Minimum Drybulb Temperature`
    ...
    def evaporative_operation_maximum_limit_wetbulb_temperature(self, value=None):
        """  Corresponds to IDD field `Evaporative Operation Maximum Limit Wetbulb Temperature`
    ...
    def evaporative_operation_maximum_limit_drybulb_temperature(self, value=None):
        """  Corresponds to IDD field `Evaporative Operation Maximum Limit Drybulb Temperature`
