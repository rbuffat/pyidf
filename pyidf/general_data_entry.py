...
class MatrixTwoDimension(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict([(u'value 1', {'name': u'Value 1', 'pyname': u'value_1', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'real'})]),
