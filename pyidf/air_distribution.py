...
class AirLoopHvacZoneSplitter(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict([(u'outlet 1 node name', {'name': u'Outlet 1 Node Name', 'pyname': u'outlet_1_node_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'node'})]),
 ...
 'unique-object': False}
    ...
    def add_extensible(self,
        ...
        """
        vals = []
        outlet_1_node_name = self.check_value("Outlet 1 Node Name", outlet_1_node_name)
...
class AirLoopHvacZoneMixer(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict([(u'inlet 1 node name', {'name': u'Inlet 1 Node Name', 'pyname': u'inlet_1_node_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'node'})]),
