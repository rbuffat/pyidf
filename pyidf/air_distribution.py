...
class AirLoopHvac(DataObject):
 ...
 'unique-object': False}
    ...
    def controller_list_name(self):
        """The value of field `Controller List Name`
    ...
    def branch_list_name(self):
        """The value of field `Branch List Name`
    ...
    def connector_list_name(self):
        """The value of field `Connector List Name`
    ...
    def supply_side_inlet_node_name(self):
        """The value of field `Supply Side Inlet Node Name`
    ...
    def demand_side_inlet_node_names(self):
        """The value of field `Demand Side Inlet Node Names`
    ...
    def supply_side_outlet_node_names(self):
        """The value of field `Supply Side Outlet Node Names`
...
class AirLoopHvacOutdoorAirSystemEquipmentList(DataObject):
 ...
 'unique-object': False}
    ...
    def component_9_object_type(self):
        """The value of field `Component 9 Object Type`
    ...
    def component_9_name(self):
        """The value of field `Component 9 Name`
...
class AirLoopHvacOutdoorAirSystem(DataObject):
 ...
 'unique-object': False}
    ...
    def outdoor_air_equipment_list_name(self):
        """The value of field `Outdoor Air Equipment List Name`
...
class OutdoorAirMixer(DataObject):
 ...
 'unique-object': False}
    ...
    def relief_air_stream_node_name(self):
        """The value of field `Relief Air Stream Node Name`
...
class AirLoopHvacZoneSplitter(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict([(u'outlet  node name', {'name': u'Outlet  Node Name', 'pyname': u'outlet_node_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'node'})]),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': 'alpha'}), (u'inlet node name', {'name': u'Inlet Node Name', 'pyname': u'inlet_node_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'node'})]),
 'format': None,
 'group': u'Air Distribution',
 'min-fields': 0,
...
class AirLoopHvacSupplyPlenum(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict([(u'outlet node name', {'name': u'Outlet Node Name', 'pyname': u'outlet_node_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'node'})]),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': 'alpha'}), (u'zone name', {'name': u'Zone Name', 'pyname': u'zone_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'zone node name', {'name': u'Zone Node Name', 'pyname': u'zone_node_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'node'}), (u'inlet node name', {'name': u'Inlet Node Name', 'pyname': u'inlet_node_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'node'})]),
 'format': None,
 'group': u'Air Distribution',
 'min-fields': 5,
...
class AirLoopHvacSupplyPath(DataObject):
 ...
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': 'alpha'}), (u'supply air path inlet node name', {'name': u'Supply Air Path Inlet Node Name', 'pyname': u'supply_air_path_inlet_node_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'node'})]),
 'format': None,
 'group': u'Air Distribution',
 'min-fields': 0,
 ...
 'unique-object': False}
    ...
    def supply_air_path_inlet_node_name(self):
        """The value of field `Supply Air Path Inlet Node Name`
...
class AirLoopHvacZoneMixer(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict([(u'inlet 1 node name', {'name': u'Inlet 1 Node Name', 'pyname': u'inlet_1_node_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'node'})]),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': 'alpha'}), (u'outlet node name', {'name': u'Outlet Node Name', 'pyname': u'outlet_node_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'node'})]),
 'format': None,
 'group': u'Air Distribution',
 'min-fields': 3,
...
class AirLoopHvacReturnPlenum(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict([(u'inlet node name', {'name': u'Inlet Node Name', 'pyname': u'inlet_node_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'node'})]),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': 'alpha'}), (u'zone name', {'name': u'Zone Name', 'pyname': u'zone_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'zone node name', {'name': u'Zone Node Name', 'pyname': u'zone_node_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'node'}), (u'outlet node name', {'name': u'Outlet Node Name', 'pyname': u'outlet_node_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'node'}), (u'induced air outlet node or nodelist name', {'name': u'Induced Air Outlet Node or NodeList Name', 'pyname': u'induced_air_outlet_node_or_nodelist_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'node'})]),
 'format': None,
 'group': u'Air Distribution',
 'min-fields': 6,
 ...
 'unique-object': False}
    ...
    def induced_air_outlet_node_or_nodelist_name(self):
        """The value of field `Induced Air Outlet Node or NodeList Name`
...
class AirLoopHvacReturnPath(DataObject):
 ...
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': 'alpha'}), (u'return air path outlet node name', {'name': u'Return Air Path Outlet Node Name', 'pyname': u'return_air_path_outlet_node_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'node'})]),
 'format': None,
 'group': u'Air Distribution',
 'min-fields': 0,
 ...
 'unique-object': False}
    ...
    def return_air_path_outlet_node_name(self):
        """The value of field `Return Air Path Outlet Node Name`
