...
class FloorDetailed(object):
    ...
    def __init__(self):
        """ Init data dictionary object for EPW IDD  `Floor:Detailed`
        """
...
class FloorGroundContact(object):
    ...
    def __init__(self):
        """ Init data dictionary object for EPW IDD  `Floor:GroundContact`
        """
        self._data = OrderedDict()
        self._data["Name"] = None
        self._data["Construction Name"] = None
...
class FloorAdiabatic(object):
    ...
    def __init__(self):
        """ Init data dictionary object for EPW IDD  `Floor:Adiabatic`
        """
        self._data = OrderedDict()
        self._data["Name"] = None
        self._data["Construction Name"] = None
...
class FloorInterzone(object):
    ...
    def __init__(self):
        """ Init data dictionary object for EPW IDD  `Floor:Interzone`
        """
        self._data = OrderedDict()
        self._data["Name"] = None
        self._data["Construction Name"] = None
