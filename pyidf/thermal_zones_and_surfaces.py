...
class GlobalGeometryRules(DataObject):
 ...
 'unique-object': True}
    ...
    def starting_vertex_position(self):
        """The value of field `Starting Vertex Position`
    ...
    def vertex_entry_direction(self):
        """The value of field `Vertex Entry Direction`
    ...
    def coordinate_system(self):
        """The value of field `Coordinate System`
    ...
    def daylighting_reference_point_coordinate_system(self):
        """The value of field `Daylighting Reference Point Coordinate System`
        Relative -- coordinates are entered relative to zone origin
        World -- all coordinates entered are "absolute" for this facility
        absolute -- same as world
    ...
    def rectangular_surface_coordinate_system(self):
        """The value of field `Rectangular Surface Coordinate System`
...
class GeometryTransform(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict(),
 'fields': OrderedDict([(u'plane of transform', {'name': u'Plane of Transform', 'pyname': u'plane_of_transform', 'default': u'XY', 'required-field': True, 'autosizable': False, 'accepted-values': [u'XY'], 'autocalculatable': False, 'type': 'alpha'}), (u'current aspect ratio', {'name': u'Current Aspect Ratio', 'pyname': u'current_aspect_ratio', 'minimum>': 0.0, 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': 'real'}), (u'new aspect ratio', {'name': u'New Aspect Ratio', 'pyname': u'new_aspect_ratio', 'minimum>': 0.0, 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': 'real'})]),
 'format': None,
 'group': u'Thermal Zones and Surfaces',
 'min-fields': 0,
 ...
 'unique-object': True}
    ...
    def plane_of_transform(self):
        """The value of field `Plane of Transform`
    ...
    def current_aspect_ratio(self):
        """The value of field `Current Aspect Ratio`
    ...
    def new_aspect_ratio(self):
        """The value of field `New Aspect Ratio`
...
class Zone(DataObject):
 ...
 'unique-object': False}
    ...
    def direction_of_relative_north(self):
        """The value of field `Direction of Relative North`
    ...
    def ceiling_height(self):
        """The value of field `Ceiling Height`
    ...
    def zone_inside_convection_algorithm(self):
        """The value of field `Zone Inside Convection Algorithm`
    ...
    def zone_outside_convection_algorithm(self):
        """The value of field `Zone Outside Convection Algorithm`
    ...
    def part_of_total_floor_area(self):
        """The value of field `Part of Total Floor Area`
...
class ZoneList(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict([(u'zone 1 name', {'name': u'Zone 1 Name', 'pyname': u'zone_1_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'})]),
...
class ZoneGroup(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict(),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'}), (u'zone list name', {'name': u'Zone List Name', 'pyname': u'zone_list_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'zone list multiplier', {'name': u'Zone List Multiplier', 'pyname': u'zone_list_multiplier', 'default': 1, 'required-field': False, 'autosizable': False, 'minimum': 1, 'autocalculatable': False, 'type': u'integer'})]),
 'format': None,
 'group': u'Thermal Zones and Surfaces',
 'min-fields': 2,
 'name': u'ZoneGroup',
 ...
 'unique-object': False}
    ...
    def zone_list_name(self):
        """The value of field `Zone List Name`
    ...
    def zone_list_multiplier(self):
        """The value of field `Zone List Multiplier`
...
class BuildingSurfaceDetailed(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict([(u'vertex 1 x-coordinate', {'name': u'Vertex 1 X-coordinate', 'pyname': u'vertex_1_xcoordinate', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'm'}), (u'vertex 1 y-coordinate', {'name': u'Vertex 1 Y-coordinate', 'pyname': u'vertex_1_ycoordinate', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'm'}), (u'vertex 1 z-coordinate', {'name': u'Vertex 1 Z-coordinate', 'pyname': u'vertex_1_zcoordinate', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'm'})]),
 ...
 'unique-object': False}
    ...
    def outside_boundary_condition(self):
        """The value of field `Outside Boundary Condition`
    ...
    def outside_boundary_condition_object(self):
        """The value of field `Outside Boundary Condition Object`
    ...
    def sun_exposure(self):
        """The value of field `Sun Exposure`
    ...
    def wind_exposure(self):
        """The value of field `Wind Exposure`
    ...
    def view_factor_to_ground(self):
        """The value of field `View Factor to Ground`
    ...
    def number_of_vertices(self):
        """The value of field `Number of Vertices`
...
class WallDetailed(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict([(u'vertex 1 x-coordinate', {'name': u'Vertex 1 X-coordinate', 'pyname': u'vertex_1_xcoordinate', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'm'}), (u'vertex 1 y-coordinate', {'name': u'Vertex 1 Y-coordinate', 'pyname': u'vertex_1_ycoordinate', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'm'}), (u'vertex 1 z-coordinate', {'name': u'Vertex 1 Z-coordinate', 'pyname': u'vertex_1_zcoordinate', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'm'})]),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'}), (u'construction name', {'name': u'Construction Name', 'pyname': u'construction_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'zone name', {'name': u'Zone Name', 'pyname': u'zone_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'outside boundary condition', {'name': u'Outside Boundary Condition', 'pyname': u'outside_boundary_condition', 'required-field': True, 'autosizable': False, 'accepted-values': [u'Adiabatic', u'Surface', u'Zone', u'Outdoors', u'Ground', u'GroundFCfactorMethod', u'OtherSideCoefficients', u'OtherSideConditionsModel', u'GroundSlabPreprocessorAverage', u'GroundSlabPreprocessorCore', u'GroundSlabPreprocessorPerimeter', u'GroundBasementPreprocessorAverageWall', u'GroundBasementPreprocessorAverageFloor', u'GroundBasementPreprocessorUpperWall', u'GroundBasementPreprocessorLowerWall'], 'autocalculatable': False, 'type': 'alpha'}), (u'outside boundary condition object', {'name': u'Outside Boundary Condition Object', 'pyname': u'outside_boundary_condition_object', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'sun exposure', {'name': u'Sun Exposure', 'pyname': u'sun_exposure', 'default': u'SunExposed', 'required-field': True, 'autosizable': False, 'accepted-values': [u'SunExposed', u'NoSun'], 'autocalculatable': False, 'type': 'alpha'}), (u'wind exposure', {'name': u'Wind Exposure', 'pyname': u'wind_exposure', 'default': u'WindExposed', 'required-field': True, 'autosizable': False, 'accepted-values': [u'WindExposed', u'NoWind'], 'autocalculatable': False, 'type': 'alpha'}), (u'view factor to ground', {'name': u'View Factor to Ground', 'pyname': u'view_factor_to_ground', 'default': 'autocalculate', 'maximum': 1.0, 'required-field': False, 'autosizable': False, 'minimum': 0.0, 'autocalculatable': True, 'type': u'real'}), (u'number of vertices', {'name': u'Number of Vertices', 'pyname': u'number_of_vertices', 'default': 'autocalculate', 'required-field': False, 'autosizable': False, 'minimum': 3.0, 'autocalculatable': True, 'type': 'real'})]),
 'format': u'vertices',
 'group': u'Thermal Zones and Surfaces',
 'min-fields': 18,
...
class WallExterior(DataObject):
 ...
 'unique-object': False}
    ...
    def azimuth_angle(self):
        """The value of field `Azimuth Angle`
    ...
    def starting_x_coordinate(self):
        """The value of field `Starting X Coordinate`
    ...
    def starting_y_coordinate(self):
        """The value of field `Starting Y Coordinate`
    ...
    def starting_z_coordinate(self):
        """The value of field `Starting Z Coordinate`
...
class WallInterzone(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict(),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'}), (u'construction name', {'name': u'Construction Name', 'pyname': u'construction_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'zone name', {'name': u'Zone Name', 'pyname': u'zone_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'outside boundary condition object', {'name': u'Outside Boundary Condition Object', 'pyname': u'outside_boundary_condition_object', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'azimuth angle', {'name': u'Azimuth Angle', 'pyname': u'azimuth_angle', 'maximum': 360.0, 'required-field': False, 'autosizable': False, 'minimum': 0.0, 'autocalculatable': False, 'type': 'real', 'unit': u'deg'}), (u'tilt angle', {'name': u'Tilt Angle', 'pyname': u'tilt_angle', 'default': 90.0, 'maximum': 180.0, 'required-field': False, 'autosizable': False, 'minimum': 0.0, 'autocalculatable': False, 'type': 'real', 'unit': u'deg'}), (u'starting x coordinate', {'name': u'Starting X Coordinate', 'pyname': u'starting_x_coordinate', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': 'real', 'unit': u'm'}), (u'starting y coordinate', {'name': u'Starting Y Coordinate', 'pyname': u'starting_y_coordinate', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': 'real', 'unit': u'm'}), (u'starting z coordinate', {'name': u'Starting Z Coordinate', 'pyname': u'starting_z_coordinate', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': 'real', 'unit': u'm'}), (u'length', {'name': u'Length', 'pyname': u'length', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': 'real', 'unit': u'm'}), (u'height', {'name': u'Height', 'pyname': u'height', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': 'real', 'unit': u'm'})]),
 'format': None,
 'group': u'Thermal Zones and Surfaces',
 'min-fields': 0,
...
class FenestrationSurfaceDetailed(DataObject):
 ...
 'unique-object': False}
    ...
    def building_surface_name(self):
        """The value of field `Building Surface Name`
    ...
    def shading_control_name(self):
        """The value of field `Shading Control Name`
    ...
    def frame_and_divider_name(self):
        """The value of field `Frame and Divider Name`
    ...
    def vertex_1_xcoordinate(self):
        """The value of field `Vertex 1 X-coordinate`
    ...
    def vertex_1_ycoordinate(self):
        """The value of field `Vertex 1 Y-coordinate`
    ...
    def vertex_1_zcoordinate(self):
        """The value of field `Vertex 1 Z-coordinate`
    ...
    def vertex_2_xcoordinate(self):
        """The value of field `Vertex 2 X-coordinate`
    ...
    def vertex_2_ycoordinate(self):
        """The value of field `Vertex 2 Y-coordinate`
    ...
    def vertex_2_zcoordinate(self):
        """The value of field `Vertex 2 Z-coordinate`
    ...
    def vertex_3_xcoordinate(self):
        """The value of field `Vertex 3 X-coordinate`
    ...
    def vertex_3_ycoordinate(self):
        """The value of field `Vertex 3 Y-coordinate`
    ...
    def vertex_3_zcoordinate(self):
        """The value of field `Vertex 3 Z-coordinate`
    ...
    def vertex_4_xcoordinate(self):
        """The value of field `Vertex 4 X-coordinate`
    ...
    def vertex_4_ycoordinate(self):
        """The value of field `Vertex 4 Y-coordinate`
        Not used for triangles
    ...
    def vertex_4_zcoordinate(self):
        """The value of field `Vertex 4 Z-coordinate`
        Not used for triangles
...
class Window(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict(),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'}), (u'construction name', {'name': u'Construction Name', 'pyname': u'construction_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'building surface name', {'name': u'Building Surface Name', 'pyname': u'building_surface_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'shading control name', {'name': u'Shading Control Name', 'pyname': u'shading_control_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'frame and divider name', {'name': u'Frame and Divider Name', 'pyname': u'frame_and_divider_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'multiplier', {'name': u'Multiplier', 'pyname': u'multiplier', 'default': 1.0, 'required-field': False, 'autosizable': False, 'minimum': 1.0, 'autocalculatable': False, 'type': 'real'}), (u'starting x coordinate', {'name': u'Starting X Coordinate', 'pyname': u'starting_x_coordinate', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': 'real', 'unit': u'm'}), (u'starting z coordinate', {'name': u'Starting Z Coordinate', 'pyname': u'starting_z_coordinate', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': 'real', 'unit': u'm'}), (u'length', {'name': u'Length', 'pyname': u'length', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': 'real', 'unit': u'm'}), (u'height', {'name': u'Height', 'pyname': u'height', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': 'real', 'unit': u'm'})]),
 'format': None,
 'group': u'Thermal Zones and Surfaces',
 'min-fields': 0,
 'name': u'Window',
...
class WindowPropertyShadingControl(DataObject):
 ...
 'unique-object': False}
    ...
    def shading_type(self):
        """The value of field `Shading Type`
    ...
    def construction_with_shading_name(self):
        """The value of field `Construction with Shading Name`
    ...
    def shading_control_type(self):
        """The value of field `Shading Control Type`
    ...
    def shading_control_is_scheduled(self):
        """The value of field `Shading Control Is Scheduled`
    ...
    def glare_control_is_active(self):
        """The value of field `Glare Control Is Active`
    ...
    def shading_device_material_name(self):
        """The value of field `Shading Device Material Name`
    ...
    def type_of_slat_angle_control_for_blinds(self):
        """The value of field `Type of Slat Angle Control for Blinds`
    ...
    def slat_angle_schedule_name(self):
        """The value of field `Slat Angle Schedule Name`
        Used only if Shading Type = InteriorBlind, ExteriorBlind or BetweenGlassBlind.
...
class WindowPropertyFrameAndDivider(DataObject):
 ...
 'unique-object': False}
    ...
    def frame_width(self):
        """The value of field `Frame Width`
    ...
    def frame_outside_projection(self):
        """The value of field `Frame Outside Projection`
    ...
    def frame_inside_projection(self):
        """The value of field `Frame Inside Projection`
    ...
    def frame_conductance(self):
        """The value of field `Frame Conductance`
    ...
    def ratio_of_frameedge_glass_conductance_to_centerofglass_conductance(self):
        """The value of field `Ratio of Frame-Edge Glass Conductance to Center-Of-Glass Conductance`
    ...
    def frame_solar_absorptance(self):
        """The value of field `Frame Solar Absorptance`
    ...
    def frame_visible_absorptance(self):
        """The value of field `Frame Visible Absorptance`
        Assumed same on outside and inside of frame
    ...
    def frame_thermal_hemispherical_emissivity(self):
        """The value of field `Frame Thermal Hemispherical Emissivity`
        Assumed same on outside and inside of frame
    ...
    def divider_type(self):
        """The value of field `Divider Type`
    ...
    def divider_width(self):
        """The value of field `Divider Width`
    ...
    def number_of_horizontal_dividers(self):
        """The value of field `Number of Horizontal Dividers`
    ...
    def number_of_vertical_dividers(self):
        """The value of field `Number of Vertical Dividers`
    ...
    def divider_outside_projection(self):
        """The value of field `Divider Outside Projection`
    ...
    def divider_inside_projection(self):
        """The value of field `Divider Inside Projection`
    ...
    def divider_conductance(self):
        """The value of field `Divider Conductance`
    ...
    def ratio_of_divideredge_glass_conductance_to_centerofglass_conductance(self):
        """The value of field `Ratio of Divider-Edge Glass Conductance to Center-Of-Glass Conductance`
        Excludes air films
        Obtained from WINDOW 5 or other 2-D calculation
    ...
    def divider_solar_absorptance(self):
        """The value of field `Divider Solar Absorptance`
    ...
    def divider_visible_absorptance(self):
        """The value of field `Divider Visible Absorptance`
        Assumed same on outside and inside of divider
    ...
    def divider_thermal_hemispherical_emissivity(self):
        """The value of field `Divider Thermal Hemispherical Emissivity`
        Assumed same on outside and inside of divider
    ...
    def outside_reveal_solar_absorptance(self):
        """The value of field `Outside Reveal Solar Absorptance`
    ...
    def inside_sill_depth(self):
        """The value of field `Inside Sill Depth`
    ...
    def inside_sill_solar_absorptance(self):
        """The value of field `Inside Sill Solar Absorptance`
    ...
    def inside_reveal_depth(self):
        """The value of field `Inside Reveal Depth`
    ...
    def inside_reveal_solar_absorptance(self):
        """The value of field `Inside Reveal Solar Absorptance`
...
class WindowPropertyAirflowControl(DataObject):
 ...
 'unique-object': False}
    ...
    def airflow_source(self):
        """The value of field `Airflow Source`
    ...
    def airflow_destination(self):
        """The value of field `Airflow Destination`
    ...
    def airflow_control_type(self):
        """The value of field `Airflow Control Type`
    ...
    def airflow_is_scheduled(self):
        """The value of field `Airflow Is Scheduled`
    ...
    def airflow_multiplier_schedule_name(self):
        """The value of field `Airflow Multiplier Schedule Name`
...
class WindowPropertyStormWindow(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict(),
 'fields': OrderedDict([(u'window name', {'name': u'Window Name', 'pyname': u'window_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'}), (u'storm glass layer name', {'name': u'Storm Glass Layer Name', 'pyname': u'storm_glass_layer_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'distance between storm glass layer and adjacent glass', {'name': u'Distance Between Storm Glass Layer and Adjacent Glass', 'pyname': u'distance_between_storm_glass_layer_and_adjacent_glass', 'default': 0.05, 'minimum>': 0.0, 'maximum': 0.5, 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'm'}), (u'month that storm glass layer is put on', {'name': u'Month that Storm Glass Layer is Put On', 'pyname': u'month_that_storm_glass_layer_is_put_on', 'maximum': 12, 'required-field': True, 'autosizable': False, 'minimum': 1, 'autocalculatable': False, 'type': u'integer'}), (u'day of month that storm glass layer is put on', {'name': u'Day of Month that Storm Glass Layer is Put On', 'pyname': u'day_of_month_that_storm_glass_layer_is_put_on', 'maximum': 31, 'required-field': True, 'autosizable': False, 'minimum': 1, 'autocalculatable': False, 'type': u'integer'}), (u'month that storm glass layer is taken off', {'name': u'Month that Storm Glass Layer is Taken Off', 'pyname': u'month_that_storm_glass_layer_is_taken_off', 'maximum': 12, 'required-field': True, 'autosizable': False, 'minimum': 1, 'autocalculatable': False, 'type': u'integer'}), (u'day of month that storm glass layer is taken off', {'name': u'Day of Month that Storm Glass Layer is Taken Off', 'pyname': u'day_of_month_that_storm_glass_layer_is_taken_off', 'maximum': 31, 'required-field': True, 'autosizable': False, 'minimum': 1, 'autocalculatable': False, 'type': u'integer'})]),
 'format': None,
 'group': u'Thermal Zones and Surfaces',
 'min-fields': 7,
 ...
 'unique-object': False}
    ...
    def window_name(self):
        """The value of field `Window Name`
    ...
    def storm_glass_layer_name(self):
        """The value of field `Storm Glass Layer Name`
    ...
    def distance_between_storm_glass_layer_and_adjacent_glass(self):
        """The value of field `Distance Between Storm Glass Layer and Adjacent Glass`
    ...
    def month_that_storm_glass_layer_is_put_on(self):
        """The value of field `Month that Storm Glass Layer is Put On`
    ...
    def day_of_month_that_storm_glass_layer_is_put_on(self):
        """The value of field `Day of Month that Storm Glass Layer is Put On`
    ...
    def month_that_storm_glass_layer_is_taken_off(self):
        """The value of field `Month that Storm Glass Layer is Taken Off`
    ...
    def day_of_month_that_storm_glass_layer_is_taken_off(self):
        """The value of field `Day of Month that Storm Glass Layer is Taken Off`
...
class InternalMass(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict(),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'}), (u'construction name', {'name': u'Construction Name', 'pyname': u'construction_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'zone name', {'name': u'Zone Name', 'pyname': u'zone_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'surface area', {'name': u'Surface Area', 'pyname': u'surface_area', 'minimum>': 0.0, 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': 'real', 'unit': u'm2'})]),
 'format': None,
 'group': u'Thermal Zones and Surfaces',
 'min-fields': 0,
 'name': u'InternalMass',
 ...
 'unique-object': False}
    ...
    def surface_area(self):
        """The value of field `Surface Area`
...
class ShadingSite(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict(),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'}), (u'azimuth angle', {'name': u'Azimuth Angle', 'pyname': u'azimuth_angle', 'maximum': 360.0, 'required-field': False, 'autosizable': False, 'minimum': 0.0, 'autocalculatable': False, 'type': 'real', 'unit': u'deg'}), (u'tilt angle', {'name': u'Tilt Angle', 'pyname': u'tilt_angle', 'default': 90.0, 'maximum': 180.0, 'required-field': False, 'autosizable': False, 'minimum': 0.0, 'autocalculatable': False, 'type': 'real', 'unit': u'deg'}), (u'starting x coordinate', {'name': u'Starting X Coordinate', 'pyname': u'starting_x_coordinate', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': 'real', 'unit': u'm'}), (u'starting y coordinate', {'name': u'Starting Y Coordinate', 'pyname': u'starting_y_coordinate', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': 'real', 'unit': u'm'}), (u'starting z coordinate', {'name': u'Starting Z Coordinate', 'pyname': u'starting_z_coordinate', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': 'real', 'unit': u'm'}), (u'length', {'name': u'Length', 'pyname': u'length', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': 'real', 'unit': u'm'}), (u'height', {'name': u'Height', 'pyname': u'height', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': 'real', 'unit': u'm'})]),
 'format': None,
 'group': u'Thermal Zones and Surfaces',
 'min-fields': 0,
 'name': u'Shading:Site',
...
class ShadingSiteDetailed(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict([(u'vertex 1 x-coordinate', {'name': u'Vertex 1 X-coordinate', 'pyname': u'vertex_1_xcoordinate', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'm'}), (u'vertex 1 y-coordinate', {'name': u'Vertex 1 Y-coordinate', 'pyname': u'vertex_1_ycoordinate', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'm'}), (u'vertex 1 z-coordinate', {'name': u'Vertex 1 Z-coordinate', 'pyname': u'vertex_1_zcoordinate', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'm'})]),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'}), (u'transmittance schedule name', {'name': u'Transmittance Schedule Name', 'pyname': u'transmittance_schedule_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'number of vertices', {'name': u'Number of Vertices', 'pyname': u'number_of_vertices', 'default': 'autocalculate', 'required-field': True, 'autosizable': False, 'minimum': 3.0, 'autocalculatable': True, 'type': 'real'})]),
 'format': u'vertices',
 'group': u'Thermal Zones and Surfaces',
 'min-fields': 12,
 ...
 'unique-object': False}
    ...
    def transmittance_schedule_name(self):
        """The value of field `Transmittance Schedule Name`
...
class ShadingOverhang(DataObject):
 ...
 'unique-object': False}
    ...
    def window_or_door_name(self):
        """The value of field `Window or Door Name`
    ...
    def height_above_window_or_door(self):
        """The value of field `Height above Window or Door`
    ...
    def tilt_angle_from_window_or_door(self):
        """The value of field `Tilt Angle from Window/Door`
    ...
    def left_extension_from_window_or_door_width(self):
        """The value of field `Left extension from Window/Door Width`
    ...
    def right_extension_from_window_or_door_width(self):
        """The value of field `Right extension from Window/Door Width`
...
class ShadingOverhangProjection(DataObject):
 ...
 'unique-object': False}
    ...
    def depth_as_fraction_of_window_or_door_height(self):
        """The value of field `Depth as Fraction of Window/Door Height`
...
class ShadingFin(DataObject):
 ...
 'unique-object': False}
    ...
    def left_extension_from_window_or_door(self):
        """The value of field `Left Extension from Window/Door`
    ...
    def left_distance_above_top_of_window(self):
        """The value of field `Left Distance Above Top of Window`
    ...
    def left_distance_below_bottom_of_window(self):
        """The value of field `Left Distance Below Bottom of Window`
    ...
    def left_tilt_angle_from_window_or_door(self):
        """The value of field `Left Tilt Angle from Window/Door`
    ...
    def right_extension_from_window_or_door(self):
        """The value of field `Right Extension from Window/Door`
    ...
    def right_distance_above_top_of_window(self):
        """The value of field `Right Distance Above Top of Window`
    ...
    def right_distance_below_bottom_of_window(self):
        """The value of field `Right Distance Below Bottom of Window`
    ...
    def right_tilt_angle_from_window_or_door(self):
        """The value of field `Right Tilt Angle from Window/Door`
    ...
    def right_depth(self):
        """The value of field `Right Depth`
...
class ShadingFinProjection(DataObject):
 ...
 'unique-object': False}
    ...
    def left_depth_as_fraction_of_window_or_door_width(self):
        """The value of field `Left Depth as Fraction of Window/Door Width`
    ...
    def right_depth_as_fraction_of_window_or_door_width(self):
        """The value of field `Right Depth as Fraction of Window/Door Width`
...
class ShadingZoneDetailed(DataObject):
    ...
    """
    _schema = {'extensible-fields': OrderedDict([(u'vertex 1 x-coordinate', {'name': u'Vertex 1 X-coordinate', 'pyname': u'vertex_1_xcoordinate', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'm'}), (u'vertex 1 y-coordinate', {'name': u'Vertex 1 Y-coordinate', 'pyname': u'vertex_1_ycoordinate', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'm'}), (u'vertex 1 z-coordinate', {'name': u'Vertex 1 Z-coordinate', 'pyname': u'vertex_1_zcoordinate', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'real', 'unit': u'm'})]),
 'fields': OrderedDict([(u'name', {'name': u'Name', 'pyname': u'name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'alpha'}), (u'base surface name', {'name': u'Base Surface Name', 'pyname': u'base_surface_name', 'required-field': True, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'transmittance schedule name', {'name': u'Transmittance Schedule Name', 'pyname': u'transmittance_schedule_name', 'required-field': False, 'autosizable': False, 'autocalculatable': False, 'type': u'object-list'}), (u'number of vertices', {'name': u'Number of Vertices', 'pyname': u'number_of_vertices', 'default': 'autocalculate', 'required-field': True, 'autosizable': False, 'minimum': 3.0, 'autocalculatable': True, 'type': 'real'})]),
 'format': u'vertices',
 'group': u'Thermal Zones and Surfaces',
 'min-fields': 13,
 ...
 'unique-object': False}
    ...
    def base_surface_name(self):
        """The value of field `Base Surface Name`
...
class ShadingPropertyReflectance(DataObject):
 ...
 'unique-object': False}
    ...
    def shading_surface_name(self):
        """The value of field `Shading Surface Name`
    ...
    def diffuse_solar_reflectance_of_unglazed_part_of_shading_surface(self):
        """The value of field `Diffuse Solar Reflectance of Unglazed Part of Shading Surface`
    ...
    def diffuse_visible_reflectance_of_unglazed_part_of_shading_surface(self):
        """The value of field `Diffuse Visible Reflectance of Unglazed Part of Shading Surface`
    ...
    def fraction_of_shading_surface_that_is_glazed(self):
        """The value of field `Fraction of Shading Surface That Is Glazed`
    ...
    def glazing_construction_name(self):
        """The value of field `Glazing Construction Name`
